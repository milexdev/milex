...
namespace MilexPlugin\MilexCrmBundle\Integration\Salesforce\CampaignMember;

use Milex\PluginBundle\Entity\IntegrationEntityRepository;
use MilexPlugin\MilexCrmBundle\Integration\Salesforce\Exception\InvalidObjectException;
...
use MilexPlugin\MilexCrmBundle\Integration\Salesforce\Object\Contact;
use MilexPlugin\MilexCrmBundle\Integration\Salesforce\Object\Lead;
use MilexPlugin\MilexCrmBundle\Integration\Salesforce\QueryBuilder;
...
class Fetcher
{
    ...
    /**
     * Fetch the Milex contact IDs that are not already tracked as SF campaign members.
     *
     * @return array
     */
    public function getUnknownCampaignMembers()
    {
        ...
        return array_values(array_diff($this->milexIds, $milexLeadIds));
    }
    ...
    private function fetchLeads()
    {
        ...
        foreach ($this->leads as $lead) {
            ...
            $this->milexIds[]    = $lead['internal_entity_id'];
        }
    ...
    private function fetchContacts()
    {
        ...
        foreach ($this->contacts as $contact) {
            ...
            $this->milexIds[]       = $contact['internal_entity_id'];
        }
