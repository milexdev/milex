...
class VtigerIntegration extends CrmAbstractIntegration
{
    ...
    {
        return [
            'url'       => 'milex.vtiger.form.url',
            'username'  => 'milex.vtiger.form.username',
            'accessKey' => 'milex.vtiger.form.password',
        ];
    }
    ...
    public function getFormNotes($section)
    {
        if ('leadfield_match' == $section) {
            return ['milex.vtiger.form.field_match_notes', 'info'];
        }
    ...
    public function appendToForm(&$builder, $data, $formArea)
    {
        if ('features' == $formArea) {
            $builder->add(
                ...
                [
                    'choices' => [
                        'milex.vtiger.object.contact' => 'contacts',
                        'milex.vtiger.object.company' => 'company',
                    ],
                    'expanded'          => true,
                    'multiple'          => true,
                    'label'             => 'milex.vtiger.form.objects_to_pull_from',
                    'label_attr'        => ['class' => ''],
                    'placeholder'       => false,
                    'required'          => false,
                ]
