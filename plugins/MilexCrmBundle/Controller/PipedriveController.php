...
namespace MilexPlugin\MilexCrmBundle\Controller;

use Milex\CoreBundle\Controller\CommonController;
use MilexPlugin\MilexCrmBundle\Integration\Pipedrive\Import\CompanyImport;
use MilexPlugin\MilexCrmBundle\Integration\Pipedrive\Import\LeadImport;
use MilexPlugin\MilexCrmBundle\Integration\Pipedrive\Import\OwnerImport;
...
class PipedriveController extends CommonController
{
    ...
    private function getLeadImport($integration)
    {
        ...
        $leadImport = $this->get('milex_integration.pipedrive.import.lead');
    ...
    private function getCompanyImport($integration)
    {
        ...
        $companyImport = $this->get('milex_integration.pipedrive.import.company');
    ...
    private function getOwnerImport($integration)
    {
        ...
        $ownerImport = $this->get('milex_integration.pipedrive.import.owner');
