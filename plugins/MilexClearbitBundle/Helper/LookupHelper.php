...
namespace MilexPlugin\MilexClearbitBundle\Helper;
...
use MilexPlugin\MilexClearbitBundle\Services\Clearbit_Company;
use MilexPlugin\MilexClearbitBundle\Services\Clearbit_Person;
use Monolog\Logger;
