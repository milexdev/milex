...
// import grapesjsmilex from 'grapesjs-preset-milex/src/content.service';
...
function switchBuilderButton(theme) {
  ...
  const isCodeMode = theme === 'milex_code_mode';
...
/**
 * Initialize original Milex theme selection with grapejs specific modifications
 */
function initSelectThemeGrapesjs(parentInitSelectTheme) {
  function childInitSelectTheme(themeField) {
    ...
    // Replace Milex URL by plugin URL
    ...
    // Launch original Milex.initSelectTheme function
...
Milex.launchBuilder = launchBuilderGrapesjs;
Milex.initSelectTheme = initSelectThemeGrapesjs(Milex.initSelectTheme);
Milex.setThemeHtml = setThemeHtml;
