...
<?php
    $header = ($entity->getId()) ?
    $view['translator']->trans('milex.social.monitoring.menu.edit',
        ['%name%' => $view['translator']->trans($entity->getTitle())]) :
        $view['translator']->trans('milex.social.monitoring.menu.new');
...
<?php
$view['slots']->append('modal', $this->render('MilexCoreBundle:Helper:modal.html.php', [
