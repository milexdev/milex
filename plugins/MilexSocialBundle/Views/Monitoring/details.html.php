...
if (!$isEmbedded) {
    ...
    $view['slots']->set('milexContent', 'monitoring');
    ...
    $view['slots']->set('actions', $view->render('MilexCoreBundle:Helper:page_actions.html.php', [
        ...
        'templateButtons' => [
            ...
            'close'  => $view['security']->isGranted('milexSocial:monitoring:view'),
        ],
        'routeBase'  => 'social',
        'langVar'    => 'monitoring',
        'nameGetter' => 'getTitle',
...
echo $view['assets']->includeScript('plugins/MilexSocialBundle/Assets/js/social.js');
?>
            ...
            <div class="pr-md pl-md pt-lg pb-lg">
                <div class="box-layout">
                    ...
                    <div class="col-xs-2 text-right">
                        <?php echo $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $activeMonitoring]); ?>
                    </div>
                </div>
            </div>
            <!--/ monitoring detail header -->
                ...
                <div class="pr-md pl-md pb-md">
                    <div class="panel shd-none mb-0">
                        <table class="table table-bordered table-striped mb-0">
                            <tbody>
                                <?php echo $view->render('MilexCoreBundle:Helper:details.html.php', ['entity' => $activeMonitoring]); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.social.monitoring.'.$activeMonitoring->getNetworkType().'.popularity'); ?>                                    </h5>
                                </div>
                            ...
                            <div class="pt-0 pl-15 pb-10 pr-15">
                                <?php echo $view->render('MilexCoreBundle:Helper:chart.html.php', ['chartData' => $leadStats, 'chartType' => 'line', 'chartHeight' => 300]); ?>
                            </div>
                        </div>
                    </div>
                </div>
