    ...
    <ul class="nav nav-tabs pr-md pl-md">
        ...
        <li>
            <a href="#TwitterTweets" role="tab" data-toggle="tab">
                <?php echo $view['translator']->trans('milex.lead.lead.social.twitter.tweets'); ?>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="#TwitterTags" role="tab" data-toggle="tab">
               <?php echo $view['translator']->trans('milex.lead.lead.social.tags'); ?>
            </a>
        </li>
    </ul>
</div>
<div class="np panel-body tab-content">
    <div class="pa-20 tab-pane active" id="TwitterProfile">
        <?php echo $view->render('MilexSocialBundle:Integration/Twitter/Profile:profile.html.php', [
            'lead'    => $lead,
            'profile' => $details['profile'],
        ]); ?>
    </div>
    <div class="tab-pane" id="TwitterTweets">
        <?php echo $view->render('MilexSocialBundle:Integration/Twitter/Profile:tweets.html.php', [
            'lead'     => $lead,
            'activity' => (!empty($details['activity']['tweets'])) ? $details['activity']['tweets'] : [],
        ]); ?>
    </div>
    <div class="pa-20 tab-pane" id="TwitterPhotos">
        <?php echo $view->render('MilexSocialBundle:Integration/Twitter/Profile:photos.html.php', [
            'lead'      => $lead,
             'activity' => (!empty($details['activity']['photos'])) ? $details['activity']['photos'] : [],
        ]); ?>
    </div>
    <div class="pa-20 tab-pane" id="TwitterTags">
        <?php echo $view->render('MilexSocialBundle:Integration/Twitter/Profile:tags.html.php', [
            'lead'     => $lead,
