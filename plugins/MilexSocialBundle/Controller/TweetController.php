...
class TweetController extends FormController
{
    ...
    {
        return 'MilexSocialBundle:Tweet';
    }
    ...
    {
        return 'milex.integration.Twitter';
    }
    ...
    {
        return $this->setFormTheme($form, 'MilexSocialBundle:Tweet:form.html.php', ['MilexSocialBundle:FormTheme']);
    }
