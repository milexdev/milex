...
namespace MilexPlugin\MilexSocialBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="MilexPlugin\MilexSocialBundle\Entity\TweetRepository")
 */
class Tweet extends FormEntity
{
    /**
     * Internal Milex ID of the tweet.
     *
     * @var int
     */
    private $id;
    ...
    /**
     * Internal Milex name of the tweet.
     *
     * @var string
     */
    private $name;
