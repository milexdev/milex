 ...
 * @ORM\Entity(repositoryClass="MilexPlugin\MilexSocialBundle\Entity\LeadRepository")
 */
class Lead
{
    /**
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('monitoring_leads')
            ->setCustomRepositoryClass('MilexPlugin\MilexSocialBundle\Entity\LeadRepository');
