...
use MilexPlugin\MilexSocialBundle\Entity\Tweet;
use MilexPlugin\MilexSocialBundle\Entity\TweetStat;
use MilexPlugin\MilexSocialBundle\Event as Events;
use MilexPlugin\MilexSocialBundle\Form\Type\TweetType;
...
class TweetModel extends FormModel implements AjaxLookupModelInterface
{
    ...
    {
        return $this->em->getRepository('MilexSocialBundle:Tweet');
    }
    ...
    {
        return $this->em->getRepository('MilexSocialBundle:TweetStat');
    }
