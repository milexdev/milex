...
use MilexPlugin\MilexSocialBundle\Entity\PostCount;
...
class PostCountModel extends AbstractCommonModel
{
     ...
     *
     * @return \MilexPlugin\MilexSocialBundle\Entity\PostCountRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexSocialBundle:PostCount');
    }
    ...
    public function updatePostCount($monitor, \DateTime $postDate)
    {
        ...
        /** @var \MilexPlugin\MilexSocialBundle\Entity\PostCountRepository $postCountsRepository */
        ...
        if (!count($postCounts)) {
            /** @var \MilexPlugin\MilexSocialBundle\Entity\PostCount $postCount */
