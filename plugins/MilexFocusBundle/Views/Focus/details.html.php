                            ...
                            <div class="panel-body box-layout">
                                <div class="col-xs-4 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.focus.graph.stats'); ?>
                                    </h5>
                                </div>
        ...
        <div class="pa-md">
            <div class="panel bg-info bg-light-lg bdr-w-0 mb-0">
                <div class="panel-body">
                    <h5 class="fw-sb mb-sm"><?php echo $view['translator']->trans('milex.focus.install.header'); ?></h5>
                    <p class="mb-sm"><?php echo $view['translator']->trans('milex.focus.install.description'); ?></p>
