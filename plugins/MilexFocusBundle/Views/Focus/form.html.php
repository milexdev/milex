...
$header = ($entity->getId())
    ...
    :
    $view['translator']->trans('milex.focus.new');
$view['slots']->set('headerTitle', $header);

echo $view['assets']->includeScript('plugins/MilexFocusBundle/Assets/js/focus.js');
echo $view['assets']->includeStylesheet('plugins/MilexFocusBundle/Assets/css/focus.css');
    ...
    <div class="box-layout">
        ...
        <div class="col-md-3 bg-white height-auto">
            <div class="pr-lg pl-lg pt-md pb-md">
                ...
                ?>
                <hr />
                <h5><?php echo $view['translator']->trans('milex.email.utm_tags'); ?></h5>
                <br />
                <?php
...
<!--                Form to get preview URL-->
                <div class="website-placeholder hide well well-lg col-md-6 col-md-offset-3 mt-lg">
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <h4><i class="fa fa-quote-left"></i> <?php echo $view['translator']->trans('milex.core.noresults.tip'); ?>
                                <i class="fa fa-quote-right"></i></h4>
                            <p class="mt-md">
                                <?php echo $view['translator']->trans('milex.focus.website_placeholder'); ?>
                            </p>
...
<!--        Builder-->
        <div class="builder-panel builder-panel-focus">
            <div class="builder-panel-top">
                <p>
                    <button type="button" class="btn btn-primary btn-close-builder btn-block" onclick="Milex.closeFocusBuilder(this);"><?php echo $view['translator']->trans(
                            'milex.core.close.builder'
                        ); ?></button>
                </p>
            </div>
            <?php
                    ...
                    <div class="panel-heading">
                        <h4 class="focus-type-header panel-title">
                            <a role="button" data-toggle="collapse" href="#focusTypePanel" aria-expanded="true" aria-controls="focusTypePanel">
                                <i class="fa fa-bullseye"></i> <?php echo $view['translator']->trans('milex.focus.form.type'); ?>
                            </a>
                        </h4>
                    </div>
                        ...
                        <ul class="list-group mb-0">
                            <li data-focus-type="form" class="focus-type list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.form.type.form'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.form.type.form_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li data-focus-type="notice" class="focus-type list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.form.type.notice'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.form.type.notice_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li data-focus-type="link" class="focus-type list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.form.type.link'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.form.type.link_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title focus-style-header">
                            <a role="button" data-toggle="collapse" href="#focusStylePanel" aria-expanded="true" aria-controls="focusStylePanel">
                                <i class="fa fa-desktop"></i> <?php echo $view['translator']->trans('milex.focus.form.style'); ?>
                            </a>
                        </h4>
                    </div>
                        ...
                        <ul class="list-group mb-0">
                            <li data-focus-style="bar" class="focus-style visible-focus-style-bar list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.style.bar'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.style.bar_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li data-focus-style="modal" class="focus-style visible-focus-style-modal list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.style.modal'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.style.modal_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans(
                                                'milex.focus.style.notification'
                                            ); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.style.notification_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li data-focus-style="page" class="focus-style visible-focus-style-page list-group-item pl-sm pr-sm">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <h4 class="list-group-heading"><?php echo $view['translator']->trans('milex.focus.style.page'); ?></h4>
                                        <p class="list-group-item-text small"><?php echo $view['translator']->trans(
                                                'milex.focus.style.page_description'
                                            ); ?></p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#focusColorsPanel" aria-expanded="true" aria-controls="focusColorsPanel">
                                <i class="fa fa-paint-brush"></i> <?php echo $view['translator']->trans('milex.focus.tab.focus_colors'); ?>
                            </a>
                        </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#focusContentPanel" aria-expanded="true" aria-controls="focusContentPanel">
                                <i class="fa fa-newspaper-o"></i> <?php echo $view['translator']->trans('milex.focus.tab.focus_content'); ?>
                            </a>
                        </h4>
                    </div>
                            ...
                            <div class="focus-hide visible-focus-type-form">
                                <div class="col-sm-12" id="focusFormAlert" data-hide-on='{"focus_html_mode_0":"checked"}'>
                                    <div class="alert alert-info">
                                        <?php echo $view['translator']->trans('milex.focus.form_token.instructions'); ?>
                                    </div>
                                </div>
