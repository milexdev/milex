...
.mf-modal {
    ...
    .milexform-input, .milexform-row select, .milexform-button, .milexform-pagebreak {
        width: 75%;
        height: 35px;
        margin-bottom: 5px;
    }
...
<?php echo $view->render('MilexFocusBundle:Builder\Modal:animations.less.php'); ?>
<?php echo $view->render('MilexFocusBundle:Builder\Modal:overlay.less.php'); ?>
