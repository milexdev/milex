...
$cssContent = $view->render(
    'MilexFocusBundle:Builder:style.less.php',
    [
        'preview' => $preview,
        'focus'   => $focus,
    ]
...
$parentCssContent = $view->render(
    'MilexFocusBundle:Builder:parent.less.php',
    [
        'preview' => $preview,
    ]
);
...
?>
(function (window) {
    if (typeof window.MilexFocusParentHeadStyleInserted == 'undefined') {
        window.MilexFocusParentHeadStyleInserted = false;
    }

    window.MilexFocus<?php echo $focus['id']; ?> = function () {
        var Focus = {
            ...
            initialize: function () {
                ...
                // Add class to body
                Focus.addClass(document.getElementsByTagName('body')[0], 'MilexFocus<?php echo ucfirst($style); ?>');
            },
            ...
            registerClickEvents: function () {
                ...
                var buttons = Focus.iframeDoc.getElementsByClassName('milexform-button');
                if (buttons.length) {
            ...
            insertStyleIntoHead: function () {
                if (!window.MilexFocusParentHeadStyleInserted) {
                    if (Focus.debug)
            ...
            engageVisitor: function () {
                ...
                if (Focus.cookies.hasItem('milex_focus_<?php echo $focus['id']; ?>')) {
                    if (Focus.debug)
                        console.log('Cookie exists thus checking frequency');

                    var lastEngaged = parseInt(Focus.cookies.getItem('milex_focus_<?php echo $focus['id']; ?>')),
                ...
                var focus = Focus.iframeDoc.getElementsByClassName('milex-focus');
                ...
                if (Focus.debug)
                    console.log('milex_focus_<?php echo $focus['id']; ?> cookie set for ' + now);

                Focus.cookies.removeItem('milex_focus_<?php echo $focus['id']; ?>');
                Focus.cookies.setItem('milex_focus_<?php echo $focus['id']; ?>', now, Infinity, '/');
            ...
            convertVisitor: function () {
                if (Focus.ignoreConverted) {
                    ...
                    Focus.cookies.setItem('milex_focus_<?php echo $focus['id']; ?>', -1, Infinity, '/');
                } else if (Focus.debug) {
    ...
    // Initialize
    MilexFocus<?php echo $focus['id']; ?>().initialize();
})(window);
