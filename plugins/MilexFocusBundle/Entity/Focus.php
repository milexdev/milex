...
class Focus extends FormEntity
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint(
            'type',
            new NotBlank(
                ['message' => 'milex.focus.error.select_type']
            )
        );
        ...
        $metadata->addPropertyConstraint(
            'style',
            new NotBlank(
                ['message' => 'milex.focus.error.select_style']
            )
        );
    }
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('focus')
            ->setCustomRepositoryClass('MilexPlugin\MilexFocusBundle\Entity\FocusRepository')
