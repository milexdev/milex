...
class LeadSubscriber implements EventSubscriberInterface
{
                        ...
                        foreach ($citrixEvents['results'] as $citrixEvent) {
                            ...
                            $event->addEvent(
                                [
                                    ...
                                    'contentTemplate' => 'MilexCitrixBundle:SubscribedEvents\Timeline:citrix_event.html.php',
    ...
    {
        if (false === strpos($event->getRoute(), 'milex_segment_action')) {
            return;
        }
            ...
            if (in_array($product, [CitrixProducts::GOTOWEBINAR, CitrixProducts::GOTOTRAINING])) {
                $event->addChoice(
                    ...
                    [
                        ...
                        'operators' => [
                            $this->translator->trans('milex.core.operator.in')    => 'in',
                            $this->translator->trans('milex.core.operator.notin') => '!in',
                        ],
                    ]
                );
            }
    ...
    public function onListFiltering(LeadListFilteringEvent $event)
    {
        ...
        $citrixEventsTable = $em->getClassMetadata('MilexCitrixBundle:CitrixEvent')->getTableName();
