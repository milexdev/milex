...
use MilexPlugin\MilexCitrixBundle\Form\Type\CitrixActionType;
use MilexPlugin\MilexCitrixBundle\Form\Type\CitrixListType;
    ...
    public function onFormBuilder(Events\FormBuilderEvent $event)
    {
        ...
        foreach ($activeProducts as $product) {
            $event->addFormField('plugin.citrix.select.'.$product, [
                ...
                'template' => 'MilexCitrixBundle:Field:citrixlist.html.php',
                'listType' => $product,
            ]);
            ...
            switch ($product) {
                case CitrixProducts::GOTOWEBINAR:
                    $event->addSubmitAction('plugin.citrix.action.register.webinar', [
                        ...
                        'template'  => 'MilexFormBundle:Action:generic.html.php',
