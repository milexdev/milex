...
namespace MilexPlugin\MilexCitrixBundle\Command;
 ...
 *
 * php bin/console milex:citrix:sync [--product=webinar|meeting|assist|training [--id=%productId%]]
 */
class SyncCommand extends ModeratedCommand
{
    ...
    {
        $this->setName('milex:citrix:sync')
    ...
    {
        $model   = $this->getContainer()->get('milex.citrix.model.citrix');
