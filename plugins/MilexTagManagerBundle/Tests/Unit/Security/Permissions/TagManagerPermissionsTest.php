...
namespace MilexPlugin\MilexTagManagerBundle\Tests\Unit\Security\Permissions;

use MilexPlugin\MilexTagManagerBundle\Security\Permissions\TagManagerPermissions;
