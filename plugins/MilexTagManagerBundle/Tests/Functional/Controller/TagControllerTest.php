...
namespace MilexPlugin\MilexTagManagerBundle\Tests\Functional\Controller;

use Milex\CoreBundle\Test\MilexMysqlTestCase;
use Milex\LeadBundle\Entity\Tag;
use Milex\LeadBundle\Entity\TagRepository;
use Milex\LeadBundle\Model\TagModel;
use PHPUnit\Framework\Assert;
use Symfony\Component\HttpFoundation\Request;

class TagControllerTest extends MilexMysqlTestCase
{
    /**
     * @var TagRepository
     */
