...
namespace MilexPlugin\MilexFullContactBundle\Helper;
...
use MilexPlugin\MilexFullContactBundle\Services\FullContact_Company;
use MilexPlugin\MilexFullContactBundle\Services\FullContact_Person;
use Monolog\Logger;
