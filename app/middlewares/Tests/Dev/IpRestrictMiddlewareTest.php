...
namespace Milex\Middleware\Tests\Dev;

use Milex\Middleware\Dev\IpRestrictMiddleware;
...
class IpRestrictMiddlewareTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testWorkflowWithConfiguredIp(): void
    {
        ...
        $originalDevHostsValue = $_SERVER['MILEX_CUSTOM_DEV_HOSTS'] ?? '[]';

        $_SERVER['MILEX_CUSTOM_DEV_HOSTS'] = '["configured.ip.address"]';
        ...
        $_SERVER['MILEX_CUSTOM_DEV_HOSTS'] = $originalDevHostsValue;
    }
}
