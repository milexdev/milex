...
namespace Milex\Middleware\Dev;

use Milex\Middleware\ConfigAwareTrait;
use Milex\Middleware\PrioritizedMiddlewareInterface;
...
class IpRestrictMiddleware implements HttpKernelInterface, PrioritizedMiddlewareInterface
{
    ...
    public function __construct(HttpKernelInterface $app)
    {
        ...
        if (isset($_SERVER['MILEX_CUSTOM_DEV_HOSTS'])) {
            $localIps         = json_decode($_SERVER['MILEX_CUSTOM_DEV_HOSTS'], true);
