...
$releaseMetadata = \Milex\CoreBundle\Release\ThisRelease::getMetadata();
...
if (!isset($args['repackage'])) {
    ...
    // Compile prod assets
    system('cd '.__DIR__.'/packaging && php '.__DIR__.'/packaging/bin/console milex:assets:generate -e prod', $result);
    if (0 !== $result) {
        exit;
    }
