...
@unlink($baseDir.'/packages/milex-head.zip');
...
// Step 5 - ZIP it up
echo "Packaging Milex\n";
chdir(__DIR__.'/packaging');

system('zip -r ../packages/milex-head.zip . > /dev/null');
...
system('zip -r ../packages/milex-head-update.zip . > /dev/null');
