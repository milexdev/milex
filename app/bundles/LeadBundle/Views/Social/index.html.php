...
<div class="alert alert-warning col-md-6 col-md-offset-3 mt-md">
    <h4><?php echo $view['translator']->trans('milex.lead.socialprofiles.header'); ?></h4>
    <p><a href="javascript: void(0);" onclick="Milex.refreshLeadSocialProfile('', <?php echo $lead->getId(); ?>, event);"><?php echo $view['translator']->trans('milex.lead.socialprofiles.noresults'); ?></a></p>
</div>
<?php else: ?>
<?php $count = 0; ?>
<div class="row">
    ...
    <div class="col-md-6">
        <div class="panel panel-default panel-<?php echo strtolower($integrationName); ?>">
            <div class="panel-heading pr-0">
                <h3 class="panel-title"><?php echo $view['translator']->trans('milex.integration.'.$integrationName); ?></h3>
                <div class="panel-toolbar text-right">
                    <a href="javascript:void(0);" class="btn" data-toggle="tooltip" onclick="Milex.refreshLeadSocialProfile('<?php echo $integrationName; ?>', '<?php echo $lead->getId(); ?>', event);" title="<?php echo $view['translator']->trans('milex.lead.lead.social.lastupdate', ['%datetime%' => $view['date']->toFullConcat($details['lastRefresh'], 'utc')]); ?>">
                    ...
                    <a href="javascript:void(0);" class="btn" onclick="Milex.clearLeadSocialProfile('<?php echo $integrationName; ?>', '<?php echo $lead->getId(); ?>', event);" data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.lead.lead.social.removecache'); ?>">
