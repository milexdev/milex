...
$view['slots']->set('milexContent', 'list');
...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $list])
);
...
<div class="box-layout">
    ...
    <div class="col-md-9 bg-white height-auto">
                ...
                <div class="pr-md pl-md pb-md">
                    <div class="panel shd-none mb-0">
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans('milex.lead.leads'); ?></span></td>
        ...
        <div class="bg-auto bg-dark-xs">
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.segment.stats'); ?>
                                    </h5>
                                </div>
            ...
            <!-- tabs controls -->
            <!-- search bar-->
            <form method="post" action="<?php echo $view['router']->path('milex_segment_contacts', ['objectId' => $list->getId()]); ?>" class="panel" id="segment-contact-filters">
            ...
            <ul class="nav nav-tabs pr-md pl-md">
                ...
                <li>
                    <a id="campaign-share-tab" href="#campaign-container" role="tab" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.lead.campaign.share'); ?>
                    </a>
                </li>
            </ul>
            <!--/ tabs controls -->
        ...
        <div class="tab-content pa-md">
            ...
            echo $view['router']->url(
                ...
                ['objectId' => $list->getId(), 'page' => $app->getSession()->get('milex.segment.contact.page', 1)]
            );
            ?>">
            ...
            <div class="tab-pane bdr-w-0 page-list" id="campaign-container">
                <div id="campaign-share-container" style="position: relative">
                    <table id="campaign-share-table" class="table table-bordered table-striped mb-0">
                        ...
                        <tr>
                            <th>
                                <?php echo $view['translator']->trans('milex.campaign.campaign'); ?>
                            </th>
                            <th>
                                <?php echo $view['translator']->trans('milex.lead.share'); ?>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        <?php
        echo $view->render('MilexCoreBundle:Helper:usage.html.php', [
            'title' => $view['translator']->trans('milex.lead.segments.usages'),
            'stats' => $usageStats,
            ]);
        ?>
