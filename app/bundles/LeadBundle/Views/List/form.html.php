...
if (!empty($id)) {
    ...
    $header = $view['translator']->trans('milex.lead.list.header.edit', ['%name%' => $name]);
} else {
    $header = $view['translator']->trans('milex.lead.list.header.new');
}
        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="bg-auto nav nav-tabs pr-md pl-md">
                    ...
                    <li data-toggle="tooltip" title="" data-placement="top" data-original-title="<?php echo $view['translator']->trans('milex.lead.lead.segment.add.help'); ?>">
                ...
                <div class="tab-content pa-md">
                    ...
                    <div class="tab-pane fade bdr-w-0" id="filters">
                        <div class="alert alert-info"><p><?php echo $view['translator']->trans('milex.lead.lead.segment.filter.info'); ?></p></div>
                            ...
                            <div class="available-filters mb-md pl-0 col-md-4" data-prototype="<?php echo $view->escape($view['form']->widget($form['filters']->vars['prototype'])); ?>" data-index="<?php echo $index + 1; ?>">
                                <select class="chosen form-control" id="available_segment_filters">
                                    ...
                                    foreach ($fields as $object => $field):
                                        ...
                                        $header = $view['translator']->hasId($translationId = 'milex.lead.'.$header)
