...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#channels"><?php echo $view['translator']->trans('milex.lead.contact.channels'); ?></a></li>
    <li><a data-toggle="tab" href="#categories"><?php echo $view['translator']->trans('milex.lead.preferred.categories'); ?></a></li>
    <li><a data-toggle="tab" href="#segments"><?php echo $view['translator']->trans('milex.lead.preferred.segments'); ?></a></li>
</ul>
            ...
            <tr >
                <th>
                    <input type="checkbox" id="lead_contact_frequency_rules_subscribed_channels_0" name="check_all"
                           onclick="Milex.togglePreferredChannel('all');" value="all">
                </th>
                <th>
                    <?php echo $view['translator']->trans('milex.lead.contact.channels'); ?>
                </th>
                <th><?php echo $view['translator']->trans('milex.lead.preferred.frequency'); ?></th>
                <th><?php echo $view['translator']->trans('milex.lead.preferred.channels'); ?></th>
            </tr>
            </thead>
            <tbody >
                ...
                <tr>
                    <th style="vertical-align: top" class="col-md-1">
                        <input type="checkbox" id="<?php echo $channel->value; ?>"
                               ...
                               onclick="Milex.togglePreferredChannel(this.value);"
                ...
                <tr style="border-top:none"><th style="border-top:none"></th>
                    ...
                    <td colspan="2" style="border-top:none">
                        <div id="frequency_<?php echo $channel->value; ?>" <?php if (!empty($hidden)) :?>class="<?php echo $hidden; ?>"<?php endif; ?> >
                            <div>
                                <label class="text-muted fw-n"><?php echo $view['translator']->trans('milex.lead.frequency.dates.label'); ?></label>
                            </div>
                            <div>
