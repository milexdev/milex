...
$header = ($lead->getId()) ?
    $view['translator']->trans('milex.lead.lead.header.edit',
        ['%name%' => $view['translator']->trans($lead->getPrimaryIdentifier())]) :
    $view['translator']->trans('milex.lead.lead.header.new');
                    ...
                    if (!empty($groupFields)): ?>
                        <div class="tab-pane fade<?php if (0 === $key): echo ' in active'; endif; ?> bdr-rds-0 bdr-w-0"
                            ...
                            <div class="pa-md bg-auto bg-light-xs bdr-b">
                                <h4 class="fw-sb"><?php echo $view['translator']->trans('milex.lead.field.group.'.$group); ?></h4>
                            </div>
                            <div class="pa-md">
                                <?php if ('core' == $group): ?>
                                <?php if (isset($form['title']) || isset($form['firstname']) || isset($form['lastname'])): ?>
                                    <div class="form-group mb-0">
                                        <label
                                            class="control-label mb-xs"><?php echo $view['translator']->trans('milex.core.name'); ?></label>
                                        <div class="row">
                                ...
                                <hr class="mnr-md mnl-md">
                                    <div class="form-group mb-0">
                                        <label><?php echo $view['translator']->trans('milex.company.company'); ?></label>
                                        <div class="row">
                                ...
                                <?php if (isset($form['address1']) || isset($form['address2']) || isset($form['city']) || isset($form['state']) || isset($form['zipcode']) || isset($form['country'])): ?>
                                    <div class="form-group mb-0">
                                        <label
                                            class="control-label mb-xs"><?php echo $view['translator']->trans('milex.lead.field.address'); ?></label>
                                ...
                                <?php if (isset($form['attribution']) && isset($form['attribution_date'])): ?>
                                    <div class="form-group mb-0">
                                        <label
                                            class="control-label mb-xs"><?php echo $view['translator']->trans('milex.lead.attribution'); ?></label>
                                        <div class="row">
                                            <div class="col-sm-4">
