...
<ul class="list-group">
    <?php foreach ($companies as $company): ?>
        ...
        <li class="list-group-item">
            <i class="fa fa-lg fa-fw <?php echo $switch.' '.$bgClass; ?>" id="companyLeadsToggle<?php echo $company['id']; ?>" onclick="Milex.toggleCompanyLead('companyLeadsToggle<?php echo $company['id']; ?>', <?php echo $leadId; ?>, <?php echo $company['id']; ?>);"></i>
