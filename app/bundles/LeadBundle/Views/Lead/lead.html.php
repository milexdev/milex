    ...
    $buttons[] = [
        'attr' => [
            ...
            'data-header' => $view['translator']->trans(
                'milex.lead.email.send_email.header',
        ...
        'btnText'   => $view['translator']->trans('milex.lead.email.send_email'),
...
if ($edit) {
    $buttons[] = [
        'attr' => [
            ...
            'data-target' => '#MilexSharedModal',
            'data-header' => $view['translator']->trans(
                'milex.lead.lead.header.contact.frequency',
        ...
        'btnText'   => $view['translator']->trans('milex.lead.contact.frequency'),
...
if ($view['security']->isGranted('campaign:campaigns:edit')) {
    $buttons[] = [
        'attr' => [
            ...
            'data-target' => '#MilexSharedModal',
            'data-header' => $view['translator']->trans(
                'milex.lead.lead.header.campaigns',
                ['%name%' => $view->escape($lead->getPrimaryIdentifier())]
            ),
            'data-footer' => 'false',
            'href'        => $view['router']->path(
        ...
        'btnText'   => $view['translator']->trans('milex.campaign.campaigns'),
...
if (($view['security']->hasEntityAccess(
    ...
    $buttons[] = [
        ...
        'btnText'   => $view['translator']->trans('milex.lead.merge'),
...
if ($view['security']->hasEntityAccess(
    ...
    $buttons[] = [
        ...
        'btnText'   => $view['translator']->trans('milex.core.export'),
    ...
    <div class="col-md-9 bg-white height-auto">
                    ...
                    <?php if ($devices): ?>
                        <li>
                            <a href="#devices" class="group" data-toggle="tab">
                                <?php echo $view['translator']->trans('milex.lead.devices'); ?>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
                ...
                <div class="tab-content pa-md bg-white">
                    ...
                    <?php if ($devices): ?>
                        <div class="tab-pane fade bdr-w-0" id="devices">
                            <?php echo $view->render('MilexLeadBundle:Lead:devices.html.php', ['devices' => $devices]); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                                ...
                                <div class="panel-body box-layout">
                                    <div class="col-xs-8 va-m">
                                        <h5 class="text-white dark-md fw-sb mb-xs">
                                            <?php echo $view['translator']->trans('milex.lead.field.header.engagements'); ?>
                                        </h5>
                                    </div>
            ...
            <ul class="nav nav-tabs pr-md pl-md mt-10">
                <li class="active">
                    <a href="#timeline-container" role="tab" data-toggle="tab">
                        ...
                        <?php echo $view['translator']->trans('milex.lead.lead.tab.history'); ?>
                    </a>
                </li>
                <li class="">
                    <a href="#notes-container" role="tab" data-toggle="tab">
                        ...
                        <?php echo $view['translator']->trans('milex.lead.lead.tab.notes'); ?>
                    </a>
                </li>
                <?php if (!$isAnonymous): ?>
                    <li class="">
                        ...
                        <span class="label label-primary mr-sm" id="SocialCount">
                            ...
                            <?php echo $view['translator']->trans('milex.lead.lead.tab.social'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <li class="">
                    ...
                    <span class="label label-primary mr-sm" id="IntegrationCount">
                        ...
                        <?php echo $view['translator']->trans('milex.lead.lead.tab.integration'); ?>
                    </a>
                </li>
                <li class="">
                    ...
                    <span class="label label-primary mr-sm" id="AuditLogCount">
                        ...
                        <?php echo $view['translator']->trans('milex.lead.lead.tab.auditlog'); ?>
                    </a>
                </li>
                <?php if ($places): ?>
                    <li class="">
                        ...
                        <span class="label label-primary mr-sm" id="PlaceCount">
                            ...
                            <?php echo $view['translator']->trans('milex.lead.lead.tab.places'); ?>
                        </a>
                    </li>
                <?php endif; ?>
        ...
        <div class="tab-content pa-md">
            ...
            <div class="tab-pane fade in active bdr-w-0" id="timeline-container">
                <?php echo $view->render(
                    'MilexLeadBundle:Timeline:list.html.php',
                    [
                        'events' => $events,
                        'lead'   => $lead,
                        'tmpl'   => 'index',
            ...
            <div class="tab-pane fade bdr-w-0" id="integration-container">
                <?php echo $view->render(
                    'MilexLeadBundle:Integration:index.html.php',
                    [
                        'lead'         => $lead,
            ...
            <div class="tab-pane fade bdr-w-0" id="auditlog-container">
                <?php echo $view->render(
                    'MilexLeadBundle:Auditlog:list.html.php',
                    [
                        'events' => $auditlog,
                        'lead'   => $lead,
                        'tmpl'   => 'index',
            ...
            <?php if ($places): ?>
                <div class="tab-pane fade bdr-w-0" id="place-container">
                    <?php echo $view->render('MilexLeadBundle:Lead:map.html.php', ['places' => $places]); ?>
                </div>
            <?php endif; ?>
            <!--/ #place-container -->
        </div>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
            ...
            <?php if ($doNotContact) :
                ?>
                <?php echo $view->render(
                    'MilexLeadBundle:Lead:dnc_large.html.php',
                    [
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo $view['translator']->trans('milex.lead.field.header.contact'); ?>
                </div>
            </div>
            <div class="panel-body pt-sm">
            <?php if ($lead->getOwner()) : ?>
                <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.lead.lead.field.owner'); ?></h6>
                <p class="text-muted"><?php echo $view->escape($lead->getOwner()->getName()); ?></p>
            <?php endif; ?>

                <h6 class="fw-sb">
                    <?php echo $view['translator']->trans('milex.lead.field.address'); ?>
                </h6>
                ...
                <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.core.type.email'); ?></h6>
                <p class="text-muted"><?php echo $view->escape($fields['core']['email']['value']); ?></p>

                <?php if (isset($fields['core']['phone'])): ?>
                    <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.lead.field.type.tel.home'); ?></h6>
                    <p class="text-muted"><?php echo $view->escape($fields['core']['phone']['value']); ?></p>
                <?php endif; ?>

                <?php if (isset($fields['core']['mobile'])): ?>
                    <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.lead.field.type.tel.mobile'); ?></h6>
        ...
        <?php if ($upcomingEvents) : ?>
            ...
            <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $view['translator']->trans('milex.lead.lead.upcoming.events'); ?></div>
                </div>
                <div class="panel-body pt-sm">
                    <ul class="media-list media-list-feed">
                        <?php foreach ($upcomingEvents as $event) : ?>
                        <?php
                            $metadata = \Milex\CoreBundle\Helper\Serializer::decode($event['metadata']);
                            $errors   = false;
                        ...
                        ?>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <?php echo $view['translator']->trans(
                                        'milex.lead.lead.upcoming.event.triggered.at',
        ...
        <div class="pa-sm panel-companies">
            <div class="panel-title">
                <?php echo $view['translator']->trans('milex.lead.lead.companies'); ?>
            </div>
            ...
            <h5 class="pull-left mt-xs mr-xs">
                <span class="label label-success">
                    <i id="company-<?php echo $company['id']; ?>"
                        ...
                        onclick="Milex.setAsPrimaryCompany(<?php echo $company['id']; ?>, <?php echo $lead->getId(); ?>);"
                        title="<?php echo $view['translator']->trans('milex.lead.company.set.primary'); ?>">
                    </i>
                    <a href="<?php echo $view['router']->path('milex_company_action', ['objectAction' => 'view', 'objectId' => $company['id']]); ?>" data-toggle="ajax" style="color: white;">
        ...
        <?php if (isset($lists[$lead->getId()])): ?>
          <div class="pa-sm panel-segments">
            <div class="panel-title">
              <?php echo $view['translator']->trans('milex.lead.lead.lists'); ?>
            </div>
            <?php foreach ($lists[$lead->getId()] as $key => $list): ?>
              <h5 class="pull-left mt-xs mr-xs">
                    <span class="label label-success">
                        <a href="<?php echo $view['router']->path('milex_segment_action', ['objectAction' => 'view', 'objectId' => $list['id']]); ?>" data-toggle="ajax" style="color: white;">
