...
<div class="ml-lg mr-lg mt-md pa-lg">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $view['translator']->trans('milex.lead.import.default.owner'); ?></div>
        </div>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $view['translator']->trans('milex.lead.import.fields'); ?></div>
        </div>
        <div class="panel-body">
