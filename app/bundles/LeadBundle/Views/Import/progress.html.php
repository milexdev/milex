...
$header     = ($complete) ? 'milex.lead.import.success' : 'milex.lead.import.donotleave';
?>
    ...
    <div class="col-sm-offset-3 col-sm-6 text-center">
        <div class="panel panel-<?php echo ($complete) ? 'success' : 'danger'; ?>">
            ...
            <div class="panel-body">
                <?php if (!$complete): ?>
                    <h4><?php echo $view['translator']->trans('milex.lead.import.inprogress'); ?></h4>
                <?php else: ?>
                    <h4>
                        <?php echo $view['translator']->trans(
                            'milex.lead.import.stats',
                            [
                ...
                <?php if (!$complete): ?>
                    <div>
                        <a class="btn btn-danger" href="<?php echo $view['router']->path(
                            ...
                            <?php echo $view['translator']->trans('milex.core.form.cancel'); ?>
                        </a>
                        <a class="btn btn-primary" href="<?php echo $view['router']->path(
                            'milex_import_action',
                            ['objectAction' => 'queue', 'object' => $object]
                        ); ?>" data-toggle="ajax">
                            <?php echo $view['translator']->trans('milex.lead.import.queue.btn'); ?>
                        </a>
                    </div>
                <?php else: ?>
                    <div>
                        <a class="btn btn-success" href="<?php echo $view['router']->path($indexRoute, $indexRouteParams); ?>" data-toggle="ajax">
                            <?php echo $view['translator']->trans('milex.lead.list.view', ['%objects%' => $objectName]); ?>
                        </a>
                        <a class="btn btn-success" href="<?php echo $view['router']->path('milex_import_index', ['object' => $object]); ?>" data-toggle="ajax">
                            <?php echo $view['translator']->trans('milex.lead.view.imports'); ?>
                        </a>
                        <a class="btn btn-success" href="<?php echo $view['router']->path(
                            'milex_import_action',
                            ['objectAction' => 'view', 'objectId' => $import->getId(), 'object' => $object]
                        ); ?>" data-toggle="ajax">
                            <?php echo $view['translator']->trans('milex.lead.import.result.info', ['%import%' => $import->getName()]); ?>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
