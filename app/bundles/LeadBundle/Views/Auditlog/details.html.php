...
switch ($type) {
    case 'create':
        ...
        break;
    case 'delete':
        $text = $view['translator']->trans('milex.lead.audit.deleted');
        break;
    case 'update':
        $text = '<table class="table">';
        $text .= '<tr>';
        ...
        break;
    case 'identified':
        $text = $view['translator']->trans('milex.lead.audit.identified');
        break;
    case 'ipadded':
        $text = $view['translator']->trans('milex.lead.audit.accessed').' '.implode(',', array_splice($details, 1));
        break;
    case 'merged':
        $text = $view['translator']->trans('milex.lead.audit.merged');
        break;
}
echo $text;
