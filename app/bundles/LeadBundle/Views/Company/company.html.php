    ...
    $buttons[] = [
        'attr' => [
            ...
            'data-header' => $view['translator']->trans(
                'milex.lead.company.header.merge',
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="contacts-table">
                        <?php echo $view->render(
                            'MilexLeadBundle:Company:list_rows_contacts.html.php',
                            [
                                'contacts'    => $items,
                                'company'     => $company,
                                'tmpl'        => 'index',
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo $view['translator']->trans('milex.lead.field.group.company'); ?>
                </div>
            </div>
            <div class="panel-body pt-sm">
            <?php if ($company->getOwner()) : ?>
                <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.lead.company.field.owner'); ?></h6>
            ...
            <?php endif; ?>
                ...
                <?php
                    ...
                    if (isset($company)) :
                ?>
                    <h6 class="fw-sb"><?php echo $view['translator']->trans('milex.company.phone'); ?></h6>
