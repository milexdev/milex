        ...
        <table class="table table-hover table-striped table-bordered" id="leadTable">
            ...
            <?php foreach ($contacts as $contact) : ?>
                ...
                <tr>
                        ...
                        if (!empty($fields['core']['email']['value'])) {
                            $custom[] = [
                                'attr' => [
                                    ...
                                    'href'        => $view['router']->path('milex_contact_action', ['objectId' => $contact->getId(), 'objectAction' => 'email', 'list' => 1]),
                                ],
                    ...
                    <td>
                        <a href="<?php echo $view['router']->path('milex_contact_action', ['objectAction' => 'view', 'objectId' => $contact->getId()]); ?>" data-toggle="ajax">
