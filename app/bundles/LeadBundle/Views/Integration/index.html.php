...
<div class="alert alert-warning col-md-6 col-md-offset-3 mt-md">
    <h4><?php echo $view['translator']->trans('milex.lead.integrations.header'); ?></h4>
</div>
<?php else: ?>
<?php $count = 0; ?>
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <dl class="dl-horizontal">
                    <dt><?php echo $view['translator']->trans('milex.integration.object'); ?></dt>
                    <dd><?php echo $details['integration_entity']; ?></dd>
                    <dt><?php echo $view['translator']->trans('milex.integration.object_id'); ?></dt>
                    <dd><?php echo $details['integration_entity_id']; ?></dd>
                    <dt><?php echo $view['translator']->trans('milex.core.date.added'); ?></dt>
                    <dd><?php echo $view['date']->toText($details['date_added'], 'UTC', 'Y-m-d H:i:s', true); ?></dd>
                    <dt><?php echo $view['translator']->trans('milex.integration.last_sync_date'); ?></dt>
