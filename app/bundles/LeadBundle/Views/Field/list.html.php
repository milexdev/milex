...
/** @var \Milex\LeadBundle\Entity\LeadField $item */
if ('index' == $tmpl) {
    $view->extend('MilexLeadBundle:Field:index.html.php');
}
?>
<?php if (count($items)): ?>
    <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered leadfield-list" id="leadFieldTable" class="overflow:auto">
            ...
            <tr>
                ...
                ?>
                <th class="col-leadfield-label"><?php echo $view['translator']->trans('milex.lead.field.label'); ?></th>
                <th class="visible-md visible-lg col-leadfield-alias"><?php echo $view['translator']->trans('milex.core.alias'); ?></th>
                <th class="visible-md visible-lg col-leadfield-group"><?php echo $view['translator']->trans('milex.lead.field.object'); ?></th>
                <th class="visible-md visible-lg col-leadfield-group"><?php echo $view['translator']->trans('milex.lead.field.group'); ?></th>
                <th class="col-leadfield-type"><?php echo $view['translator']->trans('milex.lead.field.type'); ?></th>
                <th class="visible-md visible-lg col-leadfield-id"><?php echo $view['translator']->trans('milex.core.id'); ?></th>
            ...
            <?php foreach ($items as $item): ?>
                <tr id="field_<?php echo $item->getId(); ?>">
                    ...
                    <span class="ellipsis">
                        <?php
                        $aditionalText = $item->getColumnIsNotCreated() ? ' ('.$view['translator']->trans('milex.lead.field.being_created_in_background').')' : null;
                        echo $view->render(
                    ...
                    <td class="visible-md visible-lg"><?php echo $view['translator']->trans('milex.'.$item->getObject().'.'.$item->getObject()); ?></td>
                    <td class="visible-md visible-lg"><?php echo $view['translator']->trans('milex.lead.field.group.'.$item->getGroup()); ?></td>
                    <td><?php echo $view['translator']->transConditional(
                            'milex.core.type.'.$item->getType(),
                            'milex.lead.field.type.'.$item->getType()
                        ); ?></td>
                    ...
                    <td class="visible-sm visible-md visible-lg">
                        <?php if ($item->isRequired()): ?>
                            <i class="fa fa-asterisk" data-toggle="tooltip" data-placement="left" title="<?php echo $view['translator']->trans(
                                'milex.lead.field.tooltip.required'
                            ); ?>"></i>
                        <?php endif; ?>
                        ...
                        <?php if ($item->isPubliclyUpdatable()): ?>
                            <i class="fa fa-globe text-danger " data-toggle="tooltip" data-placement="left" title="<?php echo $view['translator']->trans(
                                'milex.lead.field.tooltip.public'
                            ); ?>"></i>
                        <?php endif; ?>
                        ...
                        <?php if ($item->isUniqueIdentifer()): ?>
                            <i class="fa fa-key " data-toggle="tooltip" data-placement="left" title="<?php echo $view['translator']->trans(
                                'milex.lead.field.tooltip.isuniqueidentifer'
                            ); ?>"></i>
                        <?php endif; ?>
                    </td>
                </tr>
    ...
    <div class="panel-footer">
        <?php echo $view->render(
            ...
            [
                ...
                'page'       => $page,
                'limit'      => $limit,
                'baseUrl'    => $view['router']->path('milex_contactfield_index'),
