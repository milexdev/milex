...
if (!empty($userId)) {
    ...
    $header = $view['translator']->trans('milex.lead.field.header.edit', ['%name%' => $field]);
} else {
    $isNew  = true;
    $header = $view['translator']->trans('milex.lead.field.header.new');
}
            ...
            <div class="row">
                <div class="form-group col-md-6<?php echo $feedbackClass; ?>">
                    <div id="leadfield_properties">
                        ...
                        switch ($type):
                        case 'boolean':
                            echo $view->render('MilexLeadBundle:Field:properties_boolean.html.php', [
                                'yes' => isset($properties['yes']) ? $properties['yes'] : '',
                                'no'  => isset($properties['no']) ? $properties['no'] : '',
                            ]);
                            break;
                        case 'number':
                            echo $view->render('MilexLeadBundle:Field:properties_number.html.php', [
                        ...
                        case 'select':
                            case 'multiselect':
                            echo $view->render('MilexLeadBundle:Field:properties_select.html.php', [
                        ...
                        case 'lookup':
                            echo $view->render('MilexLeadBundle:Field:properties_select.html.php', [
                                ...
                                break;
                        case 'textarea':
                            echo $view->render('MilexLeadBundle:Field:properties_textarea.html.php', [
                                'form'             => $form['properties'],
            ...
            <div class="row unique-identifier-warning" style="<?php if (!$form['isUniqueIdentifer']->vars['data']): echo 'display:none;'; endif; ?>">
                <div class="col-md-12">
                    <div class="alert alert-danger">
                        <?php echo $view['translator']->trans('milex.lead.field.form.isuniqueidentifer.warning'); ?>
                    </div>
                </div>
            </div>
