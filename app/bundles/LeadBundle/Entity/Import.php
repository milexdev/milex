...
class Import extends FormEntity
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        $metadata->addPropertyConstraint('dir', new Assert\NotBlank(
            ['message' => 'milex.lead.import.dir.notblank']
        ));

        $metadata->addPropertyConstraint('file', new Assert\NotBlank(
            ['message' => 'milex.lead.import.file.notblank']
        ));
    }
    ...
    {
        $chart = new PieChart();
        $chart->setDataset($translator->trans('milex.lead.import.inserted.count'), $this->getInsertedCount());
        $chart->setDataset($translator->trans('milex.lead.import.updated.count'), $this->getUpdatedCount());
        $chart->setDataset($translator->trans('milex.lead.import.ignored.count'), $this->getIgnoredCount());
