...
class Lead extends FormEntity implements CustomFieldEntityInterface, IdentifierFieldEntityInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('leads')
            ->setCustomRepositoryClass('Milex\LeadBundle\Entity\LeadRepository')
        ...
        $builder->createManyToOne('owner', 'Milex\UserBundle\Entity\User')
            ->fetchLazy()
        ...
        $builder->createOneToMany('doNotContact', 'Milex\LeadBundle\Entity\DoNotContact')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadePersist()
            ->cascadeDetach()
        ...
        $builder->createManyToMany('ipAddresses', 'Milex\CoreBundle\Entity\IpAddress')
        ...
        $builder->createOneToMany('pushIds', 'Milex\NotificationBundle\Entity\PushID')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadeAll()
            ->fetchExtraLazy()
        ...
        $builder->createManyToMany('tags', 'Milex\LeadBundle\Entity\Tag')
        ...
        $builder->createOneToMany('utmtags', 'Milex\LeadBundle\Entity\UtmTag')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadeAll()
            ->fetchExtraLazy()
        ...
        $builder->createOneToMany('frequencyRules', 'Milex\LeadBundle\Entity\FrequencyRule')
            ->orphanRemoval()
            ->setIndexBy('channel')
            ->setOrderBy(['dateAdded' => 'DESC'])
            ->mappedBy('lead')
    ...
    public function getPrimaryIdentifier($lastFirst = false)
    {
        if ($name = $this->getName($lastFirst)) {
            ...
            return 'milex.lead.lead.anonymous';
        }
    }
     ...
     * Set stage.
     *
     * @param \Milex\StageBundle\Entity\Stage $stage
     *
     * @return Stage
     */
