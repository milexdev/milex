...
use Milex\LeadBundle\Form\Validator\Constraints\SegmentInUse;
use Milex\LeadBundle\Form\Validator\Constraints\UniqueUserAlias;
...
class LeadList extends FormEntity
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addConstraint(new UniqueUserAlias([
            'field'   => 'alias',
            'message' => 'milex.lead.list.alias.unique',
        ]));
