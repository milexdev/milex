...
trait OperatorListTrait
{
    ...
    /**
     * @deprecated to be removed in Milex 3. Use FilterOperatorProvider::getAllOperators() instead.
     *
    ...
    /**
     * @deprecated These aliases are subscribed in the TypeOperatorSubscriber now so this is not necessary. To be removed in next Milex version.
     *
