...
namespace Milex\LeadBundle\Security\Permissions;
    ...
    public function buildForm(FormBuilderInterface &$builder, array $options, array $data)
    {
        ...
        $builder->add(
            ...
            [
                ...
                'label'             => 'milex.lead.permissions.lists',
        ...
        $builder->add(
            ...
            [
                'choices' => [
                    'milex.core.permissions.manage' => 'full',
                    'milex.core.permissions.view'   => 'view',
                ],
                'label'             => 'milex.lead.permissions.fields',
