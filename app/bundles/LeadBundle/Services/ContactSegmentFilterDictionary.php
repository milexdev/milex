...
use Milex\LeadBundle\Event\SegmentDictionaryGenerationEvent;
use Milex\LeadBundle\Exception\FilterNotFoundException;
use Milex\LeadBundle\LeadEvents;
use Milex\LeadBundle\Segment\Query\Filter\BaseFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\ChannelClickQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\DoNotContactFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\ForeignFuncFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\ForeignValueFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\IntegrationCampaignFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\SegmentReferenceFilterQueryBuilder;
use Milex\LeadBundle\Segment\Query\Filter\SessionsFilterQueryBuilder;
