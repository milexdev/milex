...
use Milex\LeadBundle\Event\ChannelSubscriptionChange;
...
use Milex\LeadBundle\Event\PointsChangeEvent;
...
class WebhookSubscriber implements EventSubscriberInterface
{
    ...
    public function onWebhookBuild(WebhookBuilderEvent $event)
    {
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.new',
                'description' => 'milex.lead.webhook.event.lead.new_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.update',
                'description' => 'milex.lead.webhook.event.lead.update_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.points',
                'description' => 'milex.lead.webhook.event.lead.points_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.deleted',
                'description' => 'milex.lead.webhook.event.lead.deleted_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.dnc',
                'description' => 'milex.lead.webhook.event.lead.dnc_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.lead.company.change',
                'description' => 'milex.lead.webhook.event.lead.company.change.desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.company.new_or_update',
                'description' => 'milex.lead.webhook.event.company.new_or_update_desc',
            ]
        );
        ...
        $event->addEvent(
            ...
            [
                'label'       => 'milex.lead.webhook.event.company.deleted',
                'description' => 'milex.lead.webhook.event.company.deleted_desc',
            ]
        );
    }
