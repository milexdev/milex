...
class CalendarSubscriber implements EventSubscriberInterface
{
    ...
    public function onCalendarGenerate(CalendarGeneratorEvent $event)
    {
        ...
        $query->select('ln.lead_id, l.firstname, l.lastname, ln.date_time AS start, ln.text AS description, ln.type')
            ->from(MILEX_TABLE_PREFIX.'lead_notes', 'ln')
            ->leftJoin('ln', MILEX_TABLE_PREFIX.'leads', 'l', 'ln.lead_id = l.id')
        ...
        foreach ($results as &$object) {
            ...
            $object['url']         = $this->router->generate('milex_contact_action', ['objectAction' => 'view', 'objectId' => $object['lead_id']], true);
            ...
            //$object['title'] .= ' (' . $this->translator->trans('milex.lead.note.type.' . $object['type']) . ')';
        }
