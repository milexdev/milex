...
use Milex\LeadBundle\Event\LeadListFiltersOperatorsEvent;
...
use Milex\LeadBundle\Provider\FieldChoicesProviderInterface;
use Milex\LeadBundle\Provider\TypeOperatorProviderInterface;
...
final class FilterOperatorSubscriber implements EventSubscriberInterface
{
    ...
    {
        // Only show for segments and not dynamic content addressed by https://github.com/milex/milex/pull/9260
        ...
        $staticFields = [
            'date_added' => [
                'label'      => $this->translator->trans('milex.core.date.added'),
                'properties' => ['type' => 'date'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'date_identified' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.date_identified'),
                'properties' => ['type' => 'date'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'last_active' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.last_active'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'date_modified' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.date_modified'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'owner_id' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.owner'),
                'properties' => [
                    'type'     => 'lookup_id',
            ...
            'points' => [
                'label'      => $this->translator->trans('milex.lead.lead.event.points'),
                'properties' => ['type' => 'number'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'leadlist' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lists'),
                'properties' => [
                    'type' => 'leadlist',
            ...
            'campaign' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.campaign'),
                'properties' => [
                    'type' => 'campaign',
            ...
            'tags' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.tags'),
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('multiselect'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'tags',
            ...
            'device_type' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.device_type'),
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('multiselect'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'device_type',
            ...
            'device_brand' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.device_brand'),
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('multiselect'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'device_brand',
            ...
            'device_os' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.device_os'),
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('multiselect'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'device_os',
            ...
            'device_model' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.device_model'),
            ...
            'dnc_bounced' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_bounced'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'dnc_unsubscribed' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_unsubscribed'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'dnc_manual_email' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_manual_email'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'dnc_bounced_sms' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_bounced_sms'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'dnc_unsubscribed_sms' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_unsubscribed_sms'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'dnc_manual_sms' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.dnc_manual_sms'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'stage' => [
                'label'      => $this->translator->trans('milex.lead.lead.field.stage'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'stage',
            ...
            'globalcategory' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.categories'),
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('multiselect'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'globalcategory',
            ...
            'utm_campaign' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.utmcampaign'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'utm_content' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.utmcontent'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'utm_medium' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.utmmedium'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'utm_source' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.utmsource'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'utm_term' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.utmterm'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
    ...
    public function onGenerateSegmentFiltersAddBehaviors(LeadListFiltersChoicesEvent $event): void
    {
        ...
        $choices = [
            'lead_asset_download' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_asset_download'),
                'properties' => [
                    'type' => 'assets',
            ...
            'lead_email_received' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_email_received'),
                'object'     => 'lead',
                'properties' => [
            ...
            'lead_email_sent' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_email_sent'),
                'object'     => 'lead',
                'properties' => [
                    'type' => 'lead_email_received',
            ...
            'lead_email_sent_date' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_email_sent_date'),
                'object'     => 'lead',
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
            ...
            'lead_email_read_date' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_email_read_date'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'lead_email_read_count' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.lead_email_read_count'),
                'object'     => 'lead',
                'properties' => ['type' => 'number'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
            ...
            'hit_url' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.visited_url'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'hit_url_date' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.visited_url_date'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'hit_url_count' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.visited_url_count'),
                'properties' => ['type' => 'number'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::GREATER_THAN,
            ...
            'email_id' => [ // kept as email_id for BC
                'label'      => $this->translator->trans('milex.lead.list.filter.email_id'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'email_clicked_link_date' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.email_clicked_link_date'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'sms_clicked_link' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.sms_clicked_link'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'sms_clicked_link_date' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.sms_clicked_link_date'),
                'properties' => ['type' => 'datetime'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'sessions' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.session'),
                'properties' => ['type' => 'number'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::GREATER_THAN,
            ...
            'referer' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.referer'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'url_title' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.url_title'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'source' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.source'),
                'properties' => ['type' => 'text'],
                'operators'  => $this->typeOperatorProvider->getOperatorsIncluding([
                    OperatorOptions::EQUAL_TO,
                    OperatorOptions::NOT_EQUAL_TO,
            ...
            'source_id' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.source.id'),
                'properties' => ['type' => 'number'],
                'operators'  => $this->typeOperatorProvider->getOperatorsForFieldType('default'),
                'object'     => 'lead',
            ],
            'notification' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.notification'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'page_id' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.page_id'),
                'properties' => [
                    'type' => 'boolean',
            ...
            'redirect_id' => [
                'label'      => $this->translator->trans('milex.lead.list.filter.redirect_id'),
                'properties' => [
                    'type' => 'boolean',
    ...
    private function isForSegmentation(LeadListFiltersChoicesEvent $event): bool
    {
        ...
        // segment form
        if ('milex_segment_action' === $route) {
            return true;
        }

        // segment API
        if (0 === strpos($route, 'milex_api_lists')) {
            return true;
        }
