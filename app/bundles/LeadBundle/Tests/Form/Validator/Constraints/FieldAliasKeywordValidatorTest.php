...
namespace Milex\LeadBundle\Tests\Form\Validator\Constraints;

use Doctrine\ORM\EntityManager;
use Doctrine\ORM\UnitOfWork;
use Milex\LeadBundle\Entity\LeadField;
use Milex\LeadBundle\Form\Validator\Constraints\FieldAliasKeyword;
use Milex\LeadBundle\Form\Validator\Constraints\FieldAliasKeywordValidator;
use Milex\LeadBundle\Helper\FieldAliasHelper;
...
class FieldAliasKeywordValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddValidationFailure()
    {
        ...
        $this->executionContextMock->expects($this->once())->method('addViolation')->with('milex.lead.field.keyword.invalid');
