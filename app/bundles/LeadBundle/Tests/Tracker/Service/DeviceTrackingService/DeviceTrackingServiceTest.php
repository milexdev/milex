...
namespace Milex\LeadBundle\Tests\Tracker\Service\DeviceTrackingService;
...
use Milex\LeadBundle\Tracker\Service\DeviceTrackingService\DeviceTrackingService;
...
final class DeviceTrackingServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTrackCurrentDeviceAlreadyTrackedReplaceExistingTracking(): void
    {
        ...
        $this->cookieHelperMock->method('setCookie')
            ->withConsecutive(['milex_device_id', $uniqueTrackingIdentifier, 31536000]);
