...
namespace Milex\LeadBundle\Tests\Command;

use Milex\CoreBundle\Test\MilexMysqlTestCase;
use Milex\LeadBundle\Command\UpdateLeadListsCommand;
use Milex\LeadBundle\Entity\Lead;
use Milex\LeadBundle\Entity\LeadList;
use Milex\LeadBundle\Entity\LeadListRepository;
use PHPUnit\Framework\Assert;

final class UpdateLeadListCommandFunctionalTest extends MilexMysqlTestCase
{
    /**
