        ...
        $this->form->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'attr'                      => [
                        'class'                => 'form-control',
                        'data-placeholder'     => 'milex.lead.tags.select_or_create',
                        'data-no-results-text' => 'milex.lead.tags.enter_to_create',
                        'data-allow-add'       => true,
                        ...
                        function (array $options) {
                            ...
                            $this->assertSame(
                                [
                                    ...
                                    'data-target'           => 'owner',
                                    'placeholder'           => 'milex.lead.list.form.startTyping',
                                    'data-no-record-message'=> 'milex.core.form.nomatches',
                                ],
                                $options['attr']
                            );
            ...
            ->with(
                ...
                [
                    ...
                    'attr'     => [
                        ...
                        'placeholder'  => 'milex.lead.list.form.filtervalue',
                    ],
                ]
            );
