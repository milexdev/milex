...
use Milex\LeadBundle\EventListener\ReportUtmTagSubscriber;
...
class ReportUtmTagSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function getQueryBuilderMock()
    {
        ...
        $queryBuilderMock->expects($this->once())
            ->method('from')
            ->with(MILEX_TABLE_PREFIX.'lead_utmtags', 'utm')
            ->willReturn($queryBuilderMock);

        $queryBuilderMock->method('leftJoin')
            ->withConsecutive(['utm', MILEX_TABLE_PREFIX.'leads', 'l', 'l.id = utm.lead_id'])
            ->willReturn($queryBuilderMock);
