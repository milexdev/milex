...
use Milex\LeadBundle\EventListener\FilterOperatorSubscriber;
...
final class FilterOperatorSubscriberTest extends TestCase
{
    ...
    public function testOnGenerateSegmentFiltersAddStaticFields(): void
    {
        ...
        $request = new Request();
        $request->attributes->set('_route', 'milex_segment_action');
        ...
        $this->assertSame(
            [
                'label'      => 'milex.lead.list.filter.date_identified',
                'properties' => [
                    'type' => 'date',
                ],
                'operators' => [
        ...
        $this->assertSame(
            [
                'label'      => 'milex.lead.list.filter.device_model',
                'properties' => [
                    'type' => 'text',
                ],
                'operators' => [
        ...
        $this->assertSame(
            [
                'label'      => 'milex.lead.list.filter.dnc_manual_email',
                'properties' => [
                    'type' => 'boolean',
                    'list' => [
                        'Choice A' => 'choice_a',
    ...
    public function testOnGenerateSegmentFiltersAddBehaviors(): void
    {
        ...
        $this->assertSame(
            [
                'label'      => 'milex.lead.list.filter.lead_email_received',
                'object'     => 'lead',
                'properties' => [
        ...
        $this->assertSame(
            [
                'label'      => 'milex.lead.list.filter.visited_url_count',
                'properties' => [
                    'type' => 'number',
                ],
                'operators' => [
    ...
    {
        $request = new Request();
        $request->attributes->set('_route', 'milex_dynamicContent_action');
