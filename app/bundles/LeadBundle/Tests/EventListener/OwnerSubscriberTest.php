...
use Milex\LeadBundle\EventListener\OwnerSubscriber;
...
class OwnerSubscriberTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @return MilexFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getMockFactory($mailIsOwner = true, $parameterMap = [])
    {
        ...
        /** @var MilexFactory|\PHPUnit_Framework_MockObject_MockObject $mockFactory */
