...
class LeadRepositoryFunctionalTest extends MilexMysqlTestCase
{
    /**
     * @var Lead
     */
    ...
    {
        $model = self::$container->get('milex.lead.model.lead');
    ...
    public function testMixedModelAndRepositorySavesDoNotDoublePoints()
    {
        ...
        $model->saveEntity($this->lead);
        $this->em->getRepository('MilexLeadBundle:Lead')->saveEntity($this->lead);
