...
class ListControllerFunctionalTest extends MilexMysqlTestCase
{
    /**
     * @var ListModel
     */
    ...
    {
        parent::setUp();
        $this->listModel = self::$container->get('milex.lead.model.list');
        ...
        $leadModel = self::$container->get('milex.lead.model.lead');
    ...
    public function testSegmentCount(): void
    {
        ...
        $this->runCommand('milex:segments:update', ['-i' => $segmentId, '--env' => 'test']);
