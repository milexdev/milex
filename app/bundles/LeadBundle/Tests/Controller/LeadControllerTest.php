...
namespace Milex\LeadBundle\Tests\Controller;

use Milex\CampaignBundle\Entity\Campaign;
use Milex\CoreBundle\Entity\AuditLog;
use Milex\CoreBundle\Test\MilexMysqlTestCase;
use Milex\LeadBundle\DataFixtures\ORM\LoadCategorizedLeadListData;
use Milex\LeadBundle\DataFixtures\ORM\LoadCategoryData;
...
class LeadControllerTest extends MilexMysqlTestCase
{
    /**
     ...
     * We do more in-depth tests in \Milex\CoreBundle\Tests\Unit\Helper\ExportHelperTest.
     */
    ...
    public function testContactsAreAddedAndRemovedFromCompanies(): void
    {
        ...
        $this->connection->createQueryBuilder()
            ->delete(MILEX_TABLE_PREFIX.'companies_leads')
            ->execute();
    ...
    public function testEnsureCorrectPreferredTimeZonePlaceHolderOnContactPage(): void
    {
        ...
        $expectedPlaceholder = self::$container->get('translator')->trans('milex.lead.field.timezone');
    ...
    public function testAddContactsErrorMessage(): void
    {
        ...
        $fieldModel     = self::getContainer()->get('milex.lead.model.field');
    ...
    private function getCompanyLeads(int $leadId): array
    {
        return $this->connection->createQueryBuilder()
            ...
            ->join('cl', MILEX_TABLE_PREFIX.'companies', 'c', 'c.id = cl.company_id')
    ...
    public function testContactCompanyEditShowsOldCompanyNameInAuditLog(): void
    {
        ...
        $contactModel = self::$container->get('milex.lead.model.lead');
