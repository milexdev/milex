...
use Milex\LeadBundle\Field\Command\CreateCustomFieldCommand;
 ...
 */
final class FieldApiControllerFunctionalTest extends MilexMysqlTestCase
{
    ...
    /**
     * @covers \Milex\LeadBundle\Controller\Api\FieldApiController::saveEntity
     * @covers \Milex\LeadBundle\Controller\Api\FieldApiController::newEntityAction
     * @covers \Milex\LeadBundle\Controller\Api\FieldApiController::editEntityAction
     * @covers \Milex\LeadBundle\Controller\Api\FieldApiController::deleteEntityAction
     * @covers \Milex\LeadBundle\Field\Command\CreateCustomFieldCommand::execute
     */
    ...
    private function executeCommand(int $id): void
    {
        ...
        $command    = $this->client->getKernel()->getContainer()->get('milex.lead.command.create_custom_field');
