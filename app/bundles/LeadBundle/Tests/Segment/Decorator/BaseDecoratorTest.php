...
{
    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getField
     */
    ...
    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getTable
     */
    public function testGetTableLead(): void
    {
        ...
        $this->assertSame(MILEX_TABLE_PREFIX.'leads', $baseDecorator->getTable($contactSegmentFilterCrate));
    }
    ...
    public function testGetTableCompany(): void
    {
        ...
        $this->assertSame(MILEX_TABLE_PREFIX.'companies', $baseDecorator->getTable($contactSegmentFilterCrate));
    }

    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getOperator
     */
    ...
    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getQueryType
     */
    public function testGetQueryType(): void
    {
        ...
        $this->assertSame('milex.lead.query.builder.basic', $baseDecorator->getQueryType($contactSegmentFilterCrate));
    }

    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getParameterHolder
     */
    ...
    /**
     * @covers \Milex\LeadBundle\Segment\Decorator\BaseDecorator::getParameterValue
     */
