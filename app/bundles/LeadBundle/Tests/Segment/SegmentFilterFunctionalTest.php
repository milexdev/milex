...
class SegmentFilterFunctionalTest extends MilexMysqlTestCase
{
    /**
     * @var Lead[]
     */
    ...
    private function buildSegment(LeadList $segment, int $expectedCountInSegment): void
    {
        ...
        $contactSegmentService = self::$container->get('milex.lead.model.lead_segment_service');
    ...
    private function getSegmentsProvider(): \Generator
    {
        yield [
            'contacts' => [
                ['email' => 'lukas@milex.com', 'in_segment' => true, 'city' => 'Prague'],
                ['email' => 'lukas2@milex.com', 'in_segment' => true, 'city' => 'Prague 11'],
                ['email' => 'lukas3@milex.com', 'in_segment' => false, 'city' => 'Praha'],
            ],
            'segment' => [
        ...
        yield [
            'contacts' => [
                ['email' => 'lukas@milex.com', 'in_segment' => true, 'points' => 20],
                ['email' => 'lukas2@milex.com', 'in_segment' => false, 'points' => 10],
                ['email' => 'lukas3@milex.com', 'in_segment' => true, 'points' => 25],
            ],
            'segment' => [
