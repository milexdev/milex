...
use Milex\LeadBundle\Entity\RegexTrait;
        ...
        switch ($fieldType) {
            ...
            case 'tags':
                ...
                $attr                                       = array_merge(
                    $attr,
                    [
                        'data-placeholder'     => $translator->trans('milex.lead.tags.select_or_create'),
                        'data-no-results-text' => $translator->trans('milex.lead.tags.enter_to_create'),
                        'data-allow-add'       => 'true',
                ...
                $displayAttr = array_merge(
                    ...
                    [
                        ...
                        'placeholder'          => $translator->trans(
                            'milex.lead.list.form.filtervalue'
                        ),
                    ]
                );
            ...
            case 'boolean':
                $attr = array_merge(
                    $attr,
                    [
                        'placeholder' => $translator->trans('milex.lead.list.form.filtervalue'),
                    ]
                );
                    ...
                    new Callback(
                        function ($regex, ExecutionContextInterface $context) {
                            ...
                            try {
                                ...
                                $context->buildViolation('milex.core.regex.invalid')->addViolation();
                            }
                        }
                    );
            }
        ...
        $form->add(
            ...
            [
                ...
                'attr'    => [
                    ...
                    'onchange' => 'Milex.convertDwcFilterInput(this)',
                ],
            ]
        );
