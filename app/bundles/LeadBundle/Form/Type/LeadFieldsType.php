        ...
        $resolver->setDefaults([
            'choices' => function (Options $options) {
                ...
                if ($options['with_tags']) {
                    $fieldList['Core']['milex.lead.field.tags'] = 'tags';
                }
                ...
                if ($options['with_utm']) {
                    $fieldList['UTM']['milex.lead.field.utmcampaign'] = 'utm_campaign';
                    $fieldList['UTM']['milex.lead.field.utmcontent']  = 'utm_content';
                    $fieldList['UTM']['milex.lead.field.utmmedium']   = 'utm_medium';
                    $fieldList['UTM']['milex.lead.field.umtsource']   = 'utm_source';
                    $fieldList['UTM']['milex.lead.field.utmterm']     = 'utm_term';
                }
