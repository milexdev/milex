...
class CampaignEventLeadCampaignsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('campaigns',
            ...
            'label'      => 'milex.lead.lead.events.campaigns.membership',
        ...
        $builder->add(
            ...
            [
                'label' => 'milex.lead.lead.events.campaigns.date.added.filter',
        ...
        $builder->add(
            ...
            ChoiceType::class,
            [
                'label'             => 'milex.lead.lead.events.campaigns.expression',
                'multiple'          => false,
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.lead.lead.events.campaigns.date',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
