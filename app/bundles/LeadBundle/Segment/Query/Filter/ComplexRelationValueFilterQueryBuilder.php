 ...
 *
 * @see \Milex\LeadBundle\Segment\Decorator\CompanyDecorator
 */
class ComplexRelationValueFilterQueryBuilder extends BaseFilterQueryBuilder
{
    ...
    {
        return 'milex.lead.query.builder.complex_relation.value';
    }
    ...
    public function applyQuery(QueryBuilder $queryBuilder, ContactSegmentFilter $filter)
    {
        ...
        switch ($filterOperator) {
            ...
            case 'regexp':
            case 'notRegexp': //Different behaviour from 'notLike' because of BC (do not use condition for NULL). Could be changed in Milex 3.
