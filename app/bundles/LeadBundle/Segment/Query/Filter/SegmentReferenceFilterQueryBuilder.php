...
use Milex\LeadBundle\Segment\Query\ContactSegmentQueryBuilder;
use Milex\LeadBundle\Segment\Query\Expression\CompositeExpression;
...
class SegmentReferenceFilterQueryBuilder extends BaseFilterQueryBuilder
{
    ...
    {
        return 'milex.lead.query.builder.special.leadlist';
    }
    ...
    public function applyQuery(QueryBuilder $queryBuilder, ContactSegmentFilter $filter)
    {
        ...
        foreach ($segmentIds as $segmentId) {
            ...
            $contactSegment = $this->entityManager->getRepository('MilexLeadBundle:LeadList')->find($segmentId);
            if (!$contactSegment) {
            ...
            $subSegmentLeadsTableAlias = $segmentQueryBuilder->getTableAlias(MILEX_TABLE_PREFIX.'leads');
