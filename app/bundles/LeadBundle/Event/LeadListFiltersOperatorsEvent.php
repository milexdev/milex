...
class LeadListFiltersOperatorsEvent extends CommonEvent
{
    ...
    /**
     * @deprecated to be removed in Milex 3
     *
     ...
     * @deprecated to be removed in Milex 3
     *
     * @param array               $operators  @deprecated to be removed in Milex 3. Subscribe operators instead.
     * @param TranslatorInterface $translator @deprecated to be removed in Milex 3
     */
    ...
    /**
     * @deprecated to be removed in Milex 3. Use DI instead.
     *
