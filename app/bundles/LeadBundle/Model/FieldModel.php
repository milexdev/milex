...
use Milex\LeadBundle\Field\SchemaDefinition;
use Milex\LeadBundle\Form\Type\FieldType;
    ...
    public function getFieldListWithProperties($object = 'lead')
    {
        ...
        foreach ($contactFields as $contactField) {
            $fields[$contactField['alias']] = [
                ...
                'group_label'  => $this->translator->trans('milex.lead.field.group.'.$contactField['group']),
