    ...
    public function onDetermineBounceRateWinner(DetermineWinnerEvent $event)
    {
        ...
        if (null != $startDate && !empty($pageIds)) {
            ...
            if ($counts) {
                ...
                $support['data']   = [];
                $support['labels'] = [];
                $bounceLabel       = $this->translator->trans('milex.page.abtest.label.bounces');
        ...
        if (null != $startDate && !empty($pageIds)) {
            ...
            if ($counts) {
                ...
                foreach ($counts as $pid => $stats) {
                    ...
                    $support['data'][$this->translator->trans('milex.page.abtest.label.dewlltime.average')][] = $stats['average'];
                    $support['labels'][]                                                                       = $pid.':'.$stats['title'];
                }
