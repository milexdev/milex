...
use Milex\PageBundle\Form\Type\CampaignEventPageHitType;
use Milex\PageBundle\Form\Type\TrackingPixelSendType;
...
class CampaignSubscriber implements EventSubscriberInterface
{
    ...
    public function onCampaignBuild(CampaignBuilderEvent $event)
    {
        //Add trigger
        $pageHitTrigger = [
            'label'          => 'milex.page.campaign.event.pagehit',
            'description'    => 'milex.page.campaign.event.pagehit_descr',
        ...
        //Add trigger
        $deviceHitTrigger = [
            'label'          => 'milex.page.campaign.event.devicehit',
            'description'    => 'milex.page.campaign.event.devicehit_descr',
        ...
        if (!empty($trackingServices)) {
            $action = [
                'label'                  => 'milex.page.tracking.pixel.event.send',
                'description'            => 'milex.page.tracking.pixel.event.send_desc',
