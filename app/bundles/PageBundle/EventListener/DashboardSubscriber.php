...
use Milex\PageBundle\Form\Type\DashboardHitsInTimeWidgetType;
            ...
            if (!$event->isCached()) {
                ...
                if ($pages) {
                    foreach ($pages as &$page) {
                        $pageUrl = $this->router->generate('milex_page_action', ['objectAction' => 'view', 'objectId' => $page['id']]);
                        $row     = [
                            [
                                'value' => $page['title'],
                                'type'  => 'link',
