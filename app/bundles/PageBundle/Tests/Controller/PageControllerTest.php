...
use Milex\PageBundle\DataFixtures\ORM\LoadPageData;
use Milex\PageBundle\Entity\Page;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;

class PageControllerTest extends MilexMysqlTestCase
{
    use ControllerTrait;
    ...
    protected function setUp(): void
    {
        ...
        $model = self::$container->get('milex.page.model.page');
        $page  = new Page();
    ...
    public function testLandingPageWithUtmTracking(): void
    {
        ...
        $this->client->request('GET', "{$page->getAlias()}?utm_source=linkedin&utm_medium=social&utm_campaign=milex&utm_content=".$timestamp);
        ...
        if (Response::HTTP_OK === $clientResponse->getStatusCode()) {
            ...
            foreach ($allUtmTags as $utmTag) {
                ...
                $this->assertSame('milex', $utmTag->getUtmCampaign(), 'utm_campaign does not match');
