...
namespace Milex\PageBundle\Tests\Controller;
...
use Milex\CoreBundle\Templating\Helper\AnalyticsHelper;
...
use Milex\PageBundle\Controller\PublicController;
...
class PublicControllerTest extends MilexMysqlTestCase
{
    ...
    private function getVariantContent($aCount, $bCount, $cCount)
    {
        ...
        $milexSecurity = $this->getMockBuilder(CorePermissions::class)
            ->disableOriginalConstructor()
            ->getMock();
        $milexSecurity->method('hasEntityAccess')
            ->will($this->returnValue(false));
        ...
        $container->method('get')
            ->will(
                $this->returnValueMap(
                    [
                        ['milex.helper.cookie', Container::EXCEPTION_ON_INVALID_REFERENCE, $cookieHelper],
                        ['templating.helper.assets', Container::EXCEPTION_ON_INVALID_REFERENCE, $assetHelper],
                        ['milex.helper.ip_lookup', Container::EXCEPTION_ON_INVALID_REFERENCE, $ipHelper],
                        ['milex.security', Container::EXCEPTION_ON_INVALID_REFERENCE, $milexSecurity],
                        ['milex.helper.template.analytics', Container::EXCEPTION_ON_INVALID_REFERENCE, $analyticsHelper],
                        ['milex.page.model.page', Container::EXCEPTION_ON_INVALID_REFERENCE, $pageModel],
                        ['milex.lead.model.lead', Container::EXCEPTION_ON_INVALID_REFERENCE, $leadModel],
                        ...
                        ['milex.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $modelFactory],
                    ]
                )
            );
    ...
    public function testThatInvalidClickTroughGetsProcessed(): void
    {
        ...
        $this->internalContainer
            ->method('get')
            ->willReturnMap([
                ['monolog.logger.milex', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->logger],
                ['milex.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['milex.helper.ip_lookup', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->ipLookupHelper],
                ['milex.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['milex.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['milex.lead.helper.primary_company', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->primaryCompanyHelper],
    ...
    /**
     * @covers \Milex\PageBundle\Event\TrackingEvent::getContact
     * @covers \Milex\PageBundle\Event\TrackingEvent::getResponse
     * @covers \Milex\PageBundle\Event\TrackingEvent::getRequest
     *
     * @throws \Exception
     */
    public function testMtcTrackingEvent()
    {
        ...
        $container->method('get')
            ->will(
                $this->returnValueMap(
                    [
                        ['milex.security', Container::EXCEPTION_ON_INVALID_REFERENCE, $security],
                        ['milex.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $modelFactory],
                        ['milex.page.model.page', Container::EXCEPTION_ON_INVALID_REFERENCE, $pageModel],
                        ['milex.lead.service.device_tracking_service', Container::EXCEPTION_ON_INVALID_REFERENCE, $deviceTrackingService],
                        ['milex.page.helper.tracking', Container::EXCEPTION_ON_INVALID_REFERENCE, $trackingHelper],
    ...
    {
        $this->client->request('GET', '/mtracking.gif?url=http%3A%2F%2Fmilex.org');
