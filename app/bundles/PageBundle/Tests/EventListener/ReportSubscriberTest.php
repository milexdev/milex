...
use Milex\PageBundle\EventListener\ReportSubscriber;
...
class ReportSubscriberTest extends TestCase
{
    ...
    public function testOnReportGraphGenerate(): void
    {
        ...
        $mockEvent->expects($this->once())
            ...
            ->willReturn(
                [
                    'milex.page.graph.line.hits',
                    'milex.page.graph.line.time.on.site',
                    'milex.page.graph.pie.time.on.site',
                    'milex.page.graph.pie.new.vs.returning',
                    'milex.page.graph.pie.languages',
                    'milex.page.graph.pie.devices',
                    'milex.page.table.referrers',
                    'milex.page.table.most.visited',
                    'milex.page.table.most.visited.unique',
                ]
            );
