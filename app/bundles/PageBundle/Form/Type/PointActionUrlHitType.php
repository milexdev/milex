...
use Milex\CoreBundle\Form\DataTransformer\SecondsConversionTransformer;
...
class PointActionUrlHitType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('page_url', TextType::class, [
            'label'      => 'milex.page.point.action.form.page.url',
            'label_attr' => ['class' => 'control-label'],
            'attr'       => [
                'class'       => 'form-control',
                'tooltip'     => 'milex.page.point.action.form.page.url.descr',
                'placeholder' => 'http://',
            ],
        ]);

        $builder->add('page_hits', IntegerType::class, [
            'label'      => 'milex.page.hits',
            'label_attr' => ['class' => 'control-label'],
            'required'   => false,
            'attr'       => [
                'class'   => 'form-control',
                'tooltip' => 'milex.page.point.action.form.page.hits.descr',
            ],
        ]);
        ...
        $formModifier = function (FormInterface $form, $data) use ($builder) {
            ...
            $form->add(
                $builder->create('accumulative_time', TextType::class, [
                    'label'      => 'milex.page.point.action.form.accumulative.time',
                    'required'   => false,
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'   => 'form-control',
                        'tooltip' => 'milex.page.point.action.form.accumulative.time.descr',
                    ],
            ...
            $form->add(
                $builder->create('returns_within', TextType::class, [
                    'label'      => 'milex.page.point.action.form.returns.within',
                    'required'   => false,
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'   => 'form-control',
                        'tooltip' => 'milex.page.point.action.form.returns.within.descr',
                        'onBlur'  => 'Milex.EnablesOption(this.id)',
                    ],
                    'auto_initialize' => false,
                ])
                    ->addViewTransformer($secondsTransformer)
            ...
            $form->add(
                $builder->create('returns_after', TextType::class, [
                    'label'      => 'milex.page.point.action.form.returns.after',
                    'required'   => false,
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'   => 'form-control',
                        'tooltip' => 'milex.page.point.action.form.returns.after.descr',
                        'onBlur'  => 'Milex.EnablesOption(this.id)',
                    ],
                    'auto_initialize' => false,
                ])
