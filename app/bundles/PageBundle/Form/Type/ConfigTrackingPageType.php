...
class ConfigTrackingPageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('track_by_tracking_url', YesNoButtonGroupType::class, [
            'label' => 'milex.page.config.form.track.by.tracking.url',
            'data'  => isset($options['data']['track_by_tracking_url']) ? (bool) $options['data']['track_by_tracking_url'] : true,
            'attr'  => [
                'tooltip' => 'milex.page.config.form.track.by.tracking.url.tooltip',
            ],
        ]);
        ...
        $builder->add(
            ...
            [
                'label' => 'milex.page.config.form.anonymize_ip',
                'data'  => isset($options['data']['anonymize_ip']) ? (bool) $options['data']['anonymize_ip'] : false,
                'attr'  => [
                    'tooltip' => 'milex.page.config.form.anonymize_ip.tooltip',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.page.config.form.track_contact_by_ip',
                'data'  => isset($options['data']['track_contact_by_ip']) ? (bool) $options['data']['track_contact_by_ip'] : false,
                'attr'  => [
                    'tooltip'      => 'milex.page.config.form.track_contact_by_ip.tooltip',
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.page.config.form.do_not_track_404_anonymous',
                'data'  => isset($options['data']['do_not_track_404_anonymous']) ? (bool) $options['data']['do_not_track_404_anonymous'] : false,
                'attr'  => [
                    'tooltip'      => 'milex.page.config.form.do_not_track_404_anonymous.tooltip',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label' => 'milex.page.config.form.facebook.pixel.id',
                'attr'  => [
                    'class' => 'form-control',
                ],
                'required' => false,
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.page.config.form.tracking.trackingpage.enabled',
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.page.config.form.tracking.landingpage.enabled',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label' => 'milex.page.config.form.google.analytics.id',
                'attr'  => [
                    'class' => 'form-control',
                ],
                'required' => false,
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.page.config.form.tracking.anonymize.ip.enabled',
                'data'  => isset($options['data']['google_analytics_anonymize_ip']) ? (bool) $options['data']['google_analytics_anonymize_ip'] : false,
                'attr'  => [
                    'tooltip' => 'milex.page.config.form.tracking.anonymize.ip.enabled.tooltip',
                ],
            ]
        );
    }
