...
class PageRepository extends CommonRepository
{
    ...
    protected function addSearchCommandWhereClause($q, $filter)
    {
        ...
        switch ($command) {
            ...
            case $this->translator->trans('milex.core.searchcommand.lang', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('milex.page.searchcommand.isprefcenter'):
            case $this->translator->trans('milex.page.searchcommand.isprefcenter', [], null, 'en_US'):
    ...
    public function getSearchCommands()
    {
        $commands = [
            ...
            'milex.page.searchcommand.isprefcenter',
        ];
    ...
    public function resetVariants($relatedIds, $date)
    {
        ...
        $qb->update(MILEX_TABLE_PREFIX.'pages')
            ->set('variant_hits', 0)
    ...
    public function upHitCount($id, $increaseBy = 1, $unique = false, $variant = false)
    {
        ...
        $q->update(MILEX_TABLE_PREFIX.'pages')
