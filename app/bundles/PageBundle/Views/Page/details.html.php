...
/** @var \Milex\PageBundle\Entity\Page $activePage */
...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $activePage])
);
?>
                ...
                <div class="box-layout">
                    <div class="col-xs-10">
                        ...
                        <?php if ($activePage->isVariant(true)): ?>
                            <div class="small">
                                <a href="<?php echo $view['router']->path('milex_page_action', ['objectAction' => 'view', 'objectId' => $variants['parent']->getId()]); ?>" data-toggle="ajax">
                        ...
                        <div class="small">
                            <a href="<?php echo $view['router']->path('milex_page_action', ['objectAction' => 'view', 'objectId' => $translations['parent']->getId()]); ?>" data-toggle="ajax">
                        ...
                        <?php if ($activePage->getIsPreferenceCenter()): ?>
                            <div class="small">
                                <?php echo $view['translator']->trans('milex.core.icon_tooltip.preference_center'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="pr-md pl-md pb-md">
                    <div class="panel shd-none mb-0">
                        <table class="table table-bordered table-striped mb-0">
                            <tbody>
                            <?php echo $view->render('MilexCoreBundle:Helper:details.html.php', ['entity' => $activePage]); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.page.pageviews'); ?>
                                    </h5>
                                </div>
                                <div class="col-md-9 va-m">
                                    <?php echo $view->render(
                                        'MilexCoreBundle:Helper:graph_dateselect.html.php',
        ...
        <div class="pa-md">
            <div class="text-center" style="height: 100%; width: 100%; ">
                <h3 style="padding: 30px;">
                    <a class="create-abtest-link" href="<?php echo $view['router']->path('milex_page_action', ['objectAction' => 'abtest', 'objectId' => $activePage->getId()]); ?>" data-toggle="ajax">
                        <?php echo $view['translator']->trans('milex.core.ab_test.create'); ?> <i class="fa fa-angle-right"></i>
                    </a>
                </h3>
            </div>
        </div>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mt-sm mb-0">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $view['translator']->trans('milex.page.url'); ?></div>
            </div>
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mt-sm mb-0">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $view['translator']->trans('milex.page.preview.url'); ?></div>
            </div>
            <div class="panel-body pt-xs">
                <div class="input-group">
                    <input onclick="this.setSelectionRange(0, this.value.length);" type="text" class="form-control"
