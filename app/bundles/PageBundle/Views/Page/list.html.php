 ...
 */
if ('index' == $tmpl) {
    $view->extend('MilexPageBundle:Page:index.html.php');
}
?>
        ...
        <table class="table table-hover table-striped table-bordered pagetable-list" id="pageTable">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php echo $view->render('MilexCoreBundle:Helper:publishstatus_icon.html.php', ['item' => $item, 'model' => 'page.page']); ?>
                        <a href="<?php echo $view['router']->path(
                            ...
                            if ($hasVariants || $hasTranslations || $isPreferenceCenter): ?>
                                ...
                                <?php if ($isPreferenceCenter): ?>
                                    <span data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.core.icon_tooltip.preference_center'); ?>">
        ...
        <div class="panel-footer">
            <?php echo $view->render(
                ...
                [
                    ...
                    'page'       => $page,
                    'limit'      => $limit,
                    'menuLinkId' => 'milex_page_index',
                    'baseUrl'    => $view['router']->path('milex_page_index'),
                    'sessionVar' => 'page',
                ]
            ); ?>
        </div>
