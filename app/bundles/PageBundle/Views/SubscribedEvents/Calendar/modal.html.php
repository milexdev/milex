...
<div class="text-center">
	<a href="<?php echo $view['router']->path('milex_page_action',
        ['objectAction' => 'edit', 'objectId' => $entity->getId()]); ?>"
	    data-toggle="ajax">
	    <?php echo $view['translator']->trans('milex.page.menu.edit'); ?>
	</a>
	|
	<a href="<?php echo $view['router']->path('milex_page_action',
	...
	<a href="<?php echo $model->generateUrl($entity); ?>" target="_blank">
	    <?php echo $view['translator']->trans('milex.page.menu.view'); ?>
	</a>
</div>
