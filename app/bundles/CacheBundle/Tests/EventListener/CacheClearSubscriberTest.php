...
namespace Milex\CacheBundle\Tests\EventListener;

use Milex\CacheBundle\Cache\Adapter\FilesystemTagAwareAdapter;
use Milex\CacheBundle\EventListener\CacheClearSubscriber;
use Monolog\Logger;
