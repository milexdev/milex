    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            [
                ...
                'attr'        => [
                    'class'       => 'form-control',
                    'placeholder' => 'milex.install.form.email.from_name',
                ],
                'required'    => true,
                'constraints' => [
                    new NotBlank(
        ...
        $builder->add(
            ...
            [
                ...
                'attr'        => [
                    ...
                    'placeholder' => 'milex.install.form.email.from_address',
                ],
                'required'    => true,
                'constraints' => [
                    new NotBlank(
        ...
        $builder->add(
            ...
            [
                ...
                'label'             => 'milex.install.form.email.transport',
                'required'          => false,
                'attr'              => [
                    'class'    => 'form-control',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.install.form.email.mailer_host',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.install.form.email.mailer_port',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'milex.install.form.email.auth_mode',
                'label_attr'  => ['class' => 'control-label'],
                'required'    => false,
                'attr'        => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'milex.install.form.email.encryption',
                'required'    => false,
                'attr'        => [
                    'class'        => 'form-control',
                    'data-show-on' => $smtpServiceShowConditions,
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'milex.install.form.email.spool_type',
                'expanded'    => true,
                'placeholder' => false,
            ]
        );
