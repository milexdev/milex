...
namespace Milex\InstallBundle\Tests\Controller;
...
use Milex\InstallBundle\Controller\InstallController;
...
class InstallControllerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testStepActionWhenInstalled()
    {
        ...
        $this->routerMock->expects($this->once())
            ->method('generate')
            ->with('milex_dashboard_index', [], UrlGeneratorInterface::ABSOLUTE_PATH)
