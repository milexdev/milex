...
namespace Milex\InstallBundle\Tests\Functional;
 ...
 * MILEX_INSTALLER which breaks other tests.
 *
 * @runTestsInSeparateProcesses
 * @preserveGlobalState disabled
 */
class InstallWorkflowTest extends MilexMysqlTestCase
{
    ...
    public function testInstallWorkflow(): void
    {
        ...
        $form['install_user_step[password]']->setValue('milex');
        $form['install_user_step[firstname]']->setValue('admin');
        $form['install_user_step[lastname]']->setValue('milex');
        $form['install_user_step[email]']->setValue('milex@example.com');
        ...
        $form['install_email_step[mailer_from_email]']->setValue('milex@example.com');
        ...
        Assert::assertStringContainsString('Milex is installed', $successText);
    }
}
