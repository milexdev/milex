...
namespace Milex\InstallBundle\Command;

use Doctrine\DBAL\Exception;
use Milex\CoreBundle\Doctrine\Connection\ConnectionWrapper;
use Milex\InstallBundle\Configurator\Step\CheckStep;
use Milex\InstallBundle\Configurator\Step\DoctrineStep;
use Milex\InstallBundle\Configurator\Step\EmailStep;
...
/**
 * CLI Command to install Milex.
 * Class InstallCommand.
 */
class InstallCommand extends ContainerAwareCommand
{
    public const COMMAND = 'milex:install';
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption(
                ...
                'From name for email sent from Milex.',
                null
            )
            ->addOption(
                '--mailer_from_email',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \Milex\InstallBundle\Install\InstallService $installer */
        $installer = $container->get('milex.install.service');

        // Check Milex is not already installed
        if ($installer->checkIfInstalled()) {
            $output->writeln('Milex already installed');
