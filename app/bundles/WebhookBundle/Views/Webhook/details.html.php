...
$view['slots']->set('milexContent', 'milexWebhook');

/** @var \Milex\WebhookBundle\Entity\Webhook $item */
            ...
            <div class="pr-md pl-md pt-lg pb-lg">
                <div class="box-layout">
                    ...
                    <div class="col-xs-2 text-right">
                        <?php echo $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $item]); ?>
                    </div>
                </div>
            </div>
            <!--/ page detail header -->
                ...
                <div class="col-md-12">
                    ...
                    <?php if (!count($hookLog)): ?>
                        <div class="alert alert-warning col-md-6 col-md-offset-3 mt-md" style="white-space: normal;">
                            <h4>
                                <?php echo $view['translator']->trans('milex.webhook.no.logs'); ?>
                            </h4>
                            <p>
                                <?php echo $view['translator']->trans('milex.webhook.no.logs_desc'); ?>
                            </p>
                        </div>
                    <?php else: ?>
                        <table class="table table-responsive table-striped">
                            <thead>
                                <tr>
                                    <th>
                                        <?php echo $view['translator']->trans('milex.core.id'); ?>
                                    </th>
                                    <th>
                                        <?php echo $view['translator']->trans('milex.webhook.status'); ?>
                                    </th>
                                    <th>
                                        <?php echo $view['translator']->trans('milex.webhook.note'); ?>
                                    </th>
                                    <th>
                                        <?php echo $view['translator']->trans('milex.webhook.runtime'); ?>
                                    </th>
                                    <th>
                                        <?php echo $view['translator']->trans('milex.core.date.added'); ?>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($hookLog as $log): ?>
                                    <tr>
                                        ...
                                        <td><?php
                                            echo $view->render('MilexWebhookBundle:Helper:labelcode.html.php', [
                                        ...
                                        <td><?php
                                            ...
                                            if ($note) :
                                                ...
                                                echo $view['translator']->trans('milex.webhook.webhook.logs.empty.response');
                                            endif;
                                        ?></td>
                        ...
                        <div class="alert alert-info col-md-6 col-md-offset-3 mt-md">
                            <h4>
                                <?php echo $view['translator']->trans('milex.webhook.webhook.logs.title'); ?>
                            </h4>
                            <p>
                                <?php echo $view['translator']->trans('milex.webhook.webhook.logs.desc'); ?>
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mt-sm mb-0">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $view['translator']->trans('milex.webhook.webhook_url'); ?></div>
            </div>
