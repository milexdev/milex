...
namespace Milex\WebhookBundle\Tests\Functional;

use GuzzleHttp\Psr7\Response as GuzzleResponse;
use Http\Mock\Client;
use Milex\CoreBundle\Test\MilexMysqlTestCase;
use Milex\WebhookBundle\Command\ProcessWebhookQueuesCommand;
...
class WebhookFunctionalTest extends MilexMysqlTestCase
{
    ...
    public function testWebhookWorkflowWithCommandProcess()
    {
        $httpClient                        = new class() extends Client {
            ...
            public function sendRequest(RequestInterface $request): ResponseInterface
            {
                ...
                Assert::assertCount(3, $jsonPayload['milex.lead_post_save_new']);
        ...
        self::$container->set('milex.guzzle.client', $httpClient);
    ...
    private function createWebhook(): Webhook
    {
        ...
        $event->setEventType('milex.lead_post_save_new');
