...
use Milex\WebhookBundle\Command\DeleteWebhookLogsCommand;
...
final class RemoveOldLogTest extends MilexMysqlTestCase
{
    /**
     * @var WebhookModel
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->webhookModel = $this->getContainer()->get('milex.webhook.model.webhook');
    }
