...
namespace Milex\WebhookBundle\Command;
...
{
    public const COMMAND_NAME = 'milex:webhooks:process';
    ...
    {
        /** @var \Milex\WebhookBundle\Model\WebhookModel $model */
        $model  = $this->getContainer()->get('milex.webhook.model.webhook');
        $params = $this->getContainer()->get('milex.helper.core_parameters');
