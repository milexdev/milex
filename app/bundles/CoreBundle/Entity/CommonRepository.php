...
class CommonRepository extends EntityRepository
{
    ...
    {
        return ['milex.core.searchcommand.ids'];
    }
    ...
    protected function addSearchCommandWhereClause($q, $filter)
    {
        ...
        switch ($command) {
            case $this->translator->trans('milex.core.searchcommand.ids'):
            case $this->translator->trans('milex.core.searchcommand.ids', [], null, 'en_US'):
    ...
    protected function addStandardSearchCommandWhereClause(&$q, $filter)
    {
        ...
        switch ($command) {
            ...
            case $this->translator->trans('milex.core.searchcommand.isunpublished', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('milex.core.searchcommand.isuncategorized'):
            case $this->translator->trans('milex.core.searchcommand.isuncategorized', [], null, 'en_US'):
                $expr = $q->expr()->orX(
            ...
            case $this->translator->trans('milex.core.searchcommand.ismine', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('milex.core.searchcommand.category'):
            case $this->translator->trans('milex.core.searchcommand.category', [], null, 'en_US'):
     ...
     *
     * @see \Milex\LeadBundle\Segment\RandomParameterName
