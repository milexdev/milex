    ...
    <div class="row">
        <div class="form-group col-xs-12 ">
            <label class="control-label">
                <?php echo $view['translator']->trans('milex.lead.list.frequency.preferred.channel'); ?>
            </label>
            <div class="choice-wrapper">
                <select class="form-control">
                    <option value="email" selected="selected"><?php echo $view['translator']->trans('milex.email.email'); ?></option>
                </select></div>
        </div>
    </div>
</div>
