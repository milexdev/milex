            ...
            <td>
                <div id="frequency_<?php echo $channel->value; ?>" class="text-left row">
                    ...
                    <?php if ($showContactPauseDates && isset($form['lead_channels']['contact_pause_start_date_'.$channel->value]) && isset($form['lead_channels']['contact_pause_end_date_'.$channel->value])):?>
                        <div class="col-md-6">
                            <label class="text-muted label3"><?php echo $view['translator']->trans('milex.lead.frequency.dates.label'); ?></label>
        ...
        <td>
            <div class="text-left">
                ...
                <label class="control-label">
                    <?php echo $view['translator']->trans('milex.lead.contact.me.label'); ?></label>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <div id="frequency_email" class="text-left row">
                <div class="col-xs-6">
                    <label class="text-muted label1"><?php echo $view['translator']->trans('milex.lead.list.frequency.number'); ?></label>
                    <input type="text" class="frequency form-control">
                    <label class="text-muted fw-n frequency-label label2"><?php echo $view['translator']->trans('milex.lead.list.frequency.times'); ?></label>
                ...
                <div class="col-xs-6">
                    ...
                    <label class="frequency-label text-muted fw-n label4"><?php echo  $view['translator']->trans('milex.lead.frequency.contact.end.date'); ?></label>
                    <input type="date" class="form-control">
                </div>
            </div>
        </td>
