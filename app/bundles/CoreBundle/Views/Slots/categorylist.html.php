...
<div class="global-categories text-left">
    <div>
        <label class="control-label"><?php echo $view['translator']->trans('milex.lead.form.categories'); ?></label>
    </div>
...
?>
    <div class="global-categories text-left">
        ...
        <div id="category-1" class="text-left">
            ...
            <label for="lead_contact_frequency_rules_global_categories_1"><?php echo  $view['translator']->trans('milex.core.category'); ?></label>
        </div>
    </div>
<?php endif; ?>
