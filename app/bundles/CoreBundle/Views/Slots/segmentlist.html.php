...
<?php if (isset($form)) : ?>
    <?php if ($showContactSegments && isset($form['lead_lists']) && count($form['lead_lists'])):?>
        <div class="contact-segments">
            <div class="text-left">
                <label class="control-label"><?php echo isset($label_text) ? $label_text : $view['translator']->trans('milex.lead.form.list'); ?></label>
            </div>
            <?php
    ...
    <div class="contact-segments">
        <div class="text-left">
            <label class="control-label"><?php echo  $view['translator']->trans('milex.lead.form.list'); ?></label>
        </div>
        <div id="segment-1" class="text-left">
            ...
            <label for="lead_contact_frequency_rules_lead_lists_1"><?php echo  $view['translator']->trans('milex.lead.lead.field.list'); ?></label>
        </div>
    </div>
<?php endif; ?>
