...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li>
            <a href="<?php echo $view['router']->path('milex_user_account'); ?>" data-toggle="ajax">
                <i class="fa fa-user fs-14"></i><span><?php echo $view['translator']->trans('milex.user.account.settings'); ?></span>
            </a>
        </li>
        <li>
            <a href="<?php echo $view['router']->path('milex_user_logout'); ?>">
                <i class="fa fa-sign-out fs-14"></i><span><?php echo $view['translator']->trans('milex.user.auth.logout'); ?></span>
            </a>
        </li>
