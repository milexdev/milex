...
$totalWeight   = 0;
$abStatsHeader = $view['translator']->trans('milex.core.ab_test.stats');
?>
...
<ul class="list-group">
    <?php
    if ($variants['parent']) :
        echo $view->render('MilexCoreBundle:Variant:row.html.php',
            [
...
<?php echo $view->render(
    ...
    [
        ...
        ) : $view['translator']->trans('milex.core.ab_test.noresults'),
        'size' => 'lg',
    ]
); ?>
<?php endif; ?>