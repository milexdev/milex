    ...
    <div class="box-layout">
        <div class="col-md-8 va-m">
            <div class="row">
                ...
                <div class="col-xs-11">
                    <?php if ($isWinner): ?>
                        <div class="mr-xs pull-left" data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.core.ab_test.make_winner'); ?>">
                    ...
                    <h5 class="fw-sb text-primary">
                        ...
                        <?php if ($isCurrent) : ?>
                            <span class="label label-success"><?php echo $view['translator']->trans('milex.core.current'); ?></span>
                        <?php endif; ?>
                        <?php if ($variants['parent']->getId() === $variant->getId()) : ?>
                            <span class="label label-warning"><?php echo $view['translator']->trans('milex.core.parent'); ?></span>
                        <?php endif; ?>
                        <?php if ($variant instanceof \Milex\CoreBundle\Entity\TranslationEntityInterface && $variant->isTranslation()): ?>
                            <span data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.core.icon_tooltip.translation'); ?>">
            ...
            <em class="text-white dark-sm">
                <?php if ($isPublished && ($totalWeight > 100 || ($thisCriteria && $firstCriteria != $thisCriteria))): ?>
                    <div class="text-danger" data-toggle="label label-danger"
                         title="<?php echo $view['translator']->trans('milex.core.variant.misconfiguration'); ?>">
                        <div>
