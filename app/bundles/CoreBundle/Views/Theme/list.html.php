 ...
 */
// if ($tmpl == 'index')
$view->extend('MilexCoreBundle:Theme:index.html.php');
?>
<?php if (count($items)): ?>
                            ...
                            [
                                ...
                                'customButtons'   => [
                                    [
                                        ...
                                        'btnText'   => $view['translator']->trans('milex.core.download'),
                    ...
                    <td>
                        <div>
                            <?php if (isset($item['config']['authorUrl'])) : ?>
                                <a href="<?php echo \Milex\CoreBundle\Helper\InputHelper::url($item['config']['authorUrl']); ?>" target="_blank">
                            ...
                            <?php foreach ($item['config']['features'] as $feature) : ?>
                                <span style="white-space: nowrap;">
                                    <span class="label label-default pa-4">
                                        <?php echo $view['translator']->trans('milex.core.theme.feature.'.$view->escape($feature)); ?>
                                    </span>
                                </span>
                            <?php endforeach; ?>
                        <?php endif; ?>
...
<?php else: ?>
    <?php echo $view->render('MilexCoreBundle:Helper:noresults.html.php', ['tip' => 'milex.theme.noresults.tip']); ?>
<?php endif; ?>
