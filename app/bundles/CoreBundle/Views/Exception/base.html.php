...
$message            = $view['slots']->get('message', 'milex.core.error.generic');
...
<div class="pa-20 mautibot-error<?php if ($isInline): echo ' inline'; endif; ?>">
    <div class="row">
        ...
        <div class="mautibot-content col-xs-8 col-md-9">
            ...
            <div class="pull-right">
                <a class="text-muted" href="http://mau.tc/report-issue" target="_new"><?php echo $view['translator']->trans('milex.core.report_issue'); ?></a>
            </div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div<?php if ($isInline): echo ' class="slimscroll" style="max-height: 200px;"'; endif; ?>>
        <div class="row mt-20">
            <div class="col-sm-12">
                ...
                <div class="well well-sm ma-md">
                    <?php echo $view->render('MilexCoreBundle:Exception:traces.html.php', [
        ...
        <div class="row mt-20">
            <div class="col-sm-12">
                <h5 class="ml-lg"><?php echo $view['translator']->trans('milex.core.error.previousexceptions'); ?></h5>
