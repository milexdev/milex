        ...
        <table class="table table-hover table-striped table-bordered <?php echo $sessionVar; ?>-list">
            ...
            <tr>
                ...
                if (isset($listHeaders)):
                    foreach ($listHeaders as $header):
                        ...
                        echo $view->render('MilexCoreBundle:Helper:tableheader.html.php', $header);
                    endforeach;
                endif;
                ...
                ?>
                <?php echo $view['content']->getCustomContent('list.headers', $milexTemplateVars); ?>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($items as $item): ?>
                <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <a data-toggle="ajax" href="<?php echo $view['router']->path(
                                    ...
                                    <?php echo $view['content']->getCustomContent('list.name', $milexTemplateVars); ?>
                                </a>
                            </div>
                    ...
                    <?php endif; ?>
                    <?php echo $view['content']->getCustomContent('list.columns', $milexTemplateVars); ?>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
