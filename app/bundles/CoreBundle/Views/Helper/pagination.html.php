    ...
    <div class="<?php echo $responsiveClass; ?>">
        <?php if (empty($fixedLimit)): ?>
            <div class="pull-right">
                ...
                <select autocomplete="false" class="form-control not-chosen pagination-limit<?php echo $class; ?>" onchange="Milex.limitTableData('<?php echo $sessionVar; ?>',this.value,'<?php echo $tmpl; ?>','<?php echo $target; ?>'<?php if (!empty($baseUrl)): ?>, '<?php echo $baseUrl.$queryString; ?>'<?php endif; ?>);">
                    <?php foreach ($limitOptions as $value => $label): ?>
                        ...
                        <option<?php echo $selected; ?> value="<?php echo $view->escape($value); ?>">
                            <?php echo $view['translator']->trans('milex.core.pagination.'.$label); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
        ...
        <div class="<?php echo $paginationWrapper; ?> text-center">
            ...
            <small class="text-muted">
                <?php echo $view['translator']->trans(
                    'milex.core.pagination.items',
                    ['%count%' => $totalItems]
                ); ?>,
                <?php echo $view['translator']->trans(
                    'milex.core.pagination.pages',
                    ['%count%' => $totalPages]
                ); ?>
                <?php echo $view['translator']->trans(
                    'milex.core.pagination.total'
                ); ?>
            </small>
        </div>
    </div>
