...
if (isset($template)) {
    switch ($template) {
        case 'batchdelete':
            $confirmText = (!isset($confirmText)) ? $view['translator']->trans('milex.core.form.delete')
                : $confirmText;
            $iconClass       = (!isset($iconClass)) ? 'fa fa-trash-o text-danger' : $iconClass;
            $btnText         = (!isset($btnText)) ? $view['translator']->trans('milex.core.form.delete_selected') : $btnText;
        ...
        case 'delete':
            ...
            $btnText = (!isset($btnText)) ? $view['translator']->trans('milex.core.form.delete') : $btnText;
            break;
    }
}
...
if (!isset($cancelText)) {
    $cancelText = $view['translator']->trans('milex.core.form.cancel');
}
