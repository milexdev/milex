...
<div class="hide builder <?php echo $type; ?>-builder <?php echo $isCodeMode ? 'code-mode' : ''; ?>">
    ...
    <div class="builder-content">
        <input type="hidden" id="builder_url" value="<?php echo $view['router']->path('milex_'.$type.'_action', ['objectAction' => 'builder', 'objectId' => $objectId]); ?>" />
    </div>
    <div class="builder-panel">
        <div class="builder-panel-top">
            <?php echo $view->render('MilexCoreBundle:Helper:builder_buttons.html.php', [
                'onclick'       => "Milex.closeBuilder('$type');",
            ]); ?>

            <div class="code-mode-toolbar <?php echo $isCodeMode ? '' : 'hide'; ?>">
                <button class="btn btn-default btn-nospin" onclick="Milex.openMediaManager()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $view['translator']->trans('milex.core.media.manager.desc'); ?>">
                    <i class="fa fa-photo"></i>
                    <?php echo $view['translator']->trans('milex.core.media.manager'); ?>
                </button>
                <button class="btn btn-default btn-nospin" onclick="Milex.formatCode()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $view['translator']->trans('milex.core.format.code.desc'); ?>">
                    <i class="fa fa-indent"></i>
                    <?php echo $view['translator']->trans('milex.core.format.code'); ?>
                </button>
            </div>
        </div>
        <?php if ($previewUrl) : ?>
            <div class="panel panel-default" id="preview">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $view['translator']->trans('milex.email.urlvariant'); ?></h4>
                </div>
        ...
        <div class="code-editor <?php echo $isCodeMode ? '' : 'hide'; ?>">
            ...
            <i class="text-muted"><?php echo $view['translator']->trans('milex.core.code.mode.token.dropdown.hint'); ?></i>
        </div>
        <div class="builder-toolbar <?php echo $isCodeMode ? 'hide' : ''; ?>">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $view['translator']->trans('milex.core.slot.types'); ?></h4>
                </div>
                <div class="panel-body">
                    <?php if ($slots): ?>
                    ...
                    <?php endif; ?>
                    <p class="text-muted pt-md text-center"><i><?php echo $view['translator']->trans('milex.core.drag.info'); ?></i></p>
                </div>
            </div>

            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $view['translator']->trans('milex.core.section.types'); ?></h4>
                </div>
                <div class="panel-body">
                    <?php if ($sections): ?>
            ...
            <div class="panel panel-default" id="customize-slot-panel">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $view['translator']->trans('milex.core.customize.slot'); ?></h4>
                </div>
                <div class="panel-body" id="customize-form-container">
                    <div id="slot-form-container" class="col-md-12">
                        <p class="text-muted pt-md text-center">
                            <i><?php echo $view['translator']->trans('milex.core.slot.customize.info'); ?></i>
                        </p>
                    </div>
                    <?php if ($slots): ?>
                        <?php foreach ($slots as $slotKey => $slot): ?>
            ...
            <div class="panel panel-default" id="section">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $view['translator']->trans('milex.core.customize.section'); ?></h4>
                </div>
                <div class="panel-body" id="customize-form-container">
                    <div id="section-form-container" class="col-md-12">
                        <p class="text-muted pt-md text-center">
                            <i><?php echo $view['translator']->trans('milex.core.section.customize.info'); ?></i>
                        </p>
                    </div>
