            ...
            if (!empty($templateButtons['edit'])):
                $view['buttons']->addButton(
                    [
                        ...
                        'btnText'   => $view['translator']->trans('milex.core.form.edit'),
                        'primary'   => true,
                    ]
                );
            endif;
            if (!empty($templateButtons['clone'])):
                $view['buttons']->addButton(
                    [
                        ...
                        'btnText'   => $view['translator']->trans('milex.core.form.clone'),
                        'priority'  => 200,
                    ]
                );
            endif;
            if (!empty($templateButtons['delete'])):
                $view['buttons']->addButton(
                    [
                        'confirm' => [
                            'btnClass'      => false,
                            'btnText'       => $view['translator']->trans('milex.core.form.delete'),
