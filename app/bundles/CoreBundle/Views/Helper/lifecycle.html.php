...
<div class="chart-wrapper" >
    ...
    <?php if ($stages[$key]) : ?>
        <div class="chart-wrapper">
                <div>
                    <div class="chart-legend pt-sd pr-md pb-md pl-md"><h5><?php echo $view['translator']->trans('milex.lead.lifecycle.graph.stage.cycle'); ?></h5></div>
                    <div class="clearfix"></div>
                    <div style="height:<?php echo $chartHeight / 2.3; ?>px;">
    ...
    <?php endif; ?>
        <?php if ($devices[$key]) : ?>
            <div class="chart-wrapper">
                <div>
                    <div class="chart-legend pt-sd pr-md pb-md pl-md"><h5><?php echo $view['translator']->trans('milex.lead.lifecycle.graph.device.granularity'); ?></h5></div>
                    <div class="clearfix"></div>
