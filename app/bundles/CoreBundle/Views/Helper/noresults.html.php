<div class="alert alert-warning col-md-6 col-md-offset-3 mt-md" style="white-space: normal;">
    <?php if (!isset($header)) {
    $header = 'milex.core.noresults.header';
} ?>
    <h4><?php echo $view['translator']->trans($header); ?></h4>
    <?php if (!isset($message)) {
    $message = 'milex.core.noresults';
} ?>
...
<?php if (isset($tip)): ?>
    <div class="well well col-md-6 col-md-offset-3">
        <div class="row">
            ...
            <div class="col-xs-9">
                <h4><i class="fa fa-quote-left"></i> <?php echo $view['translator']->trans('milex.core.noresults.tip'); ?> <i class="fa fa-quote-right"></i></h4>
