...
switch ($status) {
    case 'published':
        ...
        $text = $view['translator']->trans('milex.core.form.published');
        break;
    case 'unpublished':
        $icon = ' fa-toggle-off text-danger';
        $text = $view['translator']->trans('milex.core.form.unpublished');
        break;
    case 'expired':
        $icon = ' fa-clock-o text-danger';
        $text = $view['translator']->trans('milex.core.form.expired_to', [
            '%date%' => $view['date']->toFull($item->getPublishDown()),
        ]);
        break;
    case 'pending':
        $icon = ' fa-clock-o text-warning';
        $text = $view['translator']->trans('milex.core.form.pending.start_at', [
...
switch (true) {
    case true === $status:
        $icon = ' fa-toggle-on text-success';
        $text = $view['translator']->trans('milex.core.form.public');
        break;
    case false === $status:
        $icon = ' fa-toggle-off text-danger';
        $text = $view['translator']->trans('milex.core.form.not.public');
        break;
}
