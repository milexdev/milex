...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.core.config.header.general'); ?></h3>
    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.core.config.header.defaults'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="row">
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.core.config.header.cors'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="row">
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.core.config.header.misc'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="row">
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.core.config.header.update'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="row">
            ...
            <?php echo $view['form']->rowIfExists(
                ...
                '<div class="col-md-6">{content}<span style="color:red">'.$view['translator']->trans(
                    'milex.core.config.form.update.composer.warning',
                    [
