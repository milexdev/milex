        ...
        [
            ...
            'footerButtons'     => [
                [
                    ...
                    'label'    => $view['translator']->trans((isset($closeButtonText) ? $closeButtonText : 'milex.core.form.cancel')),
                    'attr'     => $cancelAttr,
                ],
                [
                    'class'    => 'btn-default btn-add btn-nospin'.(!empty($update) ? ' hide' : ''),
                    'textIcon' => (isset($addButtonIcon) ? $addButtonIcon : 'fa fa-plus'),
                    'label'    => $view['translator']->trans((isset($addButtonText) ? $addButtonText : 'milex.core.form.add')),
                    'attr'     => $addAttr,
                ],
                [
                    'class'    => 'btn-default btn-nospin btn-update'.(empty($update) ? ' hide' : ''),
                    'textIcon' => (isset($updateButtonIcon) ? $updateButtonIcon : 'fa fa-save'),
                    'label'    => $view['translator']->trans((isset($updateButtonText) ? $updateButtonText : 'milex.core.form.update')),
                    'attr'     => $addAttr,
                ],
            ],
        ]
