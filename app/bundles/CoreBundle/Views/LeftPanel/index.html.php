...
<div class="sidebar-header">
    <!-- brand -->
    <a class="milex-brand<?php echo (!empty($extraMenu)) ? ' pull-left pl-0 pr-0' : ''; ?>" href="#">
        <!-- logo figure -->
        <svg version="1.1" class="milex-logo-figure" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 128 128" enable-background="new 0 0 128 128" xml:space="preserve">
        ...
        <!--/ logo figure -->
        <!-- logo text -->
        <svg version="1.1" class="milex-logo-text mnl-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 260 65" enable-background="new 0 0 260 65" xml:space="preserve">
            <g>
...
<div class="sidebar-content">
    <div class="scroll-content slimscroll">
        <nav class="nav-sidebar">
            <?php echo $view['content']->getCustomContent('menu.above', $milexTemplateVars); ?>
            <?php echo $view['menu']->render('main'); ?>

            <ul class="nav sidebar-left-dark">
                <li class="hidden-xs">
                    <a href="javascript:void(0)" data-toggle="minimize" class="sidebar-minimizer"><span class="direction icon pull-left fa"></span><span class="nav-item-name pull-left text"><?php echo $view['translator']->trans('milex.core.menu.left.collapse'); ?></span></a>
                </li>
            </ul>
        </nav>
    </div>
