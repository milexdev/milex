...
(function() {
    ...
    AbstractChosen = (function() {
      ...
      AbstractChosen.prototype.winnow_results = function(options) {
        ...
        // Milex hack to allow adding new options - start
        ...
        // Milex hack to allow adding new options - end
        ...
        switch (stroke) {
          ...
          case 13:
            if (this.results_showing) {
              ...
              // Milex hack to allow adding new entries if applicable - start
              ...
              // Milex hack to allow adding new entries if applicable - end
