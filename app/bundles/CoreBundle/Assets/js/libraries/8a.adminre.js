        ...
        PLUGINS: function () {
            ...
            (function () {
                ...
                function toggleMinimize (e) {
                    var backgroundImage = /^url\(.+$/.test($('.milex-brand').css('background-image'));
                    ...
                    if($(element).hasClass("sidebar-minimized")) {
                        ...
                        if (backgroundImage) {
                            $('.milex-brand, .sidebar-header').removeClass('minimized');
                        }
                        ...
                        if (backgroundImage) {
                            $('.milex-brand, .sidebar-header').addClass('minimized');
                        }
