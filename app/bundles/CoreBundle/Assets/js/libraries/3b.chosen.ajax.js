...
(function ($) {
    return $.fn.ajaxChosen = function (settings, callback, chosenOptions) {
        ...
        defaultOptions = {
            ...
            afterTypeDelay: 500,
            jsonTermKey: "search",
            keepTypingMsg: milexLang["milex.core.lookup.keep_typing"],
            lookingForMsg: milexLang["milex.core.lookup.looking_for"]
        };
        select = this;
        chosenXhr = null;
        ...
        return this.each(function () {
            return $(this).next('.chosen-container').find(".search-field > input, .chosen-search > input").on('keyup', function (event) {
                ...
                options.success = function (data) {
                    ...
                    // Milex - only apply container width if not hidden which will result in a bad size
                    if (w > f_width - 10) {
                        w = f_width;
                    }
