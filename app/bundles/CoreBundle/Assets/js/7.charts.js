 ...
 */
Milex.renderCharts = function(scope) {
    var charts = [];
    if (!Milex.chartObjects) Milex.chartObjects = [];
 ...
 */
Milex.renderLineChart = function(canvas) {
 ...
 * @param mQuery element canvas
 */
Milex.renderPieChart = function(canvas) {
    var data = JSON.parse(canvas.text());
    ...
    // data = Milex.emulateNoDataForPieChart(data);
    var chart = new Chart(canvas, {
        type: 'pie',
        data: data,
        options: options
 ...
 * @param mQuery element canvas
 */
Milex.renderBarChart = function(canvas) {
    var data = JSON.parse(canvas.text());
    var chart = new Chart(canvas, {
        type: 'bar',
        data: data,
 ...
 * @param mQuery element canvas
 */
Milex.renderLifechartBarChart = function(canvas) {
 ...
 * @param mQuery element canvas
 */
Milex.renderSimpleBarChart = function(canvas) {
    var data = JSON.parse(canvas.text());
    var chart = new Chart(canvas, {
        type: 'bar',
        data: data,
 ...
 * @param mQuery element canvas
 */
Milex.renderHorizontalBarChart = function(canvas) {
    var data = JSON.parse(canvas.text());
    var chart = new Chart(canvas, {
        type: 'horizontalBar',
        data: data,
 ...
 */
Milex.renderMaps = function(scope) {
    var maps = [];
    ...
    if (maps.length) {
        maps.each(function(index, element) {
            Milex.renderMap(mQuery(element));
        });
    }
};
 ...
 * @returns {*}
 */
Milex.renderMap = function(wrapper) {
    // Map render causes a JS error on FF when the element is hidden
    if (wrapper.is(':visible')) {
        if (!Milex.mapObjects) Milex.mapObjects = [];
 ...
 */
Milex.destroyMap = function(wrapper) {
 ...
 */
Milex.initDateRangePicker = function (fromId, toId) {
 ...
 * @param callback
 */
Milex.getChartData = function(element, action, query, callback) {
        ...
        success: function (response) {
            if (response.success) {
                ...
                if (typeof callback == 'function') {
                    callback(response);
                } else if(typeof window["Milex"][callback] !== 'undefined') {
                    window["Milex"][callback].apply('window', [response]);
                }
            }
        },
 ...
 * @param data
 */
Milex.emulateNoDataForPieChart = function (data) {
    var dataEmpty = true;
