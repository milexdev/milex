...
namespace Milex\CoreBundle\Security\Permissions;
...
abstract class AbstractPermissions
{
    ...
    {
        $choices = [
            'milex.core.permissions.view'   => 'view',
            'milex.core.permissions.edit'   => 'edit',
            'milex.core.permissions.create' => 'create',
            'milex.core.permissions.delete' => 'delete',
        ];

        if ($includePublish) {
            $choices['milex.core.permissions.publish'] = 'publish';
        }

        $choices['milex.core.permissions.full'] = 'full';

        $label = ('categories' == $level) ? 'milex.category.permissions.categories' : "milex.$bundle.permissions.$level";
        $builder->add(
            "$bundle:$level",
    ...
    {
        return ('categories' === $level) ? 'milex.category.permissions.categories' : "milex.{$bundle}.permissions.{$level}";
    }
    ...
    {
        $choices = [
            'milex.core.permissions.manage' => 'manage',
        ];
        ...
        $builder->add(
            ...
            [
                'choices'           => $choices,
                'label'             => "milex.$bundle.permissions.$level",
                'data'              => (!empty($data[$level]) ? $data[$level] : []),
                'bundle'            => $bundle,
                'level'             => $level,
            ]
    ...
    {
        $choices = [
            'milex.core.permissions.viewown'     => 'viewown',
            'milex.core.permissions.viewother'   => 'viewother',
            'milex.core.permissions.editown'     => 'editown',
            'milex.core.permissions.editother'   => 'editother',
            'milex.core.permissions.create'      => 'create',
            'milex.core.permissions.deleteown'   => 'deleteown',
            'milex.core.permissions.deleteother' => 'deleteother',
            'milex.core.permissions.full'        => 'full',
        ];

        if ($includePublish) {
            $choices['milex.core.permissions.publishown']   = 'publishown';
            $choices['milex.core.permissions.publishother'] = 'publishother';
        }
