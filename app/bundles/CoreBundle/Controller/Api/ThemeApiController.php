...
{
    /**
     * @var Milex\CoreBundle\Helper\ThemeHelper
     */
    protected $themeHelper;

    public function initialize(FilterControllerEvent $event)
    {
        $this->themeHelper = $this->container->get('milex.helper.theme');
    ...
    public function newAction(Request $request)
    {
        ...
        if (!$themeZip) {
            ...
            $dir       = $this->get('milex.helper.paths')->getSystemPath('themes', true);
        ...
        if (!$themeZip) {
            return $this->returnError(
                $this->translator->trans(
                    'milex.core.dir.not.accesssible',
                    ['%dir%' => $theme]
                )
            );
        }
