...
namespace Milex\CoreBundle\Controller\Api;
...
class FileApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->allowedExtensions = $this->get('milex.helper.core_parameters')->get('allowed_extensions');
    ...
    protected function getAbsolutePath($dir, $createDir = false)
    {
        try {
            ...
            if ('images' === $dir) {
                $absoluteDir = realpath($this->get('milex.helper.paths')->getSystemPath($dir, true));
            } elseif ('assets' === $dir) {
                $absoluteDir = realpath($this->get('milex.helper.core_parameters')->get('upload_dir'));
            }
            ...
            $this->get('monolog.logger.milex')->error($e->getMessage(), ['exception' => $e]);
    ...
    protected function getMediaUrl()
    {
        return $this->request->getScheme().'://'
            ...
            .$this->get('milex.helper.core_parameters')->get('image_path');
    }
}
