...
class FormController extends AbstractStandardFormController
{
    ...
    private $deprecatedMilexContent;
     ...
     * @param string $routeBase       Route base for the controller routes (i.e. milex_form or custom_addon)
     ...
     * @param string $milexContent   Milex content string to return via ajax response for onLoad functions
     */
    protected function setStandardParameters(
        ...
        if (0 !== strpos($sessionBase, 'milex.')) {
            $sessionBase = 'milex.'.$sessionBase;
        }
        ...
        $this->deprecatedMilexContent   = $milexContent;
    ...
    {
        return $this->deprecatedMilexContent;
    }
