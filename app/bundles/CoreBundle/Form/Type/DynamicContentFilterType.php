...
class DynamicContentFilterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        try {
            $milexBuilder = $this->builderIntegrationsHelper->getBuilder('email');
            $milexBuilder->getName();
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label' => 'milex.core.dynamicContent.token_name',
                'attr'  => [
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label' => 'milex.core.dynamicContent.default_content',
                'attr'  => [
