...
class DateRangeType extends AbstractType
{
    ...
    {
        $humanFormat     = 'M j, Y';
        $sessionDateFrom = $this->session->get('milex.daterange.form.from');
        $sessionDateTo   = $this->session->get('milex.daterange.form.to');
        ...
        $this->session->set('milex.daterange.form.from', $dateFrom->format($humanFormat));
        $this->session->set('milex.daterange.form.to', $dateTo->format($humanFormat));
    }
