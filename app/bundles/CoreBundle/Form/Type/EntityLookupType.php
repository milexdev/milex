...
use Milex\CoreBundle\Form\ChoiceLoader\EntityLookupChoiceLoader;
        ...
        if (!empty($options['modal_route'])) {
            $attr = array_merge(
                ...
                [
                    ...
                    'data-chosen-placeholder' => $this->translator->trans('milex.core.lookup.search_options', [], 'javascript'),
                ]
            );
        }
