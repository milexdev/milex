...
namespace Milex\CoreBundle\Form\Extension;

use Milex\CoreBundle\CoreEvents;
use Milex\CoreBundle\Event\CustomFormEvent;
...
trigger_deprecation('milex/core', '4.3', 'The "%s" class is deprecated, will be removed in 5.0.', CustomFormExtension::class);
