...
abstract class AbstractCommonModel
{
     ...
     *
     * @return \Milex\CoreBundle\Entity\CommonRepository|bool
     */
    public function getRepository()
    {
        ...
        if (null === $commonRepo) {
            $commonRepo = new CommonRepository($this->em, new ClassMetadata('MilexCoreBundle:FormEntity'));
        }
    ...
    public function getEntityBySlugs($slug)
    {
        ...
        if ($this->translator->trans('milex.core.url.uncategorized') == $category) {
            $category = null;
        }
