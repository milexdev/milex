...
namespace Milex\CoreBundle\Doctrine;
...
abstract class AbstractMilexMigration extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->prefix        = $container->getParameter('milex.db_table_prefix');
