...
namespace Milex\CoreBundle\Release;
...
class Metadata implements \JsonSerializable
{
     ...
     * Milex versions anymore.
     */
    private string $showPHPVersionWarningIfUnder;

    private string $minSupportedMilexVersion;
    ...
    public function __construct(array $metadata)
    {
        ...
        $this->minSupportedMilexVersion    = $metadata['minimum_milex_version'];
    ...
    public function getMinSupportedMilexVersion(): string
    {
        return $this->minSupportedMilexVersion;
    }
    ...
    public function jsonSerialize()
    {
        return [
            ...
            'minimum_milex_version'            => $this->minSupportedMilexVersion,
