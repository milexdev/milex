...
use Milex\CoreBundle\Exception\FileNotFoundException;
...
class MilexFactory
{
    ...
    /**
     * Retrieves Milex's security object.
     *
     * @return \Milex\CoreBundle\Security\Permissions\CorePermissions
     */
    public function getSecurity()
    {
        return $this->container->get('milex.security');
    }
    ...
    {
        return $this->container->get('milex.helper.user')->getUser($nullIfGuest);
    }
    ...
    {
        if (defined('IN_MILEX_CONSOLE')) {
            /** @var \Milex\CoreBundle\Translation\Translator $translator */
    ...
    {
        return $this->container->get('milex.helper.templating')->getTemplating();
    }
    ...
    /**
     * Retrieves Milex system parameters.
     *
     * @return array
     */
    public function getSystemParameters()
    {
        return $this->container->getParameter('milex.parameters');
    }

    /**
     * Retrieves a Milex parameter.
     *
     * @param       $id
     * @param mixed $default
     *
    ...
    {
        return $this->container->get('milex.helper.core_parameters')->get($id, $default);
    }
    ...
    {
        return $this->container->get('milex.helper.paths')->getSystemPath($name, $fullPath);
    }
    ...
    {
        return $this->container->get('milex.helper.theme')->getTheme($theme, $throwException);
    }
    ...
    {
        return $this->container->get('milex.helper.theme')->getInstalledThemes($specificFeature, $extended);
    }
    ...
    {
        return $this->container->get('milex.helper.mailer')->getMailer($cleanSlate);
    }
    ...
    {
        return $this->container->get('milex.helper.ip_lookup')->getIpAddressFromRequest();
    }
    ...
    {
        return $this->container->get('milex.helper.ip_lookup')->getIpAddress($ip);
    }
    ...
    public function getLogger($system = false)
    {
        if ($system) {
            ...
            return $this->container->get('monolog.logger.milex');
        }
    }

    /**
     * Get a milex helper service.
     *
     * @param $helper
     *
     * @return object
    ...
    public function getHelper($helper)
    {
        switch ($helper) {
            ...
            default:
                return $this->container->get('milex.helper.'.$helper);
        }
    }
    ...
    /**
     * Get's an array of details for Milex core bundles.
     *
     * @param bool|false $includePlugins
     *
     * @return array|mixed
     */
    public function getMilexBundles($includePlugins = false)
    {
        return $this->container->get('milex.helper.bundle')->getMilexBundles($includePlugins);
    }

    /**
     * Get's an array of details for enabled Milex plugins.
     *
     * @return array
     */
    public function getPluginBundles()
    {
        return $this->container->get('milex.helper.bundle')->getPluginBundles();
    }
    ...
    {
        return $this->container->get('milex.helper.bundle')->getBundleConfig($bundleName, $configKey, $includePlugins);
    }
