...
use Milex\CoreBundle\Test\Session\FixedMockFileSessionStorage;
...
abstract class AbstractMilexTestCase extends WebTestCase
{
    use FixturesTrait {
    ...
    {
        putenv('MILEX_CONFIG_PARAMETERS='.json_encode($defaultConfigOptions));
    ...
    private function mockServices(): void
    {
        ...
        self::$container->set('milex.helper.cookie', $cookieHelper);
    ...
    protected function createAjaxHeaders(): array
    {
        return [
            ...
            'HTTP_X-CSRF-Token'     => $this->getCsrfToken('milex_ajax_post'),
        ];
    }
