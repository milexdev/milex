...
namespace Milex\CoreBundle\Test\Service;
...
class FlashBagTest extends TestCase
{
    ...
    private function assertReadStatus(int $milexUserLastActive, bool $isRead): void
    {
        $message            = 'message';
        $messageVars        = [];
        $level              = FlashBag::LEVEL_NOTICE;
        ...
        $request
            ->expects($this->once())
            ->method('get')
            ->with('milexUserLastActive', 0)
            ->willReturn($milexUserLastActive);
