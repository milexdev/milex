...
abstract class MilexMysqlTestCase extends AbstractMilexTestCase
{
    /**
     * @var bool
     */
    ...
    {
        $prefix     = self::$container->getParameter('milex.db_table_prefix');
    ...
    protected function createAnotherClient(string $username = 'admin', string $password = 'milex'): Client
    {
