...
class ComposerHelper
{
     ...
     *
     * @param string $packageName The package name, e.g. milex/example-plugin
    ...
    {
        /**
         * "composer remove package-name" also triggers an update of all other Milex dependencies.
     ...
     *
     * @param string $packageName The package name, e.g. milex/exmple-plugin
     */
    ...
    /**
     * Returns a list of installed Composer packages that are of type milex-plugin.
     *
     * @return string[]
     */
    public function getMilexPluginPackages(): array
    {
        return \Composer\InstalledVersions::getInstalledPackagesByType('milex-plugin');
    }
