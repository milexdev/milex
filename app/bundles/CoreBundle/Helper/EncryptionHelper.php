...
use Milex\CoreBundle\Security\Cryptography\Cipher\Symmetric\SymmetricCipherInterface;
use Milex\CoreBundle\Security\Exception\Cryptography\Symmetric\InvalidDecryptionException;
...
class EncryptionHelper
{
    ...
    public function __construct(
        ...
        $this->key = $coreParametersHelper->get('milex.secret_key');
    }
