...
namespace Milex\CoreBundle\Tests\Unit\Form\Validator\Constraints;

use Milex\CoreBundle\Form\Validator\Constraints\CircularDependency;
use Milex\CoreBundle\Form\Validator\Constraints\CircularDependencyValidator;
...
class CircularDependencyValidatorTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @return Milex\CoreBundle\Form\Validator\Constraints\CircularDependencyValidator
     */
    ...
    public function testValidateOnInvalid($message, $currentSegmentId, $filters)
    {
        $this->configureValidator($message, $currentSegmentId)
            ->validate($filters, new CircularDependency(['message' => 'milex.core.segment.circular_dependency_exists']));
    }

    public function validateDataProvider()
    {
        $constraint = new CircularDependency(['message' => 'milex.core.segment.circular_dependency_exists']);
