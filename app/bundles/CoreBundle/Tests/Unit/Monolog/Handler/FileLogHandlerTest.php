...
namespace Milex\CoreBundle\Tests\Unit\Monolog\Handler;

use Milex\CoreBundle\Helper\CoreParametersHelper;
use Milex\CoreBundle\Monolog\Handler\FileLogHandler;
...
class FileLogHandlerTest extends TestCase
{
    ...
    public function testPropertiesAreSetFromCoreParametersHelperWhenDebugModeEnabled(): void
    {
        ...
        $this->assertEquals('/var/logs/milex_test.php', $filename);
