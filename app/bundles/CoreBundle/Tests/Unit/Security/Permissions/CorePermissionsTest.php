...
namespace Milex\CoreBundle\Tests\Unit\Security\Permissions;

use Milex\ApiBundle\Security\Permissions\ApiPermissions;
use Milex\AssetBundle\Security\Permissions\AssetPermissions;
use Milex\CampaignBundle\Security\Permissions\CampaignPermissions;
