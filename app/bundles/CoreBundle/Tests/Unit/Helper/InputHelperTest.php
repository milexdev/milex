...
class InputHelperTest extends TestCase
{
     ...
     *
     * @covers \Milex\CoreBundle\Helper\InputHelper::html
     */
 ...
 <o:OfficeDocumentSettings>
  ...
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">';
     ...
     *
     * @covers \Milex\CoreBundle\Helper\InputHelper::email
     */
     ...
     *
     * @covers \Milex\CoreBundle\Helper\InputHelper::cleanArray
     */
     ...
     *
     * @covers \Milex\CoreBundle\Helper\InputHelper::filename
     */
    ...
    public function urlProvider(): iterable
    {
        ...
        yield ['https://www.milex.org/somewhere/something?foo=bar#abc123', 'https://www.milex.org/somewhere/something?foo=bar#abc123'];

        // non URL is simply cleaned
        yield ['<img src="hello.png" />', '&#60;imgsrc=&#34;hello.png&#34;/&#62;'];

        // disallowed protocol changed to default
        yield ['foo://www.milex.org', 'http://www.milex.org'];

        // user and password are included
        yield ['http://user:password@www.milex.org', 'http://user:password@www.milex.org'];
        ...
        $sanitizedUrl = (\version_compare(PHP_VERSION, '7.3.26', '>=')) ?
            'http://&#60;img&#62;:&#60;img&#62;@www.milex.org' :
            'http://:@www.milex.org';
        yield ['http://<img>:<img>@www.milex.org', $sanitizedUrl];
        ...
        // port is included
        yield ['http://www.milex.org:8080/path', 'http://www.milex.org:8080/path'];

        // path has tags stripped
        yield ['http://www.milex.org/abc<img/src="doesnotexist.jpg">123', 'http://www.milex.org/abc123'];

        // query keys are urlencoded
        yield ['http://www.milex.org?<foo>=bar', 'http://www.milex.org?%3Cfoo%3E=bar'];

        // query is urlencoded appropriately
        yield ['http://www.milex.org?%3Cfoo%3E=<bar>', 'http://www.milex.org?%3Cfoo%3E=%3Cbar%3E'];

        // fragment is included and cleaned
        yield ['http://www.milex.org#<img/src="doesnotexist.jpg">', 'http://www.milex.org#'];
        yield ['http://www.milex.org#%3Cimg%2Fsrc%3D%22doesnotexist.jpg%22%3E', 'http://www.milex.org#%3Cimg%2Fsrc%3D%22doesnotexist.jpg%22%3E'];
        yield ['http://www.milex.org#abc<img/src="doesnotexist.jpg">123', 'http://www.milex.org#abc123'];

        // fragment is not included
        yield ['http://www.milex.org#abc123', 'http://www.milex.org', true];
    }
}
