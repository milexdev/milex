...
use Milex\CoreBundle\Exception\FilePathException;
use Milex\CoreBundle\Exception\FileUploadException;
use Milex\CoreBundle\Helper\FilePathResolver;
use Milex\CoreBundle\Helper\FileUploader;
...
class FileUploaderTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers \Milex\CoreBundle\Helper\FileUploader::upload
     */
     ...
     *
     * @covers \Milex\CoreBundle\Helper\FileUploader::delete
     */
