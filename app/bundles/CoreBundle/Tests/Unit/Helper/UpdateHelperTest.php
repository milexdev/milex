...
use Milex\CoreBundle\Helper\PreUpdateCheckHelper;
...
class UpdateHelperTest extends TestCase
{
    ...
    public function testConnectionErrorReturnsError(): void
    {
        ...
        $this->assertEquals('milex.core.updater.error.fetching.package', $result['message']);
    }
    ...
    public function testCacheIsRefreshedIfStabilityMismatches(): void
    {
        $cache = [
            ...
            'version'      => '10.0.1',
            'announcement' => 'https://milex.org',
            'package'      => 'https://milex.org/10.0.1/upgrade.zip',
            'stability'    => 'stable',
    ...
    public function testStatsAreSent(): void
    {
        ...
        $statsUrl = 'https://milex.org/stats';
    ...
    public function testNoErrorIfLatestVersionInstalled(): void
    {
        ...
        $updateUrl = 'https://milex.org/update';
        $this->coreParametersHelper->expects($this->exactly(3))
            ->method('get')
            ->withConsecutive(
                ['update_stability'],
        ...
        $this->assertEquals('milex.core.updater.running.latest.version', $data['message']);
    }
    ...
    public function testErrorIfLatestVersionCouldNotBeDetermined(): void
    {
        ...
        $this->assertEquals('milex.core.updater.error.fetching.updates', $data['message']);
    }
