...
use Milex\CoreBundle\Helper\Filesystem;
...
use Milex\CoreBundle\Templating\TemplateReference;
...
class ThemeHelperTest extends TestCase
{
    ...
    public function testExceptionThrownWithMissingConfig(): void
    {
        ...
        $this->translator->expects($this->once())
            ->method('trans')
            ->with('milex.core.theme.missing.files', $this->anything(), 'validators')
            ->willReturnCallback(
    ...
    public function testGetCurrentThemeWillReturnCodeModeIfTheThemeIsCodeMode(): void
    {
        ...
        Assert::assertSame('milex_code_mode', $themeHelper->getCurrentTheme('milex_code_mode', 'foo'));
    }
}
