...
namespace Milex\CoreBundle\Tests\Unit\Doctrine;

use Doctrine\DBAL\Platforms\AbstractPlatform;
use Doctrine\DBAL\Platforms\MySqlPlatform;
use Doctrine\DBAL\Types\Type;
use Milex\CoreBundle\Doctrine\Type\ArrayType;
...
{
    const MILEX_ARRAY_TYPE_NAME = 'milex-array-type';
    ...
    protected function setUp(): void
    {
        ...
        if (!Type::hasType(self::MILEX_ARRAY_TYPE_NAME)) {
            Type::addType(self::MILEX_ARRAY_TYPE_NAME, 'Milex\CoreBundle\Doctrine\Type\ArrayType');
        }

        $this->arrayType = Type::getType(self::MILEX_ARRAY_TYPE_NAME);
    ...
    public function testGivenObjectWithPublicPropertyWhenConvertsToDatabaseValueThenGetEncodedData()
    {
        ...
        $this->assertEquals(
            'a:1:{i:0;O:68:"Milex\CoreBundle\Tests\Unit\Doctrine\ExampleClassWithPublicProperty":1:{s:4:"test";s:5:"value";}}',
            $result
        );
    }
