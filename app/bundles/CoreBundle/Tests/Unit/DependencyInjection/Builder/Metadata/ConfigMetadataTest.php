...
class ConfigMetadataTest extends TestCase
{
    ...
    public function testConfigIsLoaded()
    {
        ...
        $this->assertTrue(isset($config['services']['helpers']['milex.helper.bundle']));
    ...
    public function testOptionalMissingServicesAreIgnored()
    {
        ...
        $config = $this->metadata->toArray()['config'];
        $this->assertFalse(isset($config['services']['fixtures']['milex.test.fixture']));
    }
    ...
    public function testParameterArgumentsAreEncoded()
    {
        ...
        $this->assertEquals('%%milex.bundles%%', $config['services']['helpers']['milex.helper.bundle']['arguments'][0]);
    }
