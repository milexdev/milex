...
use Milex\CoreBundle\Update\Step\FinalizeUpdateStep;
...
class FinalizeUpdateStepTest extends AbstractStepTest
{
    ...
    public function testFinalizationCleansUpFiles()
    {
        ...
        $wrappingUpKey       = 'milex.core.update.step.wrapping_up';
        $updateSuccessfulKey = 'milex.core.update.update_successful';
