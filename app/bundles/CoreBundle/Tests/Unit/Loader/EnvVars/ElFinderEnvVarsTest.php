...
use Milex\CoreBundle\Loader\EnvVars\ElFinderEnvVars;
...
class ElFinderEnvVarsTest extends TestCase
{
    ...
    public function testPathAndUrlSet()
    {
        ...
        $this->assertStringEndsWith('images', $this->envVars->get('MILEX_EL_FINDER_PATH'));
        $this->assertEquals('https://foo.bar/test/images', $this->envVars->get('MILEX_EL_FINDER_URL'));
    }
    ...
    public function testThatTheLocalRootHasPriorityOverTheKernelRootDir()
    {
        ...
        ElFinderEnvVars::load($this->config, $this->defaultConfig, $this->envVars);
        $this->assertSame('/foo/bar/images', $this->envVars->get('MILEX_EL_FINDER_PATH'));
    }
}
