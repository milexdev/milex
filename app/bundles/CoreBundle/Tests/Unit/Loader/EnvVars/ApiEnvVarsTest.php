...
use Milex\CoreBundle\Loader\EnvVars\ApiEnvVars;
...
class ApiEnvVarsTest extends TestCase
{
    ...
    public function testOauth2TokenLifetimesAreCalculatedWhenSet(): void
    {
        ...
        $this->assertEquals(120, $this->envVars->get('MILEX_API_OAUTH2_ACCESS_TOKEN_LIFETIME'));
        $this->assertEquals(172800, $this->envVars->get('MILEX_API_OAUTH2_REFRESH_TOKEN_LIFETIME'));
    }
    ...
    public function testOauth2TokenLifetimesAreDefaultWhenNotSet(): void
    {
        ...
        $this->assertEquals(3600, $this->envVars->get('MILEX_API_OAUTH2_ACCESS_TOKEN_LIFETIME'));
        $this->assertEquals(1209600, $this->envVars->get('MILEX_API_OAUTH2_REFRESH_TOKEN_LIFETIME'));
    }
    ...
    public function testRateLimitIsEnabled(): void
    {
        ...
        $this->assertTrue($this->envVars->get('MILEX_API_RATE_LIMIT_ENABLED'));
    }
    ...
    public function testRateLimitIsDisabled(): void
    {
        ...
        $this->assertFalse($this->envVars->get('MILEX_API_RATE_LIMIT_ENABLED'));
    }
}
