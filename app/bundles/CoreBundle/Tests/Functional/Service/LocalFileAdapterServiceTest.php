...
namespace Milex\CoreBundle\Tests\Functional\Service;
...
class LocalFileAdapterServiceTest extends MilexMysqlTestCase
{
    /**
     * @var string
     */
    ...
    {
        $pathsHelper = self::$container->get('milex.helper.paths');
