...
final class FinalizeUpdateStep implements StepInterface
{
    ...
    {
        $progressBar->setMessage($this->translator->trans('milex.core.update.step.wrapping_up'));
        $progressBar->advance();
        ...
        $progressBar->setMessage(
            $this->translator->trans('milex.core.update.update_successful', ['%version%' => $this->appVersion->getVersion()])."\n\n"
        );
        $progressBar->finish();
