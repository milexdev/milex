...
final class UpdateSchemaStep implements StepInterface
{
    ...
    public function execute(ProgressBar $progressBar, InputInterface $input, OutputInterface $output): void
    {
        ...
        $progressBar->setMessage($this->translator->trans('milex.core.update.migrating.database.schema'));
        $progressBar->advance();
        ...
        if (0 !== $migrateExitCode) {
            throw new UpdateFailedException($this->translator->trans('milex.core.update.error_performing_migration'));
        }
    }
}
