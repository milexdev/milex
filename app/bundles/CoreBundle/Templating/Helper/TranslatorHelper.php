...
class TranslatorHelper extends BaseHelper
{
    ...
    public function getJsLang()
    {
        ...
        $oldKeys = [
            'chosenChooseOne'     => $this->trans('milex.core.form.chooseone'),
            'chosenChooseMore'    => $this->trans('milex.core.form.choosemultiple'),
            'chosenNoResults'     => $this->trans('milex.core.form.nomatches'),
            'pleaseWait'          => $this->trans('milex.core.wait'),
            'popupBlockerMessage' => $this->trans('milex.core.popupblocked'),
        ];
