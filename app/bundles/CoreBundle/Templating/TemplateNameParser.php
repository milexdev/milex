...
namespace Milex\CoreBundle\Templating;
...
class TemplateNameParser extends BaseTemplateNameParser
{
    ...
    public function parse($name)
    {
        ...
        $template->setThemeHelper($this->container->get('milex.helper.theme'));
        $template->setPathsHelper($this->container->get('milex.helper.paths'));
