...
/** @var \Milex\UserBundle\Entity\User $me */
$view->extend('MilexCoreBundle:Default:content.html.php');
$view['slots']->set('milexContent', 'user');
$view['slots']->set('headerTitle', $view['translator']->trans('milex.user.account.settings'));
?>
<!-- start: box layout -->
            ...
            <ul class="list-group list-group-tabs">
                <li class="list-group-item active">
                    <a href="#profile" class="steps" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.user.account.header.details'); ?>
                    </a>
                </li>
                <?php if ($permissions['apiAccess']): ?>
                <li class="list-group-item">
                    <a href="#clients" class="steps" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.user.account.header.authorizedclients'); ?>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active bdr-rds-0 bdr-w-0" id="profile">
                ...
                <div class="pa-md bg-auto bg-light-xs bdr-b">
                    <h4 class="fw-sb"><?php echo $view['translator']->trans('milex.user.account.header.details'); ?></h4>
                </div>
                <div class="pa-md">
                    <div class="col-md-6">
                        <?php
            ...
            <?php if ($permissions['apiAccess']): ?>
                <div class="tab-pane fade bdr-rds-0 bdr-w-0" id="clients">
                    <div class="pa-md bg-auto bg-light-xs bdr-b">
                        <h4 class="fw-sb"><?php echo $view['translator']->trans('milex.user.account.header.authorizedclients'); ?></h4>
                    </div>
                    <div class="pa-md">
