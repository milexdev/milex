...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $view['slots']->get('pageTitle', 'Milex'); ?></title>
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
                <div class="panel" name="form-login">
                    <div class="panel-body">
                        <div class="milex-logo img-circle mb-md text-center">
         ...
         <div class="row">
            <div class="col-lg-4 col-lg-offset-4 text-center text-muted">
                <?php echo $view['translator']->trans('milex.core.copyright', ['%date%' => date('Y')]); ?>
            </div>
        </div>
    </div>
</section>
