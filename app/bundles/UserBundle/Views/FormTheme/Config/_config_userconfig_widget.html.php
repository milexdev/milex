...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $view['translator']->trans('milex.user.config.header.saml'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="alert alert-info"><?php echo $view['translator']->trans('milex.user.config.form.saml.idp_entity_id', ['%entityId%' => $entityId]); ?></div>
        ...
        <hr />
        <div class="alert alert-info"><?php echo $view['translator']->trans('milex.user.config.form.saml.idp_attributes'); ?></div>
        <div class="row">
            <div class="col-md-6">
        ...
        <hr />
        <div class="alert alert-info"><?php echo $view['translator']->trans('milex.user.config.form.saml.idp.own_certificate.description'); ?></div>
        <div class="row">
            <div class="col-md-6">
