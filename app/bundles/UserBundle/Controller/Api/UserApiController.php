...
namespace Milex\UserBundle\Controller\Api;
...
class UserApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Milex\UserBundle\Entity\User';
    ...
    public function editEntityAction($id)
    {
        ...
        if (null === $entity) {
            if ('PATCH' === $method ||
                ('PUT' === $method && !$this->get('milex.security')->isGranted('user:users:create'))
            ) {
    ...
    public function isGrantedAction($id)
    {
        ...
        if (empty($permissions)) {
            return $this->badRequest('milex.api.call.permissionempty');
        } elseif (!is_array($permissions)) {
            $permissions = [$permissions];
        }

        $return = $this->get('milex.security')->isGranted($permissions, 'RETURN_ARRAY', $entity);
