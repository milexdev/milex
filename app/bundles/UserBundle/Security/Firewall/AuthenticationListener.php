...
namespace Milex\UserBundle\Security\Firewall;

use Doctrine\ORM\EntityManagerInterface;
use Milex\ApiBundle\Entity\oAuth2\AccessToken;
use Milex\UserBundle\Entity\PermissionRepository;
use Milex\UserBundle\Entity\User;
use Milex\UserBundle\Security\Authentication\AuthenticationHandler;
use Milex\UserBundle\Security\Authentication\Token\PluginToken;
...
class AuthenticationListener implements ListenerInterface
{
        ...
        try {
            ...
            if ($authToken instanceof PluginToken) {
                ...
                if ($authToken->isAuthenticated()) {
                    ...
                    throw new AuthenticationException('milex.user.auth.error.invalidlogin');
                }
            }
    ...
    private function assignRoleFromToken(TokenInterface $token): User
    {
        ...
        defined('MILEX_AUDITLOG_USER') || define('MILEX_AUDITLOG_USER', $user->getName());
