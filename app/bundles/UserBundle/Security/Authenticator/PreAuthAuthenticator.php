...
namespace Milex\UserBundle\Security\Authenticator;

use Milex\PluginBundle\Helper\IntegrationHelper;
use Milex\UserBundle\Entity\User;
use Milex\UserBundle\Event\AuthenticationEvent;
    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        if (!$user instanceof User) {
            ...
            if ($this->dispatcher->hasListeners(UserEvents::USER_PRE_AUTHENTICATION)) {
                ...
                $loginCheck = ('milex_sso_login_check' == $request->attributes->get('_route'));
