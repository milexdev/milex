...
class AuthenticationEvent extends Event
{
    ...
    /**
     * @param        $user
     * @param bool   $loginCheck            Event executed from the milex_sso_login_check route typically used as the SSO callback
    ...
    public function __construct(
        ...
        if ($userProvider instanceof ChainUserProvider) {
            // Chain of user providers so let's find Milex's
    ...
    /**
     * Check if the event is executed as the result of accessing milex_sso_login_check.
     *
     * @return bool
     */
