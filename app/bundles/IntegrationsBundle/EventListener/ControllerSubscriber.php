...
class ControllerSubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelController(FilterControllerEvent $event): void
    {
        ...
        if ('Milex\PluginBundle\Controller\PluginController::configAction' === $request->get('_controller')) {
            ...
            try {
                ...
                $request->attributes->add(
                    [
                        ...
                        'page'          => $page,
                        '_controller'   => 'Milex\IntegrationsBundle\Controller\ConfigController::editAction',
                        '_route_params' => [
                            'integration' => $integrationName,
                            'page'        => $page,
                        ],
