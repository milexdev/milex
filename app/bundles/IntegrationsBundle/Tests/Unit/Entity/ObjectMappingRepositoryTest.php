...
namespace Milex\IntegrationsBundle\Tests\Unit\Entity;
...
final class ObjectMappingRepositoryTest extends TestCase
{
    ...
    public function testDeleteEntitiesForObject(): void
    {
        $this->entityManager->expects($this->once())
            ->method('createQuery')
            ->with('DELETE Milex\IntegrationsBundle\Entity\ObjectMapping m WHERE m.internalObjectName = :internalObject AND m.internalObjectId = :internalObjectId')
