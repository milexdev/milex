...
namespace Milex\IntegrationsBundle\Tests\Unit\Sync\DAO\Mapping;
...
class MappingManualDAOTest extends TestCase
{
    ...
    public function testThatOneWayInternalObjectFieldsAreNotReturnedWhenNotRequired(): void
    {
        $this->assertEquals(
            [
                ...
                'firstname', // sync from milex to integration
            ],
    ...
    public function testThatOneWayIntegrationObjectFieldsAreNotReturnedWhenNotRequired(): void
    {
        $this->assertEquals(
            [
                'email',    // required and bidirectional
                'country',  // bidirectional
                'last_name', // sync from milex to integration
            ],
            $this->getMappingManualDAO()->getIntegrationObjectFieldsToSyncToMilex($this->integrationObjectName)
        );
    }
    ...
    private function getMappingManualDAO()
    {
        ...
        $objectMapping->addFieldMapping('lastname', 'last_name', ObjectMappingDAO::SYNC_TO_MILEX);
