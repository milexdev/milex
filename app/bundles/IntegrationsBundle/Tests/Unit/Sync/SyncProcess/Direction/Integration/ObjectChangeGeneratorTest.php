...
namespace Milex\IntegrationsBundle\Tests\Unit\Sync\SyncProcess\Direction\Integration;
...
use Milex\IntegrationsBundle\Sync\SyncProcess\Direction\Integration\ObjectChangeGenerator;
...
class ObjectChangeGeneratorTest extends TestCase
{
    ...
    public function testFieldIsAddedToObjectChange(): void
    {
        ...
        // mapped object and ID should be Milex's
