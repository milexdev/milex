...
namespace Milex\IntegrationsBundle\Tests\Unit\Sync\SyncDataExchange\Helper;
...
class FieldHelperTest extends TestCase
{
    ...
    /**
     * @var MilexSyncFieldsLoadEvent|\PHPUnit\Framework\MockObject\MockObject
     */
    private $milexSyncFieldsLoadEvent;
    ...
    protected function setUp(): void
    {
        ...
        $this->milexSyncFieldsLoadEvent = $this->createMock(MilexSyncFieldsLoadEvent::class);
        $this->eventDispatcher           = $this->createMock(EventDispatcherInterface::class);
        $this->eventDispatcher->method('dispatch')
            ->willReturn($this->milexSyncFieldsLoadEvent);
    ...
    public function testContactSyncFieldsReturned(): void
    {
        ...
        $this->milexSyncFieldsLoadEvent->method('getObjectName')
            ->willReturn($objectName);
        $this->milexSyncFieldsLoadEvent->method('getFields')
        ...
        $this->assertEquals(
            [
                'email',
                'milex_internal_contact_timeline',
                'milex_internal_dnc_email',
                'milex_internal_id',
            ],
            array_keys($fields)
        );
