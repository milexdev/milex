...
class CompanyObjectHelperTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $objects = [
            new ObjectChangeDAO('Test', MilexSyncDataExchange::OBJECT_COMPANY, null, 'MappedObject', 1, new \DateTime()),
            new ObjectChangeDAO('Test', MilexSyncDataExchange::OBJECT_COMPANY, null, 'MappedObject', 2, new \DateTime()),
        ];
        ...
        foreach ($objectMappings as $key => $objectMapping) {
            ...
            $this->assertEquals(MilexSyncDataExchange::OBJECT_COMPANY, $objectMapping->getInternalObjectName());
    ...
    public function testUpdate(): void
    {
        ...
        $objects = [
            0 => new ObjectChangeDAO('Test', MilexSyncDataExchange::OBJECT_COMPANY, 0, 'MappedObject', 0, new \DateTime()),
            1 => new ObjectChangeDAO('Test', MilexSyncDataExchange::OBJECT_COMPANY, 1, 'MappedObject', 1, new \DateTime()),
        ];
