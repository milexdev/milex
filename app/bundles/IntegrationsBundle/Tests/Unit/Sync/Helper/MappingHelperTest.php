...
use Milex\IntegrationsBundle\Sync\SyncDataExchange\Internal\Object\Company;
...
class MappingHelperTest extends TestCase
{
    ...
    public function testObjectReturnedIfKnwonMappingExists(): void
    {
        ...
        $foundInternalObject = $this->mappingHelper->findMilexObject($mappingManual, $internalObjectName, $integrationObjectDAO);
    ...
    public function testMilexObjectSearchedAndEmptyObjectReturnedIfNoIdentifierFieldsAreMapped(): void
    {
    ...
    public function testEmptyObjectIsReturnedWhenMilexContactIsNotFound(): void
    {
        $this->fieldModel->expects($this->once())
            ->method('getUniqueIdentifierFields')
            ->willReturn(
    ...
    public function testMilexContactIsFoundAndReturnedAsObjectDAO(): void
    {
        $this->fieldModel->expects($this->once())
            ->method('getUniqueIdentifierFields')
            ->willReturn(
    ...
    public function testMilexCompanyIsFoundAndReturnedAsObjectDAO(): void
    {
        $this->fieldModel->expects($this->once())
            ->method('getUniqueIdentifierFields')
            ->willReturn(
        ...
        $foundInternalObject = $this->mappingHelper->findMilexObject(
            $mappingManual,
            $internalObjectName,
