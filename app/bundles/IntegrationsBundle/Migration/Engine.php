...
namespace Milex\IntegrationsBundle\Migration;

use Doctrine\DBAL\DBALException;
use Doctrine\ORM\EntityManager;
use Milex\IntegrationsBundle\Exception\PathNotFoundException;
...
class Engine
{
    ...
    private function getMigrationClasses(): array
    {
        ...
        foreach ($migrationFileNames as $fileName) {
            ...
            $className          = 'MilexPlugin\\'.$this->bundleName."\Migrations\\${className}";
