...
namespace Milex\IntegrationsBundle\Sync\SyncProcess\Direction\Helper;
...
class ValueHelper
{
    ...
    public function getValueForIntegration(NormalizedValueDAO $normalizedValueDAO, string $fieldState, string $syncDirection): NormalizedValueDAO
    {
        ...
        $newValue = $this->getValue(ObjectMappingDAO::SYNC_TO_MILEX);
     ...
     * @throws InvalidValueException
     */
    public function getValueForMilex(NormalizedValueDAO $normalizedValueDAO, string $fieldState, string $syncDirection): NormalizedValueDAO
    {
        $this->normalizedValueDAO = $normalizedValueDAO;
        $this->fieldState         = $fieldState;
        $this->syncDirection      = $syncDirection;
