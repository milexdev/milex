...
use Milex\IntegrationsBundle\Exception\UnexpectedValueException;
...
class OrderDAO
{
    ...
    /**
     * Create a new mapping between the Milex and Integration objects.
     *
    ...
    /**
     * Mark an object as deleted in the integration so Milex doesn't continue to attempt to sync it.
     */
    ...
    /**
     * If there is a temporary issue with syncing the object, tell the sync engine to not wipe out the tracked changes on Milex's object fields
