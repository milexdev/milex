...
/** @var \Milex\IntegrationsBundle\Integration\Interfaces\IntegrationInterface $integrationObject Set through buildView */
...
<ul class="nav nav-tabs">
    ...
    <li class="<?php if ('details-container' === $activeTab): echo 'active'; endif; ?> " id="details-tab">
        <a href="#details-container" role="tab" data-toggle="tab">
            <?php echo $view['translator']->trans('milex.plugin.integration.tab.details'); ?>
    ...
    <?php if ($showFeaturesTab): ?>
        <li class="" id="features-tab">
            <a href="#features-container" role="tab" data-toggle="tab">
                <?php echo $view['translator']->trans('milex.plugin.integration.tab.features'); ?>
    ...
    <?php $objects = $integrationObject->getSyncConfigObjects(); ?>
        ...
        <li class="<?php if ($activeTab == "field-mapping-{$object}"): echo 'active'; endif; ?> " id="fields-<?php echo $object; ?>-tab">
            <a href="#field-mappings-<?php echo $object; ?>-container" role="tab" data-toggle="tab">
                <?php echo $view['translator']->trans('milex.integration.sync_field_mapping', ['%object%' => $view['translator']->trans($objects[$object])]); ?>
...
<div class="tab-content pa-md bg-white">
    ...
    <div class="tab-pane fade <?php if ('details-container' == $activeTab): echo 'in active'; endif; ?> bdr-w-0" id="details-container">
        ...
        <?php if ($integrationObject instanceof \Milex\IntegrationsBundle\Integration\Interfaces\ConfigFormAuthInterface): ?>
        <hr />
        <?php echo $view['form']->row($form['apiKeys']); ?>
            ...
            <div class="well well-sm">
                <?php echo $view['translator']->trans('milex.integration.callbackuri'); ?><br/>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <button type="button" id="integration_details_authButton" name="integration_details[authButton]" class="btn btn-success btn-lg" onclick="Milex.authorizeIntegration()">
                        <i class="fa fa-key "></i>
                        <?php if ($integrationObject->isAuthorized()): ?>
                            <?php echo $view['translator']->trans('milex.integration.form.reauthorize'); ?>
                        <?php else: ?>
                            <?php echo $view['translator']->trans('milex.integration.form.authorize'); ?>
                        <?php endif; ?>
                    </button>
                </div>
            </div>
