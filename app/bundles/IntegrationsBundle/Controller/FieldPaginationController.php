...
use Milex\IntegrationsBundle\Form\Type\IntegrationSyncSettingsObjectFieldMappingType;
use Milex\IntegrationsBundle\Helper\ConfigIntegrationsHelper;
use Milex\IntegrationsBundle\Helper\FieldFilterHelper;
...
class FieldPaginationController extends CommonController
{
    ...
    public function paginateAction(string $integration, string $object, int $page, Request $request)
    {
        ...
        $integrationsHelper = $this->get('milex.integrations.helper.config_integrations');
