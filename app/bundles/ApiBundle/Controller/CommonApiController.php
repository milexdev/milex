...
use Milex\ApiBundle\ApiEvents;
use Milex\ApiBundle\Event\ApiEntityEvent;
use Milex\ApiBundle\Helper\BatchIdToEntityHelper;
use Milex\ApiBundle\Helper\EntityResultHelper;
use Milex\ApiBundle\Serializer\Exclusion\ParentChildrenExclusionStrategy;
...
use Milex\CoreBundle\Security\Exception\PermissionException;
 ...
 */
class CommonApiController extends AbstractFOSRestController implements MilexController
{
    use RequestTrait;
     ...
     *
     * @var \Milex\CoreBundle\Model\AbstractCommonModel
     */
    protected $model;
    ...
    /**
     * @var \Milex\CoreBundle\Security\Permissions\CorePermissions
     */
    protected $security;
    ...
    {
        // @see \Milex\CoreBundle\EventListener\CoreSubscriber::onKernelController()
    }
    ...
    protected function view($data = null, $statusCode = null, array $headers = [])
    {
        ...
        $headers['Milex-Version'] = $this->get('kernel')->getVersion();
