...
namespace Milex\ApiBundle\Model;

use Milex\ApiBundle\ApiEvents;
use Milex\ApiBundle\Entity\oAuth2\Client;
use Milex\ApiBundle\Event\ClientEvent;
use Milex\ApiBundle\Form\Type\ClientType;
...
class ClientModel extends FormModel
{
     ...
     * {@inheritdoc}
     */
    public function getRepository(): \Milex\ApiBundle\Entity\oAuth2\ClientRepository
    {
