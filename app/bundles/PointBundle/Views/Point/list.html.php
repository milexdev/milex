 ...
 */
if ('index' == $tmpl) {
    $view->extend('MilexPointBundle:Point:index.html.php');
}
?>
            ...
            <tr>
                ...
                echo $view->render(
                    ...
                    [
                        'sessionVar' => 'point',
                        'orderBy'    => 'p.delta',
                        'text'       => 'milex.point.thead.delta',
                        'class'      => 'visible-md visible-lg col-point-delta',
                    ]
                );

                echo '<th class="col-point-action">'.$view['translator']->trans('milex.point.thead.action').'</th>';
    ...
    <div class="panel-footer">
        <?php echo $view->render(
            ...
            [
                ...
                'page'       => $page,
                'limit'      => $limit,
                'menuLinkId' => 'milex_point_index',
                'baseUrl'    => $view['router']->path('milex_point_index'),
                'sessionVar' => 'point',
            ]
        ); ?>
    </div>
<?php else: ?>
    <?php echo $view->render(
        ...
        ['tip' => 'milex.point.action.noresults.tip']
    ); ?>
<?php endif; ?>
