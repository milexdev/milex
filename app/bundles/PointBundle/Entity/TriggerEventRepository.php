...
namespace Milex\PointBundle\Entity;
...
class TriggerEventRepository extends CommonRepository
{
    ...
    public function getLeadTriggeredEvents($leadId)
    {
        $q = $this->_em->getConnection()->createQueryBuilder()
            ->select('e.*')
            ->from(MILEX_TABLE_PREFIX.'point_lead_event_log', 'x')
            ->innerJoin('x', MILEX_TABLE_PREFIX.'point_trigger_events', 'e', 'x.event_id = e.id')
            ->innerJoin('e', MILEX_TABLE_PREFIX.'point_triggers', 't', 'e.trigger_id = t.id');
    ...
    public function getLeadsForEvent($eventId)
    {
        $results = $this->_em->getConnection()->createQueryBuilder()
            ->select('e.lead_id')
            ->from(MILEX_TABLE_PREFIX.'point_lead_event_log', 'e')
