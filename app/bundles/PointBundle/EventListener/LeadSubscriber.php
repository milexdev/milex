...
use Milex\PointBundle\Entity\LeadPointLogRepository;
use Milex\PointBundle\Entity\LeadTriggerLogRepository;
...
class LeadSubscriber implements EventSubscriberInterface
{
    ...
    public function onTimelineGenerate(LeadTimelineEvent $event)
    {
        ...
        $eventTypeName = $this->translator->trans('milex.point.event.gained');
