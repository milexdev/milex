...
namespace Milex\PointBundle\Controller\Api;
...
class PointApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Milex\PointBundle\Entity\Point';
    ...
    protected function logApiPointChange($lead, $delta, $operator)
    {
        ...
        $ip         = $this->get('milex.helper.ip_lookup')->getIpAddress();
        $eventName  = InputHelper::clean($this->request->request->get('eventName', $trans->trans('milex.lead.lead.submitaction.operator_'.$operator)));
        $actionName = InputHelper::clean($this->request->request->get('actionName', $trans->trans('milex.lead.event.api')));
