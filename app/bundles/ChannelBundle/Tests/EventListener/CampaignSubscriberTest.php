...
namespace Milex\ChannelBundle\Tests\EventListener;
...
use Milex\CampaignBundle\Executioner\Dispatcher\LegacyEventDispatcher;
...
use Milex\ChannelBundle\EventListener\CampaignSubscriber;
use Milex\ChannelBundle\Form\Type\MessageSendType;
...
class CampaignSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $factory = $this->getMockBuilder(MilexFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
                        ...
                        case 'sms.send_text_sms':
                            return new ActionAccessor(
                                [
                                    ...
                                    'timelineTemplate' => 'MilexSmsBundle:SubscribedEvents\Timeline:index.html.php',
                                    'channel'          => 'sms',
                                    'channelIdField'   => 'sms',
                                ]
                            );
    ...
    public function testCorrectChannelIsUsed()
    {
        ...
        $config = new ActionAccessor(
            [
                ...
                'formTheme'              => 'MilexChannelBundle:FormTheme\MessageSend',
                ...
                'timelineTemplate'       => 'MilexChannelBundle:SubscribedEvents\Timeline:index.html.php',
