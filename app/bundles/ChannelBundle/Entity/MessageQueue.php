...
namespace Milex\ChannelBundle\Entity;
...
class MessageQueue
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('message_queue')
            ->setCustomRepositoryClass('Milex\ChannelBundle\Entity\MessageQueueRepository')
        ...
        $builder->createManyToOne('event', 'Milex\CampaignBundle\Entity\Event')
