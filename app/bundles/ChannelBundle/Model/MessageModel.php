...
use Milex\ChannelBundle\Event\MessageEvent;
use Milex\ChannelBundle\Form\Type\MessageType;
...
class MessageModel extends FormModel implements AjaxLookupModelInterface
{
    ...
    /**
     * @return \Doctrine\ORM\EntityRepository|\Milex\ChannelBundle\Entity\MessageRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexChannelBundle:Message');
    }
