...
use Milex\ChannelBundle\Entity\Channel;
use Milex\ChannelBundle\Model\MessageModel;
use Milex\CoreBundle\Controller\AbstractStandardFormController;
...
class MessageController extends AbstractStandardFormController
{
     ...
     * @param $objectId
     *
     * @return \Milex\CoreBundle\Controller\Response|\Symfony\Component\HttpFoundation\JsonResponse|\Symfony\Component\HttpFoundation\RedirectResponse
     */
     ...
     *
     * @return \Milex\CoreBundle\Controller\Response|\Symfony\Component\HttpFoundation\JsonResponse
     */
        ...
        switch ($action) {
            case 'index':
                $viewParameters = [
                    ...
                    'listItemTemplate'  => 'MilexChannelBundle:Message:list_item.html.php',
            ...
            case 'view':
                ...
                $messagedLeads = [
                    'all' => $this->forward(
                        'MilexChannelBundle:Message:contacts',
                        [
                            'objectId'   => $message->getId(),
    ...
    {
        return 'MilexChannelBundle:Message';
    }
    ...
    {
        $themes = ['MilexChannelBundle:FormTheme'];
        /** @var MessageModel $model */
        $model    = $this->getModel($this->getModelName());
        $channels = $model->getChannels();
        ...
        return $this->setFormTheme($form, 'MilexChannelBundle:Message:form.html.php', $themes);
    }
