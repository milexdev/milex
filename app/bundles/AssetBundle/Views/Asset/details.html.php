...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $activeAsset])
);
...
<div class="box-layout">
    ...
    <div class="col-md-9 bg-white height-auto">
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            ...
                            <div class="pt-0 pl-15 pb-10 pr-15">
                                <?php echo $view->render('MilexCoreBundle:Helper:chart.html.php', ['chartData' => $stats['downloads']['timeStats'], 'chartType' => 'line', 'chartHeight' => 300]); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-content pa-md preview-detail">
            <?php echo $view->render(
                'MilexAssetBundle:Asset:preview.html.php',
