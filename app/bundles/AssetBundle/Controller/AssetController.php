...
namespace Milex\AssetBundle\Controller;
...
class AssetController extends FormController
{
    ...
    public function indexAction($page = 1)
    {
        ...
        if ($count && $count < ($start + 1)) {
            ...
            return $this->postActionRedirect([
                ...
                'contentTemplate' => 'MilexAssetBundle:Asset:index',
                'passthroughVars' => [
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MilexAssetBundle:Asset:list.html.php',
            'passthroughVars' => [
                'activeLink'    => '#milex_asset_index',
                'milexContent' => 'asset',
    ...
    public function viewAction($objectId)
    {
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MilexAssetBundle:Asset:'.$tmpl.'.html.php',
            'passthroughVars' => [
                'activeLink'    => '#milex_asset_index',
                'milexContent' => 'asset',
            ],
    ...
    {
        /** @var \Milex\AssetBundle\Model\AssetModel $model */
        $model       = $this->getModel('asset');
        $activeAsset = $model->getEntity($objectId);
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MilexAssetBundle:Asset:preview.html.php',
            'passthroughVars' => [
                'route' => false,
            ],
        ]);
    ...
    public function newAction($entity = null)
    {
        ...
        /** @var \Milex\AssetBundle\Entity\Asset $entity */
        if (null == $entity) {
        ...
        if ('POST' == $method) {
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form)) {
                    ...
                    $template  = 'MilexAssetBundle:Asset:view';
                }
            } else {
                $viewParameters = ['page' => $page];
                $returnUrl      = $this->generateUrl('milex_asset_index', $viewParameters);
                $template       = 'MilexAssetBundle:Asset:index';
            }
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MilexAssetBundle:Asset:form.html.php',
            'passthroughVars' => [
                'activeLink'    => '#milex_asset_index',
                'milexContent' => 'asset',
    ...
    public function remoteAction()
    {
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MilexAssetBundle:Remote:browse.html.php',
            'passthroughVars' => [
                'activeLink'    => '#milex_asset_index',
                'milexContent' => 'asset',
