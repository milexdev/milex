...
use Milex\AssetBundle\Event\RemoteAssetBrowseEvent;
...
class AjaxController extends CommonAjaxController
{
    ...
    protected function fetchRemoteFilesAction(Request $request)
    {
        ...
        /** @var \Milex\PluginBundle\Integration\AbstractIntegration $integration */
        ...
        $output = $this->renderView(
            'MilexAssetBundle:Remote:list.html.php',
            [
                'connector'   => $connector,
