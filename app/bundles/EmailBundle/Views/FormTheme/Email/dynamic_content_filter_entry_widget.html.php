        ...
        <div class="col-xs-5">
            <div class="form-group">
                <div class="available-filters pl-0">
                    <select class="chosen form-control" data-milex="available_filters">
                        <option value=""></option>
                        <?php
                            ...
                            <optgroup label="<?php echo $view['translator']->trans('milex.lead.'.$header); ?>">
                                <?php foreach ($field as $value => $params):
                                    ...
                                    $choices   = ('boolean' === $params['properties']['type'])
                                        ?
                                        \Milex\LeadBundle\Helper\FormFieldHelper::parseBooleanList($list)
                                        :
