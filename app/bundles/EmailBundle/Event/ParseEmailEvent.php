...
class ParseEmailEvent extends Event
{
     ...
     *
     * @return \Milex\EmailBundle\MonitoredEmail\Message[]
     */
     ...
     * @param string $criteria   Should be a string using combinations of Milex\EmailBundle\MonitoredEmail\Mailbox::CRITERIA_* constants
