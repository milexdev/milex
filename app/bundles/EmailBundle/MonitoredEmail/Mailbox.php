...
use Milex\EmailBundle\Exception\MailboxException;
use Milex\EmailBundle\MonitoredEmail\Exception\NotConfiguredException;
use stdClass;
...
class Mailbox
{
    ...
    public function getListingFolders()
    {
        if (!$this->isConfigured()) {
            throw new NotConfiguredException('milex.email.config.monitored_email.not_configured');
        }
