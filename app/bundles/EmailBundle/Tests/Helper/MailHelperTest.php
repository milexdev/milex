...
class MailHelperTest extends TestCase
{
    ...
    public function testImagesEmbeddedOnSend(): void
    {
        ...
        $initialHtml = 'Text <a href="https://milex.com">Milex</a> <img src="{ token }" /> <img src="https://milex.com/contact/{ token2 }/avatar.png"/> <img src="/tmp/fake.jpg">';
        ...
        $eventDispatcher->expects(self::once())
            ...
            ->willReturnCallback(static function (string $eventName, EmailSendEvent $event): object {
                $event->addToken('{ token }', 'https://milex.com/image.gif');
        ...
        $router->expects(self::exactly(3))
            ->method('generate')
            ->withConsecutive([
                'milex_email_unsubscribe', ['idHash' => $mailer->getIdHash()], UrlGeneratorInterface::ABSOLUTE_URL,
            ], [
                'milex_email_tracker', ['idHash' => $mailer->getIdHash()], UrlGeneratorInterface::ABSOLUTE_URL,
            ], [
                'milex_email_tracker', ['idHash' => $mailer->getIdHash()], UrlGeneratorInterface::ABSOLUTE_URL,
            ])
        ...
        Assert::assertMatchesRegularExpression(
            '~Text <a href="https://milex.com">Milex</a> <img src="cid:[a-zA-Z0-9]+@swift.generated" /> <img src="cid:[a-zA-Z0-9]+@swift.generated"/> <img src="cid:[a-zA-Z0-9]+@swift.generated"><img height="1" width="1" src="/tracking.gif" alt="" />~',
