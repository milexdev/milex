...
namespace Milex\EmailBundle\Tests\Validator;
...
use Milex\EmailBundle\Validator\EmailOrEmailTokenListValidator;
    ...
    public function provider(): \Generator
    {
        ...
        yield [
            ...
            function ($message, array $parameters = []) {
                Assert::assertSame('milex.email.email_or_token.not_valid', $message);
                Assert::assertSame(
                    [
                        '%value%'   => 'somestring',
            ...
            function ($message, array $parameters = []) {
                ...
                Assert::assertSame(
                    [
                        ...
                        '%details%' => 'milex.email.address.invalid_format',
                    ],
                    $parameters
                );
            },
            ...
            function ($message, array $parameters = []) {
                ...
                Assert::assertSame(
                    [
                        ...
                        '%details%' => 'milex.lead.contact.field.not.found',
                    ],
                    $parameters
                );
            },
            ...
            function ($message, array $parameters = []) {
                ...
                Assert::assertSame(
                    [
                        ...
                        '%details%' => 'milex.lead.contact.wrong.field.type',
                    ],
                    $parameters
                );
            },
