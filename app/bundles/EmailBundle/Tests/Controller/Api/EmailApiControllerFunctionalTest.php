...
namespace Milex\EmailBundle\Tests\Controller\Api;
...
class EmailApiControllerFunctionalTest extends MilexMysqlTestCase
{
    ...
    {
        $mailHelper = self::$container->get('milex.helper.mailer');
    ...
    public function testReplyAction(): void
    {
        ...
        $statRepository = self::$container->get('milex.email.repository.stat');
