...
namespace Milex\EmailBundle\Tests\Swiftmailer\Momentum\Service;

use Milex\EmailBundle\Swiftmailer\Message\MilexMessage;
use Milex\EmailBundle\Swiftmailer\Momentum\Service\SwiftMessageService;
...
class SwiftMessageServiceTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testTransformToTransmission(MilexMessage $milexMessage, $expectedTransmissionJson)
    {
        $service         = new SwiftMessageService();
        $transmissionDTO = $service->transformToTransmission($milexMessage);
    ...
    {
        $milexMessage = new MilexMessage();

        $milexMessage->setSubject('Test subject')
