...
namespace Milex\EmailBundle\Tests\Swiftmailer\Momentum\Facade;

use Milex\EmailBundle\Swiftmailer\Momentum\Adapter\AdapterInterface;
...
use Milex\EmailBundle\Swiftmailer\Momentum\Exception\Facade\MomentumSendException;
use Milex\EmailBundle\Swiftmailer\Momentum\Exception\Validator\SwiftMessageValidator\SwiftMessageValidationException;
use Milex\EmailBundle\Swiftmailer\Momentum\Facade\MomentumFacade;
use Milex\EmailBundle\Swiftmailer\Momentum\Service\SwiftMessageServiceInterface;
use Milex\EmailBundle\Swiftmailer\Momentum\Validator\SwiftMessageValidator\SwiftMessageValidatorInterface;
use Monolog\Logger;
