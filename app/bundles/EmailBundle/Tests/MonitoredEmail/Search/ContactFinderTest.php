...
namespace Milex\EmailBundle\Tests\MonitoredEmail\Search;
...
class ContactFinderTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\ContactFinder::find()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\ContactFinder::findByAddress()
     ...
     *
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\ContactFinder::find()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\ContactFinder::findByHash()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Processor\Address::parseAddressForStatHash()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\Result::setStat()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\Result::getStat()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\Result::addContact()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Search\Result::getContacts()
     */
