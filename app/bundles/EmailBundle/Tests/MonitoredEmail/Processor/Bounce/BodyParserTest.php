...
namespace Milex\EmailBundle\Tests\MonitoredEmail\Processor\Bounce;

use Milex\EmailBundle\MonitoredEmail\Exception\BounceNotFound;
use Milex\EmailBundle\MonitoredEmail\Message;
use Milex\EmailBundle\MonitoredEmail\Processor\Bounce\BodyParser;
...
class BodyParserTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Milex\EmailBundle\MonitoredEmail\Processor\Bounce\BodyParser::getBounce()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Processor\Bounce\BodyParser::parse()
     */
