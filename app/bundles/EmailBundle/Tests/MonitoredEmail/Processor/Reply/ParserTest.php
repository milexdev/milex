...
namespace Milex\EmailBundle\Tests\MonitoredEmail\Processor\Reply;

use Milex\EmailBundle\MonitoredEmail\Exception\ReplyNotFound;
use Milex\EmailBundle\MonitoredEmail\Message;
use Milex\EmailBundle\MonitoredEmail\Processor\Reply\Parser;
use Milex\EmailBundle\MonitoredEmail\Processor\Reply\RepliedEmail;
...
class ParserTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Milex\EmailBundle\MonitoredEmail\Processor\Reply\Parser::parse()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Processor\Reply\RepliedEmail::getStatHash()
     */
