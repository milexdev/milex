...
use Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer;
...
class MailboxOrganizerTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::organize()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainer()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainers()
     */
     ...
     * @covers  \Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainer()
     * @covers  \Milex\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainers()
     * @covers  \Milex\EmailBundle\Event\ParseEmailEvent::setCriteriaRequest()
     * @covers  \Milex\EmailBundle\Event\ParseEmailEvent::getCriteriaRequests()
     */
     ...
     * @covers  \Milex\EmailBundle\Event\ParseEmailEvent::setCriteriaRequest()
     * @covers  \Milex\EmailBundle\Event\ParseEmailEvent::getCriteriaRequests()
     * @covers  \Milex\EmailBundle\Event\ParseEmailEvent::getMarkAsSeenInstructions()
     */
