...
class MailboxTest extends \PHPUnit\Framework\TestCase
{
    public function testConstructWithDefaultConfig()
    {
        ...
        $mailbox = new \Milex\EmailBundle\MonitoredEmail\Mailbox($parametersHelper, $pathsHelper);
    ...
    public function testUseAttachments()
    {
        ...
        new \Milex\EmailBundle\MonitoredEmail\Mailbox($parametersHelper, $pathsHelper);
