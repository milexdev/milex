...
class StatDevice
{
    ...
    /**
     * @var \Milex\LeadBundle\Entity\LeadDevice
     */
    private $device;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('email_stats_devices')
            ->setCustomRepositoryClass('Milex\EmailBundle\Entity\StatDeviceRepository')
            ->addIndex(['date_opened'], 'date_opened_search');

        $builder->addBigIntIdField();

        $builder->createManyToOne('device', 'Milex\LeadBundle\Entity\LeadDevice')
