...
namespace Milex\EmailBundle\Controller\Api;
...
class EmailApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Milex\EmailBundle\Entity\Email';
    ...
    public function replyAction($trackingHash)
    {
        ...
        $replyService = $this->get('milex.message.processor.replier');

        /** @var RandomHelperInterface $randomHelper */
        $randomHelper = $this->get('milex.helper.random');
