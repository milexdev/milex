...
class DetermineWinnerSubscriber implements EventSubscriberInterface
{
    ...
    public function onDetermineOpenRateWinner(DetermineWinnerEvent $event)
    {
        ...
        /** @var \Milex\EmailBundle\Entity\StatRepository $repo */
        ...
        if (null != $startDate && !empty($ids)) {
            ...
            if ($counts) {
                ...
                foreach ($counts as $id => $stats) {
                    ...
                    $data[$translator->trans('milex.email.abtest.label.opened')][] = $stats['readCount'];
                    $data[$translator->trans('milex.email.abtest.label.sent')][]   = $stats['totalCount'];
                    $hasResults[]                                                   = $id;
                }
                ...
                if (!in_array($parent->getId(), $hasResults)) {
                    ...
                    $data[$translator->trans('milex.email.abtest.label.opened')][] = 0;
                    $data[$translator->trans('milex.email.abtest.label.sent')][]   = 0;
                }
                ...
                $event->setAbTestResults([
                    ...
                    'supportTemplate' => 'MilexPageBundle:SubscribedEvents\AbTest:bargraph.html.php',
                ]);
    ...
    public function onDetermineClickthroughRateWinner(DetermineWinnerEvent $event)
    {
        ...
        /** @var \Milex\PageBundle\Entity\HitRepository $pageRepo */
        $pageRepo = $this->em->getRepository(Hit::class);
        /** @var \Milex\EmailBundle\Entity\StatRepository $emailRepo */
        ...
        if (null != $startDate && !empty($ids)) {
            ...
            if ($clickthroughCounts) {
                ...
                foreach ($clickthroughCounts as $id => $count) {
                    ...
                    $data[$translator->trans('milex.email.abtest.label.clickthrough')][]     = $count;
                    $data[$translator->trans('milex.email.abtest.label.opened')][]           = $sentCounts[$id];
                    $hasResults[]                                                             = $id;
                }
                ...
                if (!in_array($parent->getId(), $hasResults)) {
                    ...
                    $data[$translator->trans('milex.email.abtest.label.clickthrough')][] = 0;
                    $data[$translator->trans('milex.email.abtest.label.opened')][]       = 0;
                }
