...
use Milex\EmailBundle\Swiftmailer\Momentum\Callback\MomentumCallback;
use Milex\EmailBundle\Swiftmailer\Momentum\Facade\MomentumFacadeInterface;
...
class MomentumTransport implements \Swift_Transport, TokenTransportInterface, CallbackTransportInterface
{
    ...
    /**
     * Function required to check that $this->message is instanceof MilexMessage, return $this->message->getMetadata() if it is and array() if not.
     *
     * @throws \Exception
     */
