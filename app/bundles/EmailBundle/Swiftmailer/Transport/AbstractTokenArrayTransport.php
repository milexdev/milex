...
abstract class AbstractTokenArrayTransport implements TokenTransportInterface
{
     ...
     *
     * @param array      $search            If the mailer requires tokens in another format than Milex's, pass array of Milex tokens to replace
     * @param array      $replace           If the mailer requires tokens in another format than Milex's, pass array of replacement tokens
     ...
     * @deprecated 2.13.0 to be removed in 3.0; register transport as a service and pass dependencies
     */
    public function setMilexFactory(MilexFactory $factory)
    {
