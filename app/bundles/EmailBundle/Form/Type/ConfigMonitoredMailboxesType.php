...
class ConfigMonitoredMailboxesType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.config.monitored_email_address',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.config.monitored_email_host',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'tooltip'      => 'milex.email.config.monitored_email_host.tooltip',
                    'data-show-on' => $monitoredShowOn,
                ],
                'required' => false,
            ]
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.config.monitored_email_port',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'tooltip'      => 'milex.email.config.monitored_email_port.tooltip',
                    'data-show-on' => $monitoredShowOn,
                ],
                'required' => false,
            ...
            $builder->add(
                ...
                [
                    'choices'           => [
                        ...
                        'milex.email.config.monitored_email_encryption.ssl_novalidate' => '/ssl/novalidate-cert',
                        'milex.email.config.mailer_encryption.tls'                     => '/tls',
                        'milex.email.config.monitored_email_encryption.tls_novalidate' => '/tls/novalidate-cert',
                    ],
                    'label'    => 'milex.email.config.monitored_email_encryption',
                    'required' => false,
                    'attr'     => [
                        'class'        => 'form-control',
                        'data-show-on' => $monitoredShowOn,
                        'tooltip'      => 'milex.email.config.monitored_email_encryption.tooltip',
                    ],
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.config.monitored_email_user',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'tooltip'      => 'milex.email.config.monitored_email_user.tooltip',
                    'autocomplete' => 'off',
                    'data-show-on' => $monitoredShowOn,
                ],
                'required' => false,
        ...
        $builder->add(
            ...
            PasswordType::class,
            [
                'label'      => 'milex.email.config.monitored_email_password',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'placeholder'  => 'milex.user.user.form.passwordplaceholder',
                    'preaddon'     => 'fa fa-lock',
                    'tooltip'      => 'milex.email.config.monitored_email_password.tooltip',
                    'autocomplete' => 'off',
                    'data-show-on' => $monitoredShowOn,
                ],
                'required' => false,
        ...
        if ('general' != $options['mailbox']) {
            $builder->add(
                ...
                [
                    'label'      => 'milex.email.config.monitored_email_override_settings',
                    'label_attr' => ['class' => 'control-label'],
                    'data'       => (array_key_exists('override_settings', $options['data']) && !empty($options['data']['override_settings'])) ? true : false,
                    'attr'       => [
                        'class'   => 'form-control',
                        'tooltip' => 'milex.email.config.monitored_email_override_settings.tooltip',
                    ],
                    'required' => false,
                ]
            );
            ...
            $builder->add(
                ...
                [
                    'choices'           => $choices,
                    'label'             => 'milex.email.config.monitored_email_folder',
                    'label_attr'        => ['class' => 'control-label'],
                    'attr'              => array_merge(
                        [
                            'class'             => 'form-control',
                            'tooltip'           => 'milex.email.config.monitored_email_folder.tooltip',
        ...
        $builder->add(
            ...
            [
                'label'    => 'milex.email.config.monitored_email.test_connection',
                'required' => false,
                'attr'     => [
                    'class'   => 'btn btn-success',
                    'onclick' => 'Milex.testMonitoredEmailServerConnection(\''.$options['mailbox'].'\')',
                ],
            ]
        );
    }
