...
use Milex\CoreBundle\Form\Type\DynamicContentTrait;
...
use Milex\PageBundle\Form\Type\PreferenceCenterListType;
...
class EmailType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.form.internal.name',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.from_name',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'    => 'form-control',
                    'preaddon' => 'fa fa-user',
                    'tooltip'  => 'milex.email.from_name.tooltip',
                ],
                'required' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.from_email',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'    => 'form-control',
                    'preaddon' => 'fa fa-envelope',
                    'tooltip'  => 'milex.email.from_email.tooltip',
                ],
                'required' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.email.bcc',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'    => 'form-control',
                    'preaddon' => 'fa fa-envelope',
                    'tooltip'  => 'milex.email.bcc.tooltip',
                ],
                'required' => false,
            ]
        );
        ...
        $builder->add(
            ...
            [
                'label'      => 'milex.email.use.owner.as.mailer',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'milex.email.use.owner.as.mailer.tooltip',
                ],
        ...
        $builder->add(
            ...
            [
                ...
                'attr'            => [
                    'tooltip' => 'milex.email.custom_headers.tooltip',
                ],
        ...
        $builder->add(
            ...
            [
                ...
                'attr'    => [
                    ...
                    'tooltip' => 'milex.email.form.template.help',
                ],
                'data' => $template,
            ]
        );
        ...
        $builder->add(
            ...
            [
                ...
                'attr'       => [
                    'class'       => 'form-control',
                    'data-toggle' => 'datetime',
                    'tooltip'     => 'milex.email.form.publishdown.help',
                ],
                'format'   => 'yyyy-MM-dd HH:mm',
                'required' => false,
            ]
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'milex.email.form.plaintext',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'tooltip'              => 'milex.email.form.plaintext.help',
                    'class'                => 'form-control',
                    'rows'                 => '15',
        ...
        $builder->add(
            $builder->create(
                ...
                TextareaType::class,
                [
                    'label'      => 'milex.email.form.body',
                    'label_attr' => ['class' => 'control-label'],
                    'required'   => false,
                    'attr'       => [
                        'tooltip'              => 'milex.email.form.body.help',
        ...
        $transformer = new IdToEntityModelTransformer($this->em, 'MilexFormBundle:Form', 'id');
        $builder->add(
            $builder->create(
                'unsubscribeForm',
                FormListType::class,
                [
                    'label'      => 'milex.email.form.unsubscribeform',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'            => 'form-control',
                        'tooltip'          => 'milex.email.form.unsubscribeform.tooltip',
                        'data-placeholder' => $this->translator->trans('milex.core.form.chooseone'),
                    ],
                    'required'    => false,
                    'multiple'    => false,
                    'placeholder' => '',
        ...
        $builder->add(
            $builder->create(
                ...
                [
                    'label'      => 'milex.email.form.preference_center',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'            => 'form-control',
                        'tooltip'          => 'milex.email.form.preference_center.tooltip',
                        'data-placeholder' => $this->translator->trans('milex.core.form.chooseone'),
                    ],
                    'required'    => false,
                    'multiple'    => false,
        ...
        $transformer = new IdToEntityModelTransformer($this->em, 'MilexEmailBundle:Email');
        $builder->add(
            $builder->create(
                'variantParent',
                HiddenType::class
        ...
        $transformer = new IdToEntityModelTransformer($this->em, 'MilexLeadBundle:LeadList', 'id', true);
        $builder->add(
            $builder->create(
                'lists',
                LeadListType::class,
                [
                    'label'      => 'milex.email.form.list',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'        => 'form-control',
        ...
        $builder->add(
            $builder->create(
                ...
                AssetListType::class,
                [
                    'label'      => 'milex.email.attachments',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'    => 'form-control',
                        'onchange' => 'Milex.getTotalAttachmentSize();',
                        'tooltip'  => 'milex.email.attachments.help',
                    ],
                    'multiple' => true,
                    'expanded' => false,
                ]
                ...
                'pre_extra_buttons' => [
                    [
                        ...
                        'attr'  => [
                            ...
                            'icon'    => 'fa fa-cube',
                            'onclick' => "Milex.launchBuilder('{$this->getBlockPrefix()}', 'email');",
                        ],
                    ],
                ],
            ]
