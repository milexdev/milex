...
namespace Milex\CategoryBundle\Model;

use Milex\CategoryBundle\CategoryEvents;
use Milex\CategoryBundle\Entity\Category;
use Milex\CategoryBundle\Event\CategoryEvent;
use Milex\CategoryBundle\Form\Type\CategoryType;
...
class CategoryModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('MilexCategoryBundle:Category');
    }
