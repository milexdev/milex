...
$header = ($notification->getId()) ?
    $view['translator']->trans('milex.notification.mobile.header.edit',
        ['%name%' => $notification->getName()]) :
    $view['translator']->trans('milex.notification.mobile.header.new');

$view['slots']->set('headerTitle', $header);

/** @var \Milex\NotificationBundle\Integration\OneSignalIntegration $integration */
                ...
                <ul class="bg-auto nav nav-tabs pr-md pl-md">
                    ...
                    <li>
                        <a href="#data-notification-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.notification.tab.data'); ?>
                        </a>
                    </li>
                    <?php if (in_array('ios', $integrationSettings['platforms'])) : ?>
                        <li>
                            <a href="#ios-notification-container" role="tab" data-toggle="tab">
                                <?php echo $view['translator']->trans('milex.notification.tab.ios'); ?>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (in_array('android', $integrationSettings['platforms'])) : ?>
                        <li>
                            <a href="#android-notification-container" role="tab" data-toggle="tab">
                                <?php echo $view['translator']->trans('milex.notification.tab.android'); ?>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
