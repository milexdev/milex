                ...
                <div class="panel-body box-layout">
                    <div class="col-xs-4 va-m">
                        <h5 class="text-white dark-md fw-sb mb-xs">
                            ...
                            <?php echo $view['translator']->trans('milex.notification.stats'); ?>
                        </h5>
                    </div>
                    <div class="col-xs-6 va-m" id="legend"></div>
                    <div class="col-xs-2 va-m">
                        <?php echo $view->render('MilexCoreBundle:Helper:graph_dateselect.html.php', ['callback' => 'updateNotificationStatsChart']); ?>
