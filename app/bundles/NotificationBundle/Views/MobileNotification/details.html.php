...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $notification])
);
?>
        ...
        <div class="bg-auto bg-dark-xs">
            ...
            <div class="hr-expand nm">
                <span data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.core.details'); ?>">
                    <a href="javascript:void(0)" class="arrow text-muted collapsed" data-toggle="collapse" data-target="#notification-details"><span class="caret"></span> <?php echo $view['translator']->trans('milex.core.details'); ?></a>
                </span>
            </div>
            <!--/ notification detail collapseable toggler -->
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.core.stats'); ?>
                                    </h5>
                                </div>
