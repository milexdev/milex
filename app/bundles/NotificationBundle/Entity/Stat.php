...
class Stat
{
    ...
    /**
     * @var \Milex\LeadBundle\Entity\LeadList
     */
    private $list;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('push_notification_stats')
            ->setCustomRepositoryClass('Milex\NotificationBundle\Entity\StatRepository')
        ...
        $builder->createManyToOne('list', 'Milex\LeadBundle\Entity\LeadList')
    ...
    /**
     * @return \Milex\LeadBundle\Entity\LeadList
     */
