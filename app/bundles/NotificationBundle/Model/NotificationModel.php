...
namespace Milex\NotificationBundle\Model;
...
use Milex\NotificationBundle\Form\Type\MobileNotificationType;
use Milex\NotificationBundle\Form\Type\NotificationType;
...
class NotificationModel extends FormModel implements AjaxLookupModelInterface
{
     ...
     * {@inheritdoc}
     *
     * @return \Milex\NotificationBundle\Entity\NotificationRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexNotificationBundle:Notification');
    }

    /**
     * @return \Milex\NotificationBundle\Entity\StatRepository
     */
    public function getStatRepository()
    {
        return $this->em->getRepository('MilexNotificationBundle:Stat');
    }
    ...
    {
        $q->join('t', MILEX_TABLE_PREFIX.'push_notifications', 'p', 'p.id = t.notification_id')
    ...
    public function getHitsLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [], $canViewOthers = true)
    {
        ...
        if (!$flag || 'total_and_unique' === $flag) {
            ...
            $chart->setDataset($this->translator->trans('milex.notification.show.total.sent'), $data);
        }
