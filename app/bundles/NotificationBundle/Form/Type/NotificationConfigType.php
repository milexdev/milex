...
use Milex\EmailBundle\Validator\MultipleEmailsValid;
...
class NotificationConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            [
                'label' => 'milex.notification.form.config.send_notification_to_author',
                'attr'  => [
                    'class'    => 'form-control',
                    'tooltip'  => 'milex.notification.form.config.send_notification_to_author.tooltip',
                    'onchange' => 'Milex.resetEmailsToNotification(this)',
                ],
                'required' => true,
            ]
        );
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.notification.form.config.notification_email_addresses',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control notification_email_addresses',
                    'tooltip'      => 'milex.notification.form.config.notification_email_addresses.tooltip',
