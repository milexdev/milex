...
class NotificationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.notification.form.internal.name',
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'milex.notification.form.internal.description',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => ['class' => 'form-control'],
                'required'   => false,
            ]
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.notification.form.heading',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => ['class' => 'form-control'],
                'required'   => false,
            ]
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'milex.notification.form.message',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class' => 'form-control',
                    'rows'  => 6,
        ...
        $builder->add(
            ...
            UrlType::class,
            [
                'label'      => 'milex.notification.form.url',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'milex.notification.form.url.tooltip',
                ],
                'required' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.notification.form.button',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'milex.notification.form.button.tooltip',
                ],
                'required' => false,
            ]
        );
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            [
                'data_class' => 'Milex\NotificationBundle\Entity\Notification',
            ]
        );
