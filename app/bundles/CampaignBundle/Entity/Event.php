...
class Event implements ChannelInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('campaign_events')
            ->setCustomRepositoryClass('Milex\CampaignBundle\Entity\EventRepository')
     ...
     * Get campaign.
     *
     * @return \Milex\CampaignBundle\Entity\Campaign
     */
     ...
     * Add children.
     *
     * @param \Milex\CampaignBundle\Entity\Event $children
     *
     * @return Event
     */
     ...
     * Set parent.
     *
     * @param \Milex\CampaignBundle\Entity\Event $parent
     *
     * @return Event
     */
     ...
     * Get parent.
     *
     * @return \Milex\CampaignBundle\Entity\Event
     */
