...
class SummaryRepository extends CommonRepository
{
    ...
    public function getCampaignLogCounts(
        ...
        $q = $this->_em->getConnection()->createQueryBuilder()
            ...
            ->from(MILEX_TABLE_PREFIX.'campaign_summary', 'cs')
    ...
    public function summarize(
        ...
        $sql = 'INSERT INTO '.MILEX_TABLE_PREFIX.'campaign_summary '.
            ...
            '       (SELECT count(mclel2.lead_id) FROM '.MILEX_TABLE_PREFIX.'campaign_lead_event_log mclel2 '.
            '           INNER JOIN '.MILEX_TABLE_PREFIX.'campaign_leads mcl ON mcl.campaign_id = mclel2.campaign_id AND mcl.manually_removed = 0 '.
            ...
            '               NOT EXISTS(SELECT NULL FROM '.MILEX_TABLE_PREFIX.'campaign_lead_event_failed_log mclefl2 '.
            ...
            ' FROM '.MILEX_TABLE_PREFIX.'campaign_lead_event_log mclel LEFT JOIN '.MILEX_TABLE_PREFIX.'campaign_lead_event_failed_log mclefl ON mclefl.log_id = mclel.id '.
