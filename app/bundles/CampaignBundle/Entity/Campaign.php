...
use Milex\CoreBundle\Entity\PublishStatusIconAttributesInterface;
use Milex\FormBundle\Entity\Form;
use Milex\LeadBundle\Entity\Lead as Contact;
...
class Campaign extends FormEntity implements PublishStatusIconAttributesInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('campaigns')
            ->setCustomRepositoryClass('Milex\CampaignBundle\Entity\CampaignRepository');
        ...
        $builder->createManyToMany('lists', 'Milex\LeadBundle\Entity\LeadList')
        ...
        $builder->createManyToMany('forms', 'Milex\FormBundle\Entity\Form')
     ...
     *
     * @param                                     $key
     * @param \Milex\CampaignBundle\Entity\Event $event
     *
     * @return Campaign
     */
    ...
    {
        return 'Milex.confirmationCampaignPublishStatus(mQuery(this));';
    }
