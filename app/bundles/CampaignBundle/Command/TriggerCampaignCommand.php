...
use Milex\CampaignBundle\Event\CampaignTriggerEvent;
use Milex\CampaignBundle\Executioner\ContactFinder\Limiter\ContactLimiter;
use Milex\CampaignBundle\Executioner\InactiveExecutioner;
use Milex\CampaignBundle\Executioner\KickoffExecutioner;
use Milex\CampaignBundle\Executioner\ScheduledExecutioner;
...
class TriggerCampaignCommand extends ModeratedCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        defined('MILEX_CAMPAIGN_SYSTEM_TRIGGERED') or define('MILEX_CAMPAIGN_SYSTEM_TRIGGERED', 1);
