...
use Milex\CampaignBundle\Entity\LeadRepository as CampaignMemberRepository;
use Milex\CampaignBundle\Executioner\ContactFinder\Limiter\ContactLimiter;
use Milex\CampaignBundle\Membership\Exception\RunLimitReachedException;
...
class MembershipBuilder
{
    ...
    {
        defined('MILEX_REBUILDING_CAMPAIGNS') or define('MILEX_REBUILDING_CAMPAIGNS', 1);
