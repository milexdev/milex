...
use Milex\CampaignBundle\Entity\Summary;
use Milex\CampaignBundle\Entity\SummaryRepository;
use Milex\CampaignBundle\EventCollector\EventCollector;
use Milex\CampaignBundle\EventListener\CampaignActionJumpToEventSubscriber;
...
class CampaignController extends AbstractStandardFormController
{
            ...
            return $this->postActionRedirect(
                $this->getPostActionRedirectArguments(
                    [
                        ...
                        'contentTemplate' => 'MilexCampaignBundle:Campaign:index',
                        'passthroughVars' => [
    ...
    public function newAction()
    {
                ...
                if ($valid = $this->isFormValid($form)) {
                    if ($valid = $this->beforeEntitySave($campaign, $form, 'new')) {
                        ...
                        if (method_exists($this, 'viewAction')) {
                            ...
                            $template       = 'MilexCampaignBundle:Campaign:view';
                        } else {
                            $viewParameters = ['page' => $page];
                            $returnUrl      = $this->generateUrl('milex_campaign_index', $viewParameters);
                            $template       = 'MilexCampaignBundle:Campaign:index';
                        }
                    }
                }
        ...
        $delegateArgs = [
            ...
            'contentTemplate' => 'MilexCampaignBundle:Campaign:form.html.php',
            'passthroughVars' => [
                'milexContent' => 'campaign',
    ...
    {
        return 'MilexCampaignBundle:Campaign';
    }
