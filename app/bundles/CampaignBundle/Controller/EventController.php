...
class EventController extends CommonFormController
{
    ...
    public function newAction()
    {
        ...
        if ($cancelled || $valid) {
            ...
            $closeModal = false;
            $formThemes = ['MilexCampaignBundle:FormTheme\Event'];
            if (isset($event['settings']['formTheme'])) {
                $formThemes[] = $event['settings']['formTheme'];
            }

            $viewParams['form']             = $this->setFormTheme($form, 'MilexCampaignBundle:Campaign:index.html.php', $formThemes);
        ...
        if (!empty($keyId)) {
            ...
            $template = (empty($event['settings']['template'])) ? 'MilexCampaignBundle:Event:generic.html.php'
            ...
            if ('interval' == $event['triggerMode']) {
                ...
                /** @var \Milex\CoreBundle\Templating\Helper\DateHelper $dh */
        ...
        if ($closeModal) {
            ...
            return $this->ajaxAction(
                [
                    'contentTemplate' => 'MilexCampaignBundle:Event:form.html.php',
    ...
    public function editAction($objectId)
    {
        ...
        if (!$cancelled && !$valid) {
            ...
            $viewParams = array_merge($viewParams, [
                'form'             => $this->setFormTheme($form, 'MilexCampaignBundle:Campaign:index.html.php', $formThemes),
        ...
        if (!$cancelled && $valid) {
            ...
            $template = isset($event['settings']['template'])
                ? $event['settings']['template']
                : 'MilexCampaignBundle:Event:generic.html.php';
