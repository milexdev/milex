...
use Milex\CampaignBundle\Form\Type\CampaignLeadSourceType;
        ...
        if ($cancelled || $valid) {
            if ($valid) {
                $passthroughVars['sourceHtml'] = $this->renderView(
                    'MilexCampaignBundle:Source:index.html.php',
                    [
                        'sourceType' => $sourceType,
                        'campaignId' => $objectId,
            ...
            return $this->ajaxAction(
                [
                    'contentTemplate' => 'MilexCampaignBundle:Source:form.html.php',
