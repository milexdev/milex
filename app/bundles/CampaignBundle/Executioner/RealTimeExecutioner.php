...
use Milex\CampaignBundle\Executioner\Event\DecisionExecutioner as Executioner;
use Milex\CampaignBundle\Executioner\Exception\CampaignNotExecutableException;
use Milex\CampaignBundle\Executioner\Exception\DecisionNotApplicableException;
use Milex\CampaignBundle\Executioner\Helper\DecisionHelper;
use Milex\CampaignBundle\Executioner\Result\Responses;
...
class RealTimeExecutioner
{
    ...
    public function execute($type, $passthrough = null, $channel = null, $channelId = null)
    {
        ...
        defined('MILEX_CAMPAIGN_NOT_SYSTEM_TRIGGERED') or define('MILEX_CAMPAIGN_NOT_SYSTEM_TRIGGERED', 1);
