...
namespace Milex\CampaignBundle\Executioner\Logger;
...
use Milex\CampaignBundle\Model\SummaryModel;
...
class EventLogger
{
    ...
    public function buildLogEntry(Event $event, Lead $contact = null, $isInactiveEvent = false)
    {
        ...
        if (!defined('MILEX_CAMPAIGN_SYSTEM_TRIGGERED')) {
        ...
        $log->setSystemTriggered(defined('MILEX_CAMPAIGN_SYSTEM_TRIGGERED'));
