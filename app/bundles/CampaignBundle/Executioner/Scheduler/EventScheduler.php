...
namespace Milex\CampaignBundle\Executioner\Scheduler;
...
use Milex\CampaignBundle\Event\ScheduledBatchEvent;
use Milex\CampaignBundle\Event\ScheduledEvent;
...
use Milex\CampaignBundle\Executioner\Exception\IntervalNotConfiguredException;
...
use Milex\CampaignBundle\Executioner\Scheduler\Mode\DateTime;
use Milex\CampaignBundle\Executioner\Scheduler\Mode\Interval;
...
class EventScheduler
{
    ...
    /**
     * @deprecated since Milex 3. To be removed in Milex 4. Use rescheduleFailures instead.
     */
