...
namespace Milex\CampaignBundle\Tests\Functional\Entity;

use Milex\CampaignBundle\Entity\LeadEventLogRepository;
use Milex\CoreBundle\Test\MilexMysqlTestCase;
use PHPUnit\Framework\Assert;

class LeadEventLogRepositoryTest extends MilexMysqlTestCase
{
    public function testThatRemoveEventLogsMethodRemovesLogs(): void
    {
        ...
        $insertStatement = $connection->prepare('INSERT INTO `'.MILEX_TABLE_PREFIX.'campaign_lead_event_log` (`event_id`, `lead_id`, `rotation`, `is_scheduled`, `system_triggered`) VALUES (?, ?, ?, ?, ?);');
