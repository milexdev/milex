...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $campaign])
);

$campaignId = $campaign->getId();

$preview = trim($view->render('MilexCampaignBundle:Campaign:preview.html.php', [
...
$decisions  = trim($view->render('MilexCampaignBundle:Campaign:events.html.php', ['events' => $events['decision']]));
$actions    = trim($view->render('MilexCampaignBundle:Campaign:events.html.php', ['events' => $events['action']]));
$conditions = trim($view->render('MilexCampaignBundle:Campaign:events.html.php', ['events' => $events['condition']]));
