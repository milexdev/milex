...
namespace Milex\ConfigBundle\Tests\Form\Helper;

use Milex\ConfigBundle\Form\Helper\RestrictionHelper;
use Milex\ConfigBundle\Form\Type\ConfigType;
use Milex\ConfigBundle\Form\Type\EscapeTransformer;
...
use Milex\EmailBundle\EventListener\ProcessBounceSubscriber;
use Milex\EmailBundle\EventListener\ProcessUnsubscribeSubscriber;
use Milex\EmailBundle\Form\Type\ConfigMonitoredEmailType;
use Milex\EmailBundle\Form\Type\ConfigMonitoredMailboxesType;
use Milex\EmailBundle\Form\Type\ConfigType as EmailConfigType;
...
class RestrictionHelperTest extends TypeTestCase
{
     ...
     *
     * @covers \Milex\ConfigBundle\Form\Helper\RestrictionHelper::applyRestrictions()
     * @covers \Milex\ConfigBundle\Form\Helper\RestrictionHelper::restrictField()
     */
        ...
        return [
            ...
            new PreloadedExtension(
                [
                    ...
                    new FormButtonsType(),
                    new ButtonGroupType(),
                    new \Milex\EmailBundle\Form\Type\ConfigType($translator, $transportType),
