...
class AjaxController extends CommonAjaxController
{
    ...
    protected function reorderFieldsAction(Request $request, $bundle, $name = 'fields')
    {
        ...
        $sessionName = 'milex.form.'.$sessionId.'.'.$name.'.modified';
        $session     = $this->get('session');
        $orderName   = ('fields' == $name) ? 'milexform' : 'milexform_action';
    ...
    {
        $response     = $this->forwardWithPost('MilexFormBundle:Public:submit', $this->request->request->all(), [], ['ajax' => true]);
