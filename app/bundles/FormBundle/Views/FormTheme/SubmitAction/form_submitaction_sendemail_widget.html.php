...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <label class="control-label"><?php echo $view['translator']->trans('milex.form.action.sendemail.dragfield'); ?></label>
        <div id="formFieldTokens" class="list-group" style="max-height: 250px; overflow-y: auto;">
            <?php foreach ($formFields as $token => $field): ?>
            <a class="list-group-item ellipsis" href="#" onclick="Milex.insertTextInEditor(mQuery('#formaction_properties_message'), '<?php echo $token; ?>');"><?php echo $field; ?></a>
            <?php endforeach; ?>
        </div>
    </div>
</div>
