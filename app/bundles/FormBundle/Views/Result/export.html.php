...
<div class="formresults">
    <table class="table table-hover table-striped table-bordered formresult-list">
        ...
        <tr>
            ...
            <th class="col-formresult-date"><?php echo $view['translator']->trans('milex.form.result.thead.date'); ?></th>
            <th class="col-formresult-ip"><?php echo $view['translator']->trans('milex.core.ipaddress'); ?></th>
            <?php
