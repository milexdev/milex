...
$view['slots']->set(
    'publishStatus',
    $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $activeForm])
);
    ...
    <div class="col-md-9 bg-white height-auto">
                ...
                <div class="pr-md pl-md pb-md">
                    <div class="panel shd-none mb-0">
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%">
                                    <span class="fw-b"><?php echo $view['translator']->trans('milex.form.stats.submission_counts'); ?></span>
                                </td>
                                <td>
        ...
        <div class="bg-auto bg-dark-xs">
            ...
            <div class="hr-expand nm">
                <span data-toggle="tooltip"
                      title="<?php echo $view['translator']->trans('milex.form.details.detail'); ?>">
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-xs-6 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.form.graph.line.submissions'); ?>
                                    </h5>
                                </div>
                                <div class="col-xs-6 va-m">
                                    <?php echo $view->render(
            ...
            <ul class="nav nav-tabs pr-md pl-md">
                <?php if ($showActions): ?>
                    <li class="active">
                        <a href="#actions-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.form.tab.actions'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <li class="<?php if (!$showActions) {
                    ...
                    <a href="#fields-container" role="tab" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.form.tab.fields'); ?>
                    </a>
                </li>
            </ul>
            <!--/ tabs controls -->
        ...
        <div class="tab-content pa-md">
            <?php if ($showActions): ?>
                ...
                <div class="tab-pane active fade in bdr-w-0" id="actions-container">
                    <?php foreach ($activeFormActions as $group => $groupActions) : ?>
                        ...
                        <ul class="list-group">
                            <?php /** @var \Milex\FormBundle\Entity\Action $action */ ?>
            ...
            <div class="tab-pane fade<?php if (!$showActions) {
                ...
                <h5 class="fw-sb mb-xs"><?php echo $view['translator']->trans('milex.form.field'); ?></h5>
                <ul class="list-group mb-xs">
                    <?php /** @var \Milex\FormBundle\Entity\Field $field */
                    foreach ($activeFormFields as $field) : ?>
                    <?php if (!$field->getParent()): ?>
                    <li class="list-group-item bg-auto bg-light-xs mt-10">
                        <?php echo $view->render(
                            'MilexFormBundle:Form:details-fields-list.html.php',
                            ['field' => $field]
                        ); ?>
                    </li>
                    <?php endif; ?>
            ...
            <div class="panel bg-info bg-light-lg bdr-w-0 mb-0">
                <div class="panel-body">
                    <h5 class="fw-sb mb-sm"><?php echo $view['translator']->trans(
                            'milex.form.form.header.copy'
                        ); ?></h5>
                    <p class="mb-sm"><?php echo $view['translator']->trans('milex.form.form.help.landingpages'); ?></p>

                    <a href="#" class="btn btn-info" data-toggle="modal"
                       data-target="#modal-automatic-copy"><?php echo $view['translator']->trans(
                            'milex.form.form.header.automaticcopy'
                        ); ?></a>
                    <a href="#" class="btn btn-info" data-toggle="modal"
                       data-target="#modal-manual-copy"><?php echo $view['translator']->trans(
                            'milex.form.form.header.manualcopy'
                        ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo $view['translator']->trans('milex.form.form.help.automaticcopy'); ?></p>
                    <h3><?php echo $view['translator']->trans('milex.form.form.help.automaticcopy.js'); ?></h3>
                    ...
                    <h3 class="pt-lg"><?php echo $view['translator']->trans(
                            'milex.form.form.help.automaticcopy.iframe'
                        ); ?></h3>
                    ...
                    <i><?php echo $view['translator']->trans('milex.form.form.help.automaticcopy.iframe.note'); ?></i>
                </div>
    ...
    <div class="modal fade" id="modal-manual-copy">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="panel-body">
                    <p><?php echo $view['translator']->trans('milex.form.form.help.manualcopy'); ?></p>

                    <h4 class="mt-sm mb-sm"><?php echo $view['translator']->trans(
                            'milex.form.form.help.manualcopy.script'
                        ); ?></h4>
                    ...
                    <h4 class="mt-sm mb-sm"><?php echo $view['translator']->trans(
                            'milex.form.form.help.manualcopy.body'
                        ); ?></h4>
                    <textarea class="form-html form-control" readonly
