...
<?php if ($form->getDescription()) : ?>
	<dt><?php echo $view['translator']->trans('milex.core.description'); ?></dt>
    ...
    <?php endif; ?>
<?php endif; ?>
	<dt><?php echo $view['translator']->trans('milex.form.result.thead.referrer'); ?></dt>
...
&& [] != $results[$field->getAlias()]
			...
			<dd>
                ...
                <a href="<?php echo $view['router']->path('milex_form_file_download', ['submissionId' => $submission->getId(), 'field' => $field->getAlias()]); ?>">
