        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a<?php if ($generalTabError): echo ' class="text-danger" '; endif; ?> href="#general" aria-controls="general" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.general'); ?>
            ...
            <?php if ($showConditions): ?>
                <li role="presentation">
                    <a<?php if ($conditionsTabError): echo ' class="text-danger" '; endif; ?> href="#conditions" aria-controls="conditions" role="tab" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.form.field.form.condition'); ?>
            ...
            <li role="presentation">
                <a href="#leadfields" aria-controls="leadfields" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.leadfield'); ?>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li role="presentation">
                <a href="#required" aria-controls="required" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.validation'); ?>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li role="presentation">
                <a<?php if ($propertiesTabError): echo ' class="text-danger" '; endif; ?> href="#properties" aria-controls="properties" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.properties'); ?>
            ...
            <li role="presentation">
                <a href="#attributes" aria-controls="attributes" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.attributes'); ?>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li role="progressive-profiling">
                <a href="#progressive-profiling" aria-controls="progressive-profiling" role="tab" data-toggle="tab">
                    <?php echo $view['translator']->trans('milex.form.field.section.progressive.profiling'); ?>
                </a>
            </li>
            <?php endif; ?>
        </ul>
        ...
        <div class="tab-content pa-lg">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select id="formfield_leadField" name="formfield[leadField]" class="form-control" autocomplete="false" style="display: none;">
                            ...
                            ?>
                            <optgroup label="<?php echo $view['translator']->trans('milex.lead.'.$header); ?>">
                                <?php
            ...
            <?php if ($showConditions): ?>
                <div role="tabpanel" class="tab-pane" id="conditions">
                    <div class="row">
                        <div class="col-md-12">
                            <label data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="<?php echo $view['translator']->trans('milex.form.field.form.condition.show.only.tooltip'); ?>">
                                <?php echo $view['translator']->trans('milex.form.field.form.condition.show.only'); ?>
