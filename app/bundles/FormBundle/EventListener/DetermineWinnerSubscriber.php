    ...
    public function onDetermineSubmissionWinner(DetermineWinnerEvent $event)
    {
        ...
        if (null != $startDate && !empty($ids)) {
            ...
            if ($counts) {
                ...
                $submissionLabel = $this->translator->trans('milex.form.abtest.label.submissions');
                $hitLabel        = ('page' == $type) ? $this->translator->trans('milex.form.abtest.label.hits') : $this->translator->trans('milex.form.abtest.label.sentemils');
