...
use Milex\UserBundle\Entity\RoleRepository;
...
final class SubmissionFunctionalTest extends MilexMysqlTestCase
{
    ...
    public function testRequiredConditionalFieldIfNotEmpty(): void
    {
        ...
        $formCrawler = $crawler->filter('form[id=milexform_submissiontestform]');
        $this->assertSame(1, $formCrawler->count());
        $form = $formCrawler->form();
        $form->setValues([
            'milexform[country]' => 'Australia',
            'milexform[state]'   => 'Victoria',
        ]);
    ...
    public function testProgressiveFormsWithMaximumFieldsDisplayedAtTime(): void
    {
        ...
        $this->assertSame(1, $formCrawler->filter('.milexform-text')->count());
    }
    ...
    public function testAddContactToCampaignByForm(): void
    {
        ...
        $campaignModel = $this->getContainer()->get('milex.campaign.model.campaign');
