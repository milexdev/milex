...
use Milex\CoreBundle\Form\ToBcBccFieldsTrait;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $data = (isset($options['data']['subject']))
            ...
            : $this->translator->trans(
                'milex.form.action.sendemail.subject.default'
            );
        $builder->add(
            'subject',
            TextType::class,
            [
                'label'      => 'milex.form.action.sendemail.subject',
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'milex.form.action.sendemail.message',
                'label_attr' => ['class' => 'control-label'],
        ...
        if ('file' == $this->coreParametersHelper->get('mailer_spool_type')) {
            ...
            $builder->add(
                ...
                [
                    'label' => 'milex.form.action.sendemail.immediately',
                    'data'  => $default,
                    'attr'  => [
                        'tooltip' => 'milex.form.action.sendemail.immediately.desc',
                    ],
                ]
            );
        } else {
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.form.action.sendemail.copytolead',
                'data'  => $default,
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.form.action.sendemail.setreplyto',
                'data'  => $default,
                'attr'  => [
                    'tooltip' => 'milex.form.action.sendemail.setreplyto_tooltip',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.form.action.sendemail.emailtoowner',
                'data'  => $default,
            ]
        );
        ...
        $builder->add(
            ...
            EmailListType::class,
            [
                'label'      => 'milex.lead.email.template',
                'label_attr' => ['class' => 'control-label'],
                'required'   => false,
                'attr'       => [
                    'class'    => 'form-control',
                    'onchange' => 'Milex.getLeadEmailContent(this)',
                ],
                'multiple'   => false,
            ]
        );
