...
use Milex\FormBundle\Event\FormFieldEvent;
...
class FieldModel extends CommonFormModel
{
    ...
    public function createForm($entity, $formFactory, $action = null, $options = [])
    {
        ...
        $usedLeadFields   = $this->session->get('milex.form.'.$entity['formId'].'.fields.leadfields', []);
     ...
     * {@inheritdoc}
     *
     * @return \Milex\FormBundle\Entity\FieldRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexFormBundle:Field');
    }
    ...
    {
        $fields = $this->session->get('milex.form.'.$formId.'.fields.modified', []);
        $remove = $this->session->get('milex.form.'.$formId.'.fields.deleted', []);
