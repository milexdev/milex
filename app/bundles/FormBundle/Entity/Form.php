...
class Form extends FormEntity
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('forms')
            ->setCustomRepositoryClass('Milex\FormBundle\Entity\FormRepository');
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('postActionProperty', new Assert\NotBlank([
            'message' => 'milex.form.form.postactionproperty_message.notblank',
            'groups'  => ['messageRequired'],
        ]));

        $metadata->addPropertyConstraint('postActionProperty', new Assert\NotBlank([
            'message' => 'milex.form.form.postactionproperty_redirect.notblank',
            'groups'  => ['urlRequired'],
        ]));
        ...
        $metadata->addPropertyConstraint('progressiveProfilingLimit', new Assert\GreaterThan([
            'value'   => 0,
            'message' => 'milex.form.form.progressive_profiling_limit.error',
