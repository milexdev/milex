...
class Submission
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('form_submissions')
            ->setCustomRepositoryClass('Milex\FormBundle\Entity\SubmissionRepository')
        ...
        $builder->createManyToOne('page', 'Milex\PageBundle\Entity\Page')
     ...
     * Set ipAddress.
     *
     * @param \Milex\CoreBundle\Entity\IpAddress $ipAddress
     *
     * @return Submission
     */
     ...
     * Set page.
     *
     * @param \Milex\PageBundle\Entity\Page $page
     *
     * @return Submission
     */
     ...
     * Get page.
     *
     * @return \Milex\PageBundle\Entity\Page
     */
