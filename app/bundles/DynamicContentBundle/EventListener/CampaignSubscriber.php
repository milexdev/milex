...
use Milex\DynamicContentBundle\Form\Type\DynamicContentDecisionType;
use Milex\DynamicContentBundle\Form\Type\DynamicContentSendType;
...
class CampaignSubscriber implements EventSubscriberInterface
{
    ...
    public function onCampaignBuild(CampaignBuilderEvent $event)
    {
        $event->addAction(
            'dwc.push_content',
            [
                'label'                  => 'milex.dynamicContent.campaign.send_dwc',
                'description'            => 'milex.dynamicContent.campaign.send_dwc.tooltip',
                ...
                'formTheme'              => 'MilexDynamicContentBundle:FormTheme\DynamicContentPushList',
                'timelineTemplate'       => 'MilexDynamicContentBundle:SubscribedEvents\Timeline:index.html.php',
        ...
        $event->addDecision(
            'dwc.decision',
            [
                'label'           => 'milex.dynamicContent.campaign.decision_dwc',
                'description'     => 'milex.dynamicContent.campaign.decision_dwc.tooltip',
                'eventName'       => DynamicContentEvents::ON_CAMPAIGN_TRIGGER_DECISION,
                'formType'        => DynamicContentDecisionType::class,
                'formTypeOptions' => ['update_select' => 'campaignevent_properties_dynamicContent'],
                'formTheme'       => 'MilexDynamicContentBundle:FormTheme\DynamicContentDecisionList',
                'channel'         => 'dynamicContent',
