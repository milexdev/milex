...
/** @var \Milex\DynamicContentBundle\Entity\DynamicContent $entity */
if (!$isEmbedded) {
...
$translationContent = $view->render(
    ...
    [
        ...
        'actionRoute'  => 'milex_dynamicContent_action',
    ]
);
...
if (!$isEmbedded) {
    ...
    $view['slots']->set(
        'publishStatus',
        $view->render('MilexCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $entity])
    );
}
?>
                ...
                <div class="box-layout">
                    <div class="col-xs-10">
                        ...
                        <?php if ($entity->isVariant(true)): ?>
                            <div class="small">
                                <a href="<?php echo $view['router']->path('milex_dynamicContent_action', ['objectAction' => 'view', 'objectId' => $variants['parent']->getId()]); ?>" data-toggle="ajax">
                        ...
                        <?php if ($entity->isTranslation(true)): ?>
                            <div class="small">
                                <a href="<?php echo $view['router']->path('milex_dynamicContent_action', ['objectAction' => 'view', 'objectId' => $translations['parent']->getId()]); ?>" data-toggle="ajax">
                        ...
                        <?php if (!$entity->getIsCampaignBased()): ?>
                            <div class="small">
                                <?php echo $view['translator']->trans('milex.dynamicContent.header.is_filter_based', ['%slot%' => $entity->getSlotName()]); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle">
                                    <?php echo $view['translator']->trans('milex.dynamicContent.slot.campaign'); ?>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle">
                                    <?php echo $view['translator']->trans('milex.dynamicContent.label.slot_name'); ?>
                                </td>
                                <td>
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.dynamicContent.views'); ?>
                                    </h5>
                                </div>
                                <div class="col-md-9 va-m">
                                    <?php echo $view->render('MilexCoreBundle:Helper:graph_dateselect.html.php', ['dateRangeForm' => $dateRangeForm, 'class' => 'pull-right']); ?>
                                </div>
                            </div>
                            <div class="pt-0 pl-15 pb-10 pr-15">
                                <?php echo $view->render('MilexCoreBundle:Helper:chart.html.php', ['chartData' => $entityViews, 'chartType' => 'line', 'chartHeight' => 300]); ?>
                            </div>
                        </div>
                    </div>
                </div>
