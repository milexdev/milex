...
use Milex\CoreBundle\Entity\FiltersEntityTrait;
...
class DynamicContent extends FormEntity implements VariantEntityInterface, TranslationEntityInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('dynamic_content')
            ...
            ->setCustomRepositoryClass('Milex\DynamicContentBundle\Entity\DynamicContentRepository')
    ...
    {
        $metadata->addPropertyConstraint('name', new NotBlank(['message' => 'milex.core.name.required']));
                ...
                if (!$dwc->getIsCampaignBased()) {
                    ...
                    $violations = $validator->validate(
                        ...
                        [
                            new NotBlank(
                                [
                                    'message' => 'milex.dynamicContent.slot_name.notblank',
                                ]
                            ),
                        ]
                    );
                    ...
                    $violations = $validator->validate(
                        ...
                        [
                            new Count(
                                [
                                    'minMessage' => 'milex.dynamicContent.filter.options.empty',
                                    'min'        => 1,
                                ]
                            ),
                        ]
    ...
    /**
     * @return \Milex\CategoryBundle\Entity\Category
     */
    ...
    /**
     * @param \Milex\CategoryBundle\Entity\Category $category
     *
     * @return $this
     */
