...
namespace Milex\DynamicContentBundle\Tests\Form\Type;

use DeviceDetector\Parser\Device\AbstractDeviceParser as DeviceParser;
use DeviceDetector\Parser\OperatingSystem;
use Doctrine\ORM\EntityManager;
use Milex\DynamicContentBundle\Entity\DynamicContent;
use Milex\DynamicContentBundle\Form\Type\DynamicContentListType;
        ...
        $formBuilderInterfaceMock->expects($this->exactly(3))
            ...
            ->withConsecutive(
                ...
                [
                    ...
                    [
                        'entry_type'     => 'Milex\DynamicContentBundle\Form\Type\DwcEntryFiltersType',
                        'entry_options'  => [
