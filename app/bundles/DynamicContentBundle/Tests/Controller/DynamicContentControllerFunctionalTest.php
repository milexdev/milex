...
namespace Milex\DynamicContentBundle\Tests\Controller;
...
class DynamicContentControllerFunctionalTest extends MilexMysqlTestCase
{
    ...
    private function createAndLoginUser(string $permission = null): User
    {
        ...
        $this->client->setServerParameter('PHP_AUTH_PW', 'milex');
    ...
    private function createUser(Role $role): User
    {
        ...
        $user->setPassword($encoder->encodePassword('milex', null));
        $user->setRole($role);
