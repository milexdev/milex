...
namespace Milex\SmsBundle\Tests\Sms;

use Exception;
use Milex\CoreBundle\Test\MilexMysqlTestCase;
use Milex\LeadBundle\Entity\Lead;
use Milex\SmsBundle\Integration\Twilio\TwilioTransport;
use Milex\SmsBundle\Sms\TransportChain;
use Milex\SmsBundle\Sms\TransportInterface;
use PHPUnit\Framework\MockObject\MockObject;
use ReflectionClass;

class TransportChainTest extends MilexMysqlTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->transportChain = new TransportChain(
            'milex.test.twilio.mock',
            self::$container->get('milex.helper.integration')
        );
    ...
    public function testAddTransport()
    {
        ...
        $this->transportChain->addTransport('milex.transport.test', self::$container->get('milex.sms.twilio.transport'), 'milex.transport.test', 'Twilio');
    ...
    public function testSendSms()
    {
        ...
        $this->transportChain->addTransport('milex.test.twilio.mock', $this->twilioTransport, 'milex.test.twilio.mock', 'Twilio');
