...
use Milex\QueueBundle\Event\QueueEvent;
use Milex\QueueBundle\Helper\QueueRequestHelper;
...
class QueueService
{
    ...
    public function publishToQueue($queueName, array $payload = [])
    {
        ...
        $payload['milexQueueName'] = $queueName;
    ...
    public function dispatchConsumerEventFromPayload($payload)
    {
        ...
        $queueName = $payload['milexQueueName'];
        unset($payload['milexQueueName']);
        $eventName = "milex.queue_{$queueName}";
