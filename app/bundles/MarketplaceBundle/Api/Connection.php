...
namespace Milex\MarketplaceBundle\Api;
...
class Connection
{
    ...
    {
        return $this->makeRequest("https://packagist.org/search.json?page={$page}&per_page={$limit}&type=milex-plugin&q={$query}");
    }
