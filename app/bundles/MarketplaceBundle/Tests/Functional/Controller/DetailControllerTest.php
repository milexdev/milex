...
final class DetailControllerTest extends MilexMysqlTestCase
{
    /**
    ...
    public function dataProvider(): iterable
    {
        ...
        yield [
            ...
            'milex/unicorn',
            'Package \'milex/unicorn\' not found in allowlist.',
        ];

        // Package that exists in the allowlist with display name.
        yield [
            'koco/milex-recaptcha-bundle',
            SymfonyResponse::HTTP_OK,
            'KocoCaptcha',
            'This plugin brings reCAPTCHA integration to milex.',
            '<a href="https://github.com/KonstantinCodes/milex-recaptcha/releases/tag/3.0.1" id="latest-version" target="_blank" rel="noopener noreferrer">',
        ];
    }
}
