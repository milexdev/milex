...
{
    public const NAME = 'milex:marketplace:install';
    ...
    protected function configure(): void
    {
        ...
        $this->addArgument('package', InputArgument::REQUIRED, 'The Packagist package to install (e.g. milex/example-plugin)');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($package->packageBase->type) || 'milex-plugin' !== $package->packageBase->type) {
            throw new Exception('Package type is not milex-plugin. Cannot install this plugin.');
        }
