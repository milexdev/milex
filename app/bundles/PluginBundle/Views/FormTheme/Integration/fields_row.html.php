...
<div class="row fields-container" id="<?php echo $containerId; ?>">
    ...
    <div class="<?php echo $object; ?>-field form-group col-xs-12">
        <div class="row">
            ...
            <div class="mb-xs col-sm-<?php echo $class; ?> text-center"><h4><?php echo $view['translator']->trans('milex.plugins.integration.fields'); ?></h4></div>
            <?php if (5 == $numberOfFields): ?>
                <div class="col-sm-2"></div>
            <?php endif; ?>
            <div class="mb-xs col-sm-<?php echo $class; ?> text-center"><h4><?php echo $view['translator']->trans('milex.plugins.milex.fields'); ?></h4></div>
        </div>
        <?php foreach ($form->children as $child):
            ...
            <?php endif; ?>
            <?php if (strstr($child->vars['name'], 'update_milex')): ?>
            <div class="pr-xs <?php echo $class; ?>" style="padding-left: 8px;" data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.plugin.direction.data.update'); ?>">
                <div class="row">
                            ...
                            <div class="btn-group btn-block" data-toggle="buttons" <?php if ($child->vars['attr']['forceDirection']) : echo 'data-force-direction="1"'; endif; ?>>
                                ...
                                <label class="btn-arrow<?php echo $indexCount; ?> btn btn-default<?php if ($checked): echo ' active'; endif; ?> <?php if ($child->vars['attr']['disabled']) : echo 'disabled'; endif; ?>">
                                    <input type="radio"
                                           ...
                                           autocomplete="false"
                                           value="0"
                                           onchange="Milex.matchedFields(<?php echo $indexCount; ?>, '<?php echo $object; ?>', '<?php echo $integration; ?>')"
            ...
            <div class="pl-xs pr-xs <?php echo $class; ?>">
                ...
                <select id="<?php echo $child->vars['id']; ?>"
                        ...
                        class="<?php echo $child->vars['attr']['class']; ?>"
                        data-placeholder=" "
                        autocomplete="false" onchange="Milex.matchedFields(<?php echo $indexCount; ?>, '<?php echo $object; ?>', '<?php echo $integration; ?>')">
                    <option value=""></option>
                    <?php
                    $milexChoices = $child->vars['attr']['data-choices'];
                    foreach ($milexChoices as $keyLabel => $options): ?>
    ...
    <div class="panel-footer">
        ...
        <?php echo $view->render(
            ...
            [
                ...
                'jsCallback'  => 'Milex.getIntegrationFields',
                'jsArguments' => [
                    [
                        'object'      => $object,
