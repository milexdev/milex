    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
                ...
                $builder->add(
                    ...
                    [
                        'attr'     => [
                            ...
                            'onclick' => 'Milex.initiateIntegrationAuthorization()',
                            'icon'    => 'fa fa-key',
                        ],
                        'label'    => 'milex.integration.form.'.$label,
                        'disabled' => $disabled,
                    ]
                );
            }
        ...
        if (!empty($features)) {
            ...
            foreach ($features as $f) {
                $choices['milex.integration.form.feature.'.$f] = $f;
            }
            ...
            $builder->add(
                ...
                [
                    ...
                    'multiple'    => true,
                    'label'       => 'milex.integration.form.features',
                    'required'    => false,
                    'data'        => $data,
        ...
        $builder->add(
            ...
            [
                'label'              => 'milex.integration.form.feature.settings',
                'required'           => true,
