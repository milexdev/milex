...
namespace Milex\PluginBundle\Tests\Entity;
 ...
 */
class IntegrationEntityRepositoryTest extends MilexMysqlTestCase
{
    /**
     * @var string
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->integrationEntityRepository = $this->em->getRepository('MilexPluginBundle:IntegrationEntity');
    }
