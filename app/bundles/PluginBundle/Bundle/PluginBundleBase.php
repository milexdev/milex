...
namespace Milex\PluginBundle\Bundle;
...
abstract class PluginBundleBase extends Bundle
{
     ...
     * @throws \Exception
     */
    public static function installPluginSchema(array $metadata, MilexFactory $factory, $installedSchema = null)
    {
     ...
     * @throws \Exception
     */
    public static function updatePluginSchema(array $metadata, Schema $installedSchema, MilexFactory $factory)
    {
        $db         = $factory->getDatabase();
        $schemaTool = new SchemaTool($factory->getEntityManager());
     ...
     * @param null $metadata
     */
    public static function onPluginUninstall(Plugin $plugin, MilexFactory $factory, $metadata = null)
    {
    }
     ...
     * @throws \Exception
     */
    public static function dropPluginSchema(array $metadata, MilexFactory $factory)
    {
        $db          = $factory->getDatabase();
        $schemaTool  = new SchemaTool($factory->getEntityManager());
