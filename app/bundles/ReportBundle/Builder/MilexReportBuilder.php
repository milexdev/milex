...
namespace Milex\ReportBundle\Builder;
...
final class MilexReportBuilder implements ReportBuilderInterface
{
    /**
     * @var array
     */
    const OPERATORS = [
        'default' => [
            ...
            'gt'         => 'milex.core.operator.greaterthan',
            'gte'        => 'milex.core.operator.greaterthanequals',
            'lt'         => 'milex.core.operator.lessthan',
            'lte'        => 'milex.core.operator.lessthanequals',
            'neq'        => 'milex.core.operator.notequals',
            'like'       => 'milex.core.operator.islike',
            'notLike'    => 'milex.core.operator.isnotlike',
            'empty'      => 'milex.core.operator.isempty',
            'notEmpty'   => 'milex.core.operator.isnotempty',
            'contains'   => 'milex.core.operator.contains',
            'startsWith' => 'milex.core.operator.starts.with',
            'endsWith'   => 'milex.core.operator.ends.with',
        ],
        'bool' => [
            'eq'  => 'milex.core.operator.equals',
            'neq' => 'milex.core.operator.notequals',
        ...
        'multiselect' => [
            'in'    => 'milex.core.operator.in',
            'notIn' => 'milex.core.operator.notin',
        ],
        'select' => [
            'eq'  => 'milex.core.operator.equals',
            'neq' => 'milex.core.operator.notequals',
