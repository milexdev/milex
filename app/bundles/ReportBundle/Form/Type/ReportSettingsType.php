...
class ReportSettingsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            [
                'label' => 'milex.report.report.form.display.graphs.above.table',
                'attr'  => [
                    'class' => 'filter-value',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.report.report.form.display.show.dynamic.filters',
                'attr'  => [
                    'class' => 'filter-value',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'milex.report.report.form.display.hide.date.ranges',
                'attr'  => [
                    'class' => 'filter-value',
                ],
