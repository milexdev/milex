...
class ReportType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!($options['attr']['readonly'] ?? false)) {
            ...
            $builder->add(
                ...
                [
                    'label' => 'milex.report.report.form.issystem',
                    'data'  => $data,
                    'attr'  => [
                        'tooltip' => 'milex.report.report.form.issystem.tooltip',
                    ],
                ]
            );
            ...
            $builder->add(
                ...
                UserListType::class,
                [
                    'label'      => 'milex.report.report.form.owner',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class' => 'form-control',
                    ],
            ...
            $builder->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'milex.report.report.form.source',
                    'label_attr'        => ['class' => 'control-label'],
                    'placeholder'       => false,
                    'required'          => false,
                    'attr'              => [
                        'class'    => 'form-control',
                        'tooltip'  => 'milex.report.report.form.source.help',
                        'onchange' => 'Milex.updateReportSourceData(this.value)',
                    ],
                ]
            );
            ...
            $formModifier = function (FormInterface $form, $source, $currentColumns, $currentGraphs, $formData) use ($tables) {
                ...
                $form->add(
                    ...
                    [
                        ...
                        'attr'              => [
                            'class'         => 'form-control multiselect',
                            'data-sortable' => 'true',
                            'onchange'      => 'Milex.checkSelectedGroupBy()',
                        ],
                    ]
                );
                ...
                $form->add(
                    ...
                    [
                        ...
                        'data'    => 1,
                        'choices' => [
                            'milex.core.form.no'      => 0,
                            'milex.core.form.yes'     => 1,
                            'milex.core.filter.clear' => 2,
                        ],
                        ]
                );
                ...
                $form->add(
                    ...
                    [
                        ...
                        'label'             => 'milex.report.report.form.graphs',
                        'label_attr'        => ['class' => 'control-label'],
                        'required'          => false,
                        'multiple'          => true,
                        'expanded'          => false,
            ...
            $builder->add(
                ...
                YesNoButtonGroupType::class,
                [
                    'label'      => 'milex.report.schedule.isScheduled',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => [
                        'class'                => 'form-control',
            ...
            $builder->add(
                ...
                TextType::class,
                [
                    'label'      => 'milex.report.schedule.toAddress.label',
                    'label_attr' => ['class' => 'control-label'],
                    'required'   => false,
                    'attr'       => [
                        'class'    => 'form-control',
                        'preaddon' => 'fa fa-envelope',
                        'tooltip'  => 'milex.report.schedule.toAddress.tooltip',
                    ],
                ]
            );
            ...
            $builder->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'milex.report.schedule.every',
                    'label_attr'        => ['class' => 'control-label'],
                    'placeholder'       => false,
                    'required'          => false,
                    'attr'              => [
            ...
            $builder->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'milex.report.schedule.day',
                    'label_attr'        => ['class' => 'control-label'],
                    'placeholder'       => false,
                    'required'          => false,
                    'attr'              => [
            ...
            $builder->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'milex.report.schedule.month_frequency',
                    'label_attr'        => ['class' => 'control-label'],
                    'placeholder'       => false,
                    'required'          => false,
                    'attr'              => [
    ...
    private function buildTableSourceList($tables)
    {
        ...
        foreach ($temp as $table) {
            $list['milex.report.group.'.$tables[$table]['group']][$tables[$table]['display_name']] = $table;
        }
