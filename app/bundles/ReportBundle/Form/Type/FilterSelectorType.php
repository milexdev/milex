    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formModifier = function (FormInterface $form, $column) use ($options) {
            ...
            $form->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'milex.report.report.label.filtercondition',
        ...
        $builder->add(
            ...
            [
                ...
                'required'          => false,
                'choices'           => [
                    'milex.report.report.glue.choice.and' => 'and',
                    'milex.report.report.glue.choice.or'  => 'or',
                ],
                'placeholder' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.report.report.label.filtervalue',
                'label_attr' => ['class' => 'control-label'],
        ...
        $builder->add(
            ...
            [
                'label'      => 'milex.report.report.label.filterdynamic',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'milex.report.report.label.filterdynamic_tooltip',
                ],
                'required' => false,
            ]
        );
