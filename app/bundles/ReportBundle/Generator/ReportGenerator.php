...
namespace Milex\ReportBundle\Generator;
...
class ReportGenerator
{
    ...
    /**
     * @var \Milex\ReportBundle\Entity\Report
     */
    private $entity;
     ...
     * @var string
     */
    private $validInterface = 'Milex\\ReportBundle\\Builder\\ReportBuilderInterface';
     ...
     * Gets report builder.
     *
     * @return \Milex\ReportBundle\Builder\ReportBuilderInterface
     *
     * @throws \Symfony\Component\DependencyInjection\Exception\RuntimeException
     */
    protected function getBuilder()
    {
        $className = '\\Milex\\ReportBundle\\Builder\\MilexReportBuilder';

        if (!class_exists($className)) {
            throw new RuntimeException('The MilexReportBuilder does not exist.');
        }
