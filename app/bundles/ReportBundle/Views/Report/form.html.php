...
$header = ($report->getId()) ?
    $view['translator']->trans(
        'milex.report.report.header.edit',
        ['%name%' => $view['translator']->trans($report->getName())]
    ) :
    $view['translator']->trans('milex.report.report.header.new');
                    ...
                    <ul class="bg-auto nav nav-tabs pr-md pl-md">
                        <li class="active">
                            <a href="#details-container" role="tab"
                               data-toggle="tab"><?php echo $view['translator']->trans('milex.core.details'); ?></a>
                        </li>
                        <li class="">
                            <a href="#data-container" role="tab"
                               data-toggle="tab"><?php echo $view['translator']->trans('milex.report.tab.data'); ?></a>
                        </li>
                        <li class="<?php if (!$showGraphTab): echo 'hide'; endif; ?>" id="graphs-tab">
                            <a href="#graphs-container" role="tab"
                               data-toggle="tab"><?php echo $view['translator']->trans(
                                    'milex.report.tab.graphs'
                                ); ?></a>
                        </li>
                        <li>
                            <a href="#schedule-container" role="tab" <?php echo $scheduleTabErrorClass; ?>
                               data-toggle="tab"><?php echo $view['translator']->trans('milex.report.tab.schedule'); ?></a>
                        </li>
                    </ul>
                    <!--/ tabs controls -->
                                ...
                                <div class="col-md-6">
                                    <div class="pa-md">
                                        <h4><strong><?php echo $view['translator']->trans(
                                                    'milex.report.report.form.columnselector'
                                                ); ?></strong></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="schedule_form well well-sm mt-lg">
                                        <span id="schedule_preview_url" data-url="<?php echo $view['router']->path('milex_report_schedule_preview'); ?>"></span>
                                        <div id="schedule_preview_data">
                                            <strong><?php echo $view['translator']->trans('milex.report.schedule.preview_data'); ?></strong>
        ...
        <div class="col-md-3 bg-white height-auto bdr-l">
            <div class="pr-lg pl-lg pt-md pb-md">
                ...
                <h5><?php echo $view['translator']->trans(
                        'milex.report.report.form.display.dynamic.filters.settings'
                    ); ?></h5>
                <br>
