 ...
 */
if ('index' == $tmpl) {
    $view->extend('MilexReportBundle:Report:details.html.php');
}
...
$graphContent = $view->render(
    'MilexReportBundle:Report:details_data_graphs.html.php',
    [
            ...
            <div class="page-list">
                <div class="table-responsive table-responsive-force">
                    <table class="table table-hover table-striped table-bordered report-list" id="reportTable">
                        ...
                        <?php endif; ?>
                        <tr class="cm-strong">
                            <td><?php echo $view['translator']->trans('milex.report.report.groupby.totals'); ?></td>
                            <?php
                            $index = 0;
                ...
                <div class="panel-footer">
                    <?php echo $view->render('MilexCoreBundle:Helper:pagination.html.php', [
                        ...
                        'page'       => $reportPage,
                        'limit'      => $limit,
                        'baseUrl'    => $view['router']->path('milex_report_view', [
