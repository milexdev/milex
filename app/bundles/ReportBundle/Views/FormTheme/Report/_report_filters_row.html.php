...
<div id="filterSelectorContainer" class="row">
    ...
    <div class="col-xs-12">
        <button type="button" class="btn btn-primary" onclick="Milex.addReportRow('report_filters');"><?php echo $view['translator']->trans('milex.report.report.label.addfilter'); ?></button>
    </div>
</div>
