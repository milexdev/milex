    ...
    <div class="panel-body">
        <div class="row mb-sm">
            ...
            <div class="col-xs-1 mt-lg">
                <button type="button" class="btn btn-danger" onclick="Milex.removeReportRow('<?php echo $form->vars['id']; ?>_container');" data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.report.report.label.removefilter'); ?>"><i class="fa fa-minus-square-o"></i></button>
            </div>
        </div>
    </div>
</div>
