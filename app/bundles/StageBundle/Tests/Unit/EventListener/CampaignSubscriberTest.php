...
namespace Milex\StageBundle\Tests\Unit\EventListener;
...
use Milex\StageBundle\EventListener\CampaignSubscriber;
...
final class CampaignSubscriberTest extends TestCase
{
    public function testOnCampaignTriggerStageChangeWhenStageNotFound(): void
    {
        ...
        Assert::assertSame(
            [
                'failed' => 1,
                'reason' => '[trans]milex.stage.campaign.event.stage_missing[/trans]',
            ],
            $log->getMetadata()
        );
    }
    ...
    public function testOnCampaignTriggerStageChangeWhenContactHasTheSameStage(): void
    {
        ...
        Assert::assertSame(
            [
                'failed' => 1,
                'reason' => '[trans]milex.stage.campaign.event.already_in_stage[/trans]',
            ],
            $log->getMetadata()
        );
        Assert::assertSame(123, $contact->getStage()->getId());
    ...
    public function testOnCampaignTriggerStageChangeWhenContactHasStageWithGreaterWeight(): void
    {
        ...
        Assert::assertSame(
            [
                'failed' => 1,
                'reason' => '[trans]milex.stage.campaign.event.stage_invalid[/trans]',
            ],
            $log->getMetadata()
        );
