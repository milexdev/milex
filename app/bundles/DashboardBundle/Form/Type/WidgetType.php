...
namespace Milex\DashboardBundle\Form\Type;
...
use Milex\DashboardBundle\Event\WidgetFormEvent;
use Milex\DashboardBundle\Event\WidgetTypeListEvent;
...
class WidgetType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'milex.dashboard.widget.form.name',
        ...
        $builder->add(
            ...
            ChoiceType::class,
            [
                'label'             => 'milex.dashboard.widget.form.type',
                'choices'           => $types,
                'label_attr'        => ['class' => 'control-label'],
                'placeholder'       => 'milex.core.select',
                'attr'              => [
                    'class'    => 'form-control',
                    'onchange' => 'Milex.updateWidgetForm(this)',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            ChoiceType::class,
            [
                'label'   => 'milex.dashboard.widget.form.width',
                'choices' => [
                    '25%'  => '25',
                    '50%'  => '50',
                    '75%'  => '75',
        ...
        $builder->add(
            ...
            ChoiceType::class,
            [
                'label'   => 'milex.dashboard.widget.form.height',
                'choices' => [
                    '215px' => '215',
                    '330px' => '330',
                    '445px' => '445',
