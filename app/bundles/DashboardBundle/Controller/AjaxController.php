...
class AjaxController extends CommonAjaxController
{
    ...
    protected function viewingVisitorsAction(Request $request)
    {
        ...
        /** @var \Milex\PageBundle\Entity\PageRepository $pageRepository */
        $pageRepository               = $this->get('doctrine.orm.entity_manager')->getRepository('MilexPageBundle:Hit');
    ...
    protected function updateWidgetFormAction(Request $request)
    {
        ...
        $formHtml = $this->render('MilexDashboardBundle::Widget\\form.html.php',
    ...
    public function deleteAction(Request $request)
    {
        ...
        // if (!$this->get('milex.security')->isGranted('dashobard:widgets:delete')) {
        //     return $this->accessDenied();
        // }

        /** @var \Milex\DashboardBundle\Model\DashboardModel $model */
