...
namespace Milex\DashboardBundle\Tests\Controller;
...
use Milex\DashboardBundle\Controller\DashboardController;
use Milex\DashboardBundle\Dashboard\Widget;
...
class DashboardControllerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSaveWithPostAjaxWillSave(): void
    {
        ...
        $this->translatorMock->expects($this->once())
            ->method('trans')
            ->with('milex.dashboard.notice.save');
    ...
    public function testSaveWithPostAjaxWillNotBeAbleToSave(): void
    {
        ...
        $this->translatorMock->expects($this->once())
            ->method('trans')
            ->with('milex.dashboard.error.save');
    ...
    {
        $widgetId        = '1';
        $widget          = new \Milex\DashboardBundle\Entity\Widget();
