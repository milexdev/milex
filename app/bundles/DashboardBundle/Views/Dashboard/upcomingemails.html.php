                ...
                <div class="box-layout">
                    ...
                    <div class="col-md-4 va-m">
                        <h5 class="fw-sb text-primary">
                            <a href="<?php echo $view['router']->path('milex_campaign_action', ['objectAction' => 'view', 'objectId' => $email['campaign_id']]); ?>" data-toggle="ajax">
                    ...
                    <div class="col-md-4 va-m text-right">
                        <a class="btn btn-sm btn-success"  href="<?php echo $view['router']->path('milex_contact_action', ['objectAction' => 'view', 'objectId' => $email['lead_id']]); ?>" data-toggle="ajax">
...
<?php else: ?>
        <div class="alert alert-warning" role="alert">
            <?php echo $view['translator']->trans('milex.note.no.upcoming.emails'); ?>
        </div>
<?php endif; ?>