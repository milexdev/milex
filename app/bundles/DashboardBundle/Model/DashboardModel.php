...
namespace Milex\DashboardBundle\Model;
...
class DashboardModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('MilexDashboardBundle:Widget');
    }
    ...
    public function saveEntity($entity, $unlock = true)
    {
        ...
        if (!$entity->getName()) {
            $entity->setName($this->translator->trans('milex.widget.'.$entity->getType()));
        }
    ...
    public function getDefaultFilter(): array
    {
        ...
        $today    = new \DateTime();
        $dateFrom = new \DateTime($this->session->get('milex.daterange.form.from', $dateRangeStart->format('Y-m-d 00:00:00')));
        $dateTo   = new \DateTime($this->session->get('milex.daterange.form.to', $today->format('Y-m-d 23:59:59')));
