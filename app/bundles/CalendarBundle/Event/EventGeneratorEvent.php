...
namespace Milex\CalendarBundle\Event;
...
class EventGeneratorEvent extends Event
{
    ...
    /**
     * @var \Milex\CoreBundle\Model\FormModel
     */
    private $model;

    /**
     * @var \Milex\CoreBundle\Entity\FormEntity
     */
    private $entity;
     ...
     *
     * @return \Milex\CoreBundle\Model\FormModel
     */
     ...
     * Set the event model.
     */
    public function setModel(\Milex\CoreBundle\Model\FormModel $model)
    {
        $this->model = $model;
    }
     ...
     *
     * @return \Milex\CoreBundle\Entity\FormEntity
     */
     ...
     */
    public function setEntity(\Milex\CoreBundle\Entity\FormEntity $entity)
    {
        $this->entity = $entity;
    }
